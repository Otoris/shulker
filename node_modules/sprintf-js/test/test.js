...
describe("sprintfjs", function() ***REMOVED***
    var pi = 3.141592653589793

    it("should return formated strings for simple placeholders", function() ***REMOVED***
        ...
        assert.equal("2", sprintf("%d", "2"))
        assert.equal("2", sprintf("%i", "2"))
        assert.equal('***REMOVED***"foo":"bar"***REMOVED***', sprintf("%j", ***REMOVED***foo: "bar"***REMOVED***))
        ...
        assert.equal("Hello world!", sprintf("Hello %(who)s!", ***REMOVED***"who": "world"***REMOVED***))
    ***REMOVED***)

    it("should return formated strings for complex placeholders", function() ***REMOVED***
        // sign
        assert.equal("2", sprintf("%d", 2))
        assert.equal("-2", sprintf("%d", -2))
        assert.equal("+2", sprintf("%+d", 2))
        ...
        assert.equal('***REMOVED***\n  "foo": "bar"\n***REMOVED***', sprintf("%2j", ***REMOVED***foo: "bar"***REMOVED***))
        assert.equal('[\n  "foo",\n  "bar"\n]', sprintf("%2j", ["foo", "bar"]))
    ...
    ***REMOVED***)
    ...
    it("should return formated strings for callbacks", function() ***REMOVED***
        assert.equal("foobar", sprintf("%s", function() ***REMOVED*** return "foobar" ***REMOVED***))
