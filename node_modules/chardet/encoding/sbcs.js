...
function NGramParser(theNgramList, theByteMap) ***REMOVED***
   ...
   */
  this.search = function(table, value) ***REMOVED***
    var index = 0;
  ...
  ***REMOVED***;
  ...
  this.lookup = function(thisNgram) ***REMOVED***
    this.ngramCount += 1;
    if (this.search(this.ngramList, thisNgram) >= 0) ***REMOVED***
      this.hitCount += 1;
    ***REMOVED***
  ***REMOVED***;

  this.addByte = function(b) ***REMOVED***
  ...
  ***REMOVED***
  ...
  this.parse = function(det, spaceCh) ***REMOVED***
    var b, ignoreSpace = false;
    this.spaceChar = spaceCh;

    while ((b = this.nextByte(det)) >= 0) ***REMOVED***
      var mb = this.byteMap[b];

      // TODO: 0x20 might not be a space in all character sets...
      if (mb != 0) ***REMOVED***
        if (!(mb == this.spaceChar && ignoreSpace)) ***REMOVED***
          this.addByte(mb);
        ***REMOVED***
...
function NGramsPlusLang(la, ng) ***REMOVED***
  this.fLang = la;
  this.fNGrams = ng;
***REMOVED***;

function sbcs() ***REMOVED******REMOVED***;
sbcs.prototype.spaceChar = 0x20;
sbcs.prototype.ngrams = function() ***REMOVED******REMOVED***;
sbcs.prototype.byteMap = function() ***REMOVED******REMOVED***;
sbcs.prototype.match = function(det) ***REMOVED***
  ...
  ***REMOVED***
  ...
  for (var i = ngrams.length - 1; i >= 0; i--) ***REMOVED***
    var ngl = ngrams[i];

    var parser = new NGramParser(ngl.fNGrams, this.byteMap());
    var confidence = parser.parse(det, this.spaceChar);
    if (confidence > bestConfidenceSoFar) ***REMOVED***
...
module.exports.ISO_8859_1 = function() ***REMOVED***
  this.byteMap = function() ***REMOVED***
    return [
  ...
  ***REMOVED***;
  ...
  this.name = function(det) ***REMOVED***
...
module.exports.ISO_8859_2 = function() ***REMOVED***
  this.byteMap = function() ***REMOVED***
    return [
      0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
      0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
...
module.exports.ISO_8859_5 = function() ***REMOVED***
  this.byteMap = function() ***REMOVED***
    return [
      0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
      0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
...
module.exports.ISO_8859_6 = function() ***REMOVED***
  this.byteMap = function() ***REMOVED***
    return [
      0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
      0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
...
module.exports.ISO_8859_7 = function() ***REMOVED***
  this.byteMap = function() ***REMOVED***
    return [
      0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
      0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
...
module.exports.ISO_8859_8 = function() ***REMOVED***
...
module.exports.ISO_8859_9 = function() ***REMOVED***
  this.byteMap = function() ***REMOVED***
    return [
      0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
      0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
...
module.exports.windows_1251 = function() ***REMOVED***
  this.byteMap = function() ***REMOVED***
    return [
      0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
      0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
...
module.exports.windows_1256 = function() ***REMOVED***
  this.byteMap = function() ***REMOVED***
    return [
      0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
      0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
...
module.exports.KOI8_R = function() ***REMOVED***
  this.byteMap = function() ***REMOVED***
    return [
      0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
      0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
