...
declare global ***REMOVED***
    namespace Express ***REMOVED***
        ...
        interface Request ***REMOVED*** ***REMOVED***
        interface Response ***REMOVED*** ***REMOVED***
        interface Application ***REMOVED*** ***REMOVED***
    ***REMOVED***
***REMOVED***

import * as http from "http";
import ***REMOVED*** EventEmitter ***REMOVED*** from "events";
import ***REMOVED*** Options as RangeParserOptions, Result as RangeParserResult, Ranges as RangeParserRanges ***REMOVED*** from "range-parser";
...
export interface Dictionary<T> ***REMOVED*** [key: string]: T; ***REMOVED***

export interface ParamsDictionary ***REMOVED*** [key: string]: string; ***REMOVED***
export type ParamsArray = string[];
export type Params = ParamsDictionary | ParamsArray;

export interface RequestHandler<P extends Params = ParamsDictionary, ResBody = any, ReqBody = any> ***REMOVED***
...
export interface IRouterMatcher<T> ***REMOVED***
...
export interface IRouterHandler<T> ***REMOVED***
...
export interface IRoute ***REMOVED***
    path: string;
    stack: any;
...
export interface Router extends IRouter ***REMOVED*** ***REMOVED***
...
export interface ByteRange ***REMOVED*** start: number; end: number; ***REMOVED***

export interface RequestRanges extends RangeParserRanges ***REMOVED*** ***REMOVED***
 ...
 *     app.get<ParamsArray>('/user/*', (req, res) => res.send(req.params[0]));
 */
export interface Request<P extends Params = ParamsDictionary, ResBody = any, ReqBody = any> extends http.IncomingMessage, Express.Request ***REMOVED***
    /**
    ...
    //body: ***REMOVED*** username: string; password: string; remember: boolean; title: string; ***REMOVED***;
    body: ReqBody;

    //cookies: ***REMOVED*** string; remember: boolean; ***REMOVED***;
    cookies: any;
...
export interface Response<ResBody = any> extends http.ServerResponse, Express.Response ***REMOVED***
    /**
     * Set status `code`.
     */
...
export interface Handler extends RequestHandler ***REMOVED*** ***REMOVED***
...
export interface Application extends EventEmitter, IRouter, Express.Application ***REMOVED***
    /**
