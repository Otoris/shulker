...
function hasProp() ***REMOVED***
  ...
  return props.some(function (attribute) ***REMOVED***
...
function hasAnyProp() ***REMOVED***
  ...
  return propsToCheck.some(function (prop) ***REMOVED***
...
function hasEveryProp() ***REMOVED***
  ...
  return propsToCheck.every(function (prop) ***REMOVED***
    return hasProp(nodeProps, prop, options);
  ***REMOVED***);
***REMOVED***