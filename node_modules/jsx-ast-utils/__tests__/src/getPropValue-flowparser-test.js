...
describe('getPropValue', () => ***REMOVED***
  ...
  ***REMOVED***);
  ...
  it('should throw not error when trying to get value from unknown node type', () => ***REMOVED***
    const prop = ***REMOVED***
      type: 'JSXAttribute',
      value: ***REMOVED***
  ...
  ***REMOVED***);
  ...
  describe('Type Cast Expression', () => ***REMOVED***
    it('should return the expression from a type cast', () => ***REMOVED***
      const prop = extractProp('<div foo=***REMOVED***(this.handleClick: (event: MouseEvent) => void))***REMOVED*** />');
