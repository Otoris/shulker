 ...
 */
export default function extractValueFromBindExpression(value) ***REMOVED***
  ...
  if (value.object && value.object.property) ***REMOVED***
    return `$***REMOVED***object***REMOVED***.$***REMOVED***callee***REMOVED***.bind($***REMOVED***object***REMOVED***)`;
  ***REMOVED***

  return `$***REMOVED***callee***REMOVED***.bind($***REMOVED***object***REMOVED***)`;
***REMOVED***
