 ...
 */
export default function hasProp(props = [], prop = '', options = DEFAULT_OPTIONS) ***REMOVED***
  const propToCheck = options.ignoreCase ? prop.toUpperCase() : prop;

  return props.some((attribute) => ***REMOVED***
 ...
 */
export function hasAnyProp(nodeProps = [], props = [], options = DEFAULT_OPTIONS) ***REMOVED***
 ...
 */
export function hasEveryProp(nodeProps = [], props = [], options = DEFAULT_OPTIONS) ***REMOVED***
  const propsToCheck = typeof props === 'string' ? props.split(' ') : props;
