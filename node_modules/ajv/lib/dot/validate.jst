...
***REMOVED******REMOVED***? it.isTop ***REMOVED******REMOVED***
  var validate = ***REMOVED******REMOVED***?$async***REMOVED******REMOVED******REMOVED******REMOVED***it.async = true;***REMOVED******REMOVED***async ***REMOVED******REMOVED***?***REMOVED******REMOVED***function(data, dataPath, parentData, parentDataProperty, rootData) ***REMOVED***
    'use strict';
...
***REMOVED******REMOVED***? it.schema.$comment && it.opts.$comment ***REMOVED******REMOVED***
  ***REMOVED******REMOVED***= it.RULES.all.$comment.code(it, '$comment') ***REMOVED******REMOVED***
***REMOVED******REMOVED***?***REMOVED******REMOVED***
...
***REMOVED******REMOVED***??***REMOVED******REMOVED***
  ***REMOVED******REMOVED***~ it.RULES:$rulesGroup ***REMOVED******REMOVED***
    ***REMOVED******REMOVED***? $shouldUseGroup($rulesGroup) ***REMOVED******REMOVED***
      ...
      ***REMOVED******REMOVED***?***REMOVED******REMOVED***
        ***REMOVED******REMOVED***? it.opts.useDefaults ***REMOVED******REMOVED***
