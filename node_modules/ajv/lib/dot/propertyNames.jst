...
***REMOVED******REMOVED***? ***REMOVED******REMOVED***# def.nonEmptySchema:$schema ***REMOVED******REMOVED*** ***REMOVED******REMOVED***
  ...
  ***REMOVED******REMOVED***# def.iterateProperties ***REMOVED******REMOVED***
    var startErrs***REMOVED******REMOVED***=$lvl***REMOVED******REMOVED*** = errors;

    ***REMOVED******REMOVED*** var $passData = $key; ***REMOVED******REMOVED***
    ...
    ***REMOVED******REMOVED***# def.resetCompositeRule ***REMOVED******REMOVED***
    ...
    if (!***REMOVED******REMOVED***=$nextValid***REMOVED******REMOVED***) ***REMOVED***
      for (var ***REMOVED******REMOVED***=$i***REMOVED******REMOVED***=startErrs***REMOVED******REMOVED***=$lvl***REMOVED******REMOVED***; ***REMOVED******REMOVED***=$i***REMOVED******REMOVED***<errors; ***REMOVED******REMOVED***=$i***REMOVED******REMOVED***++) ***REMOVED***
        vErrors[***REMOVED******REMOVED***=$i***REMOVED******REMOVED***].propertyName = ***REMOVED******REMOVED***=$key***REMOVED******REMOVED***;
      ***REMOVED***
      ***REMOVED******REMOVED***# def.extraError:'propertyNames' ***REMOVED******REMOVED***
