...
***REMOVED******REMOVED***## def._errorMessages = ***REMOVED***
  ...
  additionalProperties: "'***REMOVED******REMOVED***? it.opts._errorDataPathProperty ***REMOVED******REMOVED***is an invalid additional property***REMOVED******REMOVED***??***REMOVED******REMOVED***should NOT have additional properties***REMOVED******REMOVED***?***REMOVED******REMOVED***'",
  ...
  'if':            "'should match \"' + ***REMOVED******REMOVED***=$ifClause***REMOVED******REMOVED*** + '\" schema'",
  ...
  _limitItems:     "'should NOT have ***REMOVED******REMOVED***?$keyword=='maxItems'***REMOVED******REMOVED***more***REMOVED******REMOVED***??***REMOVED******REMOVED***fewer***REMOVED******REMOVED***?***REMOVED******REMOVED*** than ***REMOVED******REMOVED***#def.concatSchema***REMOVED******REMOVED*** items'",
  ...
  _limitProperties:"'should NOT have ***REMOVED******REMOVED***?$keyword=='maxProperties'***REMOVED******REMOVED***more***REMOVED******REMOVED***??***REMOVED******REMOVED***fewer***REMOVED******REMOVED***?***REMOVED******REMOVED*** than ***REMOVED******REMOVED***#def.concatSchema***REMOVED******REMOVED*** properties'",
...
***REMOVED******REMOVED***## def._errorSchemas = ***REMOVED***
  ...
  'if':            "validate.schema***REMOVED******REMOVED***=$schemaPath***REMOVED******REMOVED***",
...
***REMOVED******REMOVED***## def._errorParams = ***REMOVED***
  ...
  const:           "***REMOVED*** allowedValue: schema***REMOVED******REMOVED***=$lvl***REMOVED******REMOVED*** ***REMOVED***",
  ...
  'if':            "***REMOVED*** failingKeyword: ***REMOVED******REMOVED***=$ifClause***REMOVED******REMOVED*** ***REMOVED***",
  ...
  not:             "***REMOVED******REMOVED***",
  oneOf:           "***REMOVED*** passingSchemas: ***REMOVED******REMOVED***=$passingSchemas***REMOVED******REMOVED*** ***REMOVED***",
