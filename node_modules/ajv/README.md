...
```javascript
var ajv = new Ajv(***REMOVED***schemaId: 'id'***REMOVED***);
// If you want to use both draft-04 and draft-06/07 schemas:
// var ajv = new Ajv(***REMOVED***schemaId: 'auto'***REMOVED***);
...
```javascript
var ajv = new Ajv(***REMOVED*** processCode: transpileFunc ***REMOVED***);
var validate = ajv.compile(schema); // transpiled es7 async function
validate(data).then(successFunc).catch(errorFunc);
```
...
const schema1 = ***REMOVED***format: 'email'***REMOVED***;
isSchemaSecure(schema1); // false

const schema2 = ***REMOVED***format: 'email', maxLength: MAX_LENGTH***REMOVED***;
