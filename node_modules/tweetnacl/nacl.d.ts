...
declare namespace nacl ***REMOVED***
    export interface BoxKeyPair ***REMOVED***
        publicKey: Uint8Array;
        secretKey: Uint8Array;
    ***REMOVED***

    export interface SignKeyPair ***REMOVED***
        publicKey: Uint8Array;
        secretKey: Uint8Array;
    ***REMOVED***

    export interface secretbox ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface scalarMult ***REMOVED***
    ...
    ***REMOVED***
    ...
    namespace boxProps ***REMOVED***
        export interface open ***REMOVED***
        ...
        ***REMOVED***
        ...
        export interface keyPair ***REMOVED***
            (): BoxKeyPair;
            fromSecretKey(secretKey: Uint8Array): BoxKeyPair;
        ***REMOVED***
    ***REMOVED***

    export interface box ***REMOVED***
    ...
    ***REMOVED***
    ...
    namespace signProps ***REMOVED***
        export interface detached ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface hash ***REMOVED***
        (msg: Uint8Array): Uint8Array;
        readonly hashLength: number;
    ***REMOVED***
***REMOVED***

declare interface nacl ***REMOVED***
