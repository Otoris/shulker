...
pp$1.parseBlock = function(createNewLexicalScope, node) ***REMOVED***
...
pp$3.parseMaybeAssign = function(noIn, refDestructuringErrors, afterLeftParse) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (oldShorthandAssign > -1) ***REMOVED*** refDestructuringErrors.shorthandAssign = oldShorthandAssign; ***REMOVED***
  return left
***REMOVED***;
...
pp$3.parseSubscripts = function(base, startPos, startLoc, noCalls) ***REMOVED***
  ...
  while (true) ***REMOVED***
    ...
    if (element === base || element.type === "ArrowFunctionExpression") ***REMOVED*** return element ***REMOVED***
    base = element;
  ***REMOVED***
***REMOVED***;

pp$3.parseSubscript = function(base, startPos, startLoc, noCalls, maybeAsyncArrow) ***REMOVED***
  var computed = this.eat(types.bracketL);
  if (computed || this.eat(types.dot)) ***REMOVED***
    var node = this.startNodeAt(startPos, startLoc);
    node.object = base;
  ...
  ***REMOVED*** else if (!noCalls && this.eat(types.parenL)) ***REMOVED***
    ...
    if (maybeAsyncArrow && !this.canInsertSemicolon() && this.eat(types.arrow)) ***REMOVED***
...
pp$3.parseLiteral = function(value) ***REMOVED***
  ...
  if (node.raw.charCodeAt(node.raw.length - 1) === 110) ***REMOVED*** node.bigint = node.raw.slice(0, -1); ***REMOVED***
  this.next();
  return this.finishNode(node, "Literal")
***REMOVED***;
...
RegExpValidationState.prototype.at = function at (i) ***REMOVED***
  var s = this.source;
  var l = s.length;
  if (i >= l) ***REMOVED***
    return -1
  ***REMOVED***
  ...
  if (!this.switchU || c <= 0xD7FF || c >= 0xE000 || i + 1 >= l) ***REMOVED***
    return c
  ***REMOVED***
  return (c << 10) + s.charCodeAt(i + 1) - 0x35FDC00
***REMOVED***;

RegExpValidationState.prototype.nextIndex = function nextIndex (i) ***REMOVED***
  var s = this.source;
  var l = s.length;
  if (i >= l) ***REMOVED***
    return l
...
RegExpValidationState.prototype.current = function current () ***REMOVED***
  return this.at(this.pos)
***REMOVED***;

RegExpValidationState.prototype.lookahead = function lookahead () ***REMOVED***
  return this.at(this.nextIndex(this.pos))
***REMOVED***;

RegExpValidationState.prototype.advance = function advance () ***REMOVED***
  this.pos = this.nextIndex(this.pos);
***REMOVED***;

RegExpValidationState.prototype.eat = function eat (ch) ***REMOVED***
  if (this.current() === ch) ***REMOVED***
    this.advance();
    return true
  ***REMOVED***
  return false
...
pp$8.regexp_eatRegExpIdentifierStart = function(state) ***REMOVED***
  ...
  if (ch === 0x5C /* \ */ && this.regexp_eatRegExpUnicodeEscapeSequence(state)) ***REMOVED***
...
pp$8.regexp_eatRegExpUnicodeEscapeSequence = function(state) ***REMOVED***
  var start = state.pos;

  if (state.eat(0x75 /* u */)) ***REMOVED***
    if (this.regexp_eatFixedHexDigits(state, 4)) ***REMOVED***
      var lead = state.lastIntValue;
      if (state.switchU && lead >= 0xD800 && lead <= 0xDBFF) ***REMOVED***
...
pp$9.readInt = function(radix, len) ***REMOVED***
