...
import ***REMOVED*** NodeWrap ***REMOVED*** from './convert-ast';
...
export declare function forEachDestructuringIdentifier<T>(pattern: ts.BindingPattern, fn: (element: ts.BindingElement & ***REMOVED***
    name: ts.Identifier;
***REMOVED***) => T): T | undefined;
export declare function forEachDeclaredVariable<T>(declarationList: ts.VariableDeclarationList, cb: (element: (ts.VariableDeclaration | ts.BindingElement) & ***REMOVED***
    name: ts.Identifier;
***REMOVED***) => T): T | undefined;
export declare enum VariableDeclarationKind ***REMOVED***
    Var = 0,
    Let = 1,
    Const = 2
***REMOVED***
...
export declare enum ScopeBoundary ***REMOVED***
    None = 0,
    Function = 1,
    Block = 2,
    Type = 4,
    ConditionalType = 8
***REMOVED***
export declare enum ScopeBoundarySelector ***REMOVED***
    Function = 1,
    Block = 3,
    Type = 7,
    InferType = 8
...
export declare function isFunctionWithBody(node: ts.Node): node is ts.FunctionLikeDeclaration & ***REMOVED***
...
export interface LineRange extends ts.TextRange ***REMOVED***
...
export declare enum SideEffectOptions ***REMOVED***
    None = 0,
    TaggedTemplate = 1,
    Constructor = 2,
    JsxElement = 4
...
export declare enum AccessKind ***REMOVED***
    None = 0,
    Read = 1,
    Write = 2,
    Delete = 4,
...
export declare enum ImportKind ***REMOVED***
    ImportDeclaration = 1,
    ImportEquals = 2,
    ExportFrom = 4,
    DynamicImport = 8,
...
export declare type ImportLike = ts.ImportDeclaration | (ts.ImportEqualsDeclaration & ***REMOVED***
    moduleReference: ts.ExternalModuleReference;
***REMOVED***) | (ts.ExportDeclaration & ***REMOVED***
    moduleSpecifier: ***REMOVED******REMOVED***;
***REMOVED***) | (ts.CallExpression & ***REMOVED***
    expression: ts.Token<ts.SyntaxKind.ImportKeyword> | (ts.Identifier & ***REMOVED***
        text: 'require';
    ***REMOVED***);
...
export declare type BooleanCompilerOptions = ***REMOVED***
