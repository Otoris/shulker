 ...
 */
import ***REMOVED*** Observer, TeardownLogic ***REMOVED*** from './internal/types';
import ***REMOVED*** Observable ***REMOVED*** from './internal/Observable';
 ...
 * @hide true
 */
export class ObservableDoc ***REMOVED***
  /**
   * Creates a new Observable, that will execute the specified function when an
   * ***REMOVED***@link Observer***REMOVED*** subscribes to it.
   *
   ...
   * with an ***REMOVED***@link Observer***REMOVED*** instance as a first and only parameter. `onSubscription` should
   ...
   * `create` as `(observer: Observer) => TeardownLogic`, where ***REMOVED***@link Observer***REMOVED***
   * and ***REMOVED***@link TeardownLogic***REMOVED*** are interfaces provided by the library.
   *
   * @example <caption>Emit three numbers, then complete.</caption>
   * var observable = Rx.Observable.create(function (observer) ***REMOVED***
   *   observer.next(1);
   *   observer.next(2);
   *   observer.next(3);
   *   observer.complete();
   ...
   * const observable = Rx.Observable.create((observer) => ***REMOVED***
   ...
   *
   *   return () => ***REMOVED*** clearTimeout(id); console.log('cleared!'); ***REMOVED***;
   * ***REMOVED***);
   *
   ...
   * @see ***REMOVED***@link never***REMOVED***
   * @see ***REMOVED***@link of***REMOVED***
   * @see ***REMOVED***@link throw***REMOVED***
   *
   * @param ***REMOVED***function(observer: Observer): TeardownLogic***REMOVED*** onSubscription A
   ...
   * @return ***REMOVED***Observable***REMOVED*** An Observable that, whenever subscribed, will execute the
   * specified function.
   * @static true
   * @name create
   * @owner Observable
   * @nocollapse
   */
  static create<T>(onSubscription: <R>(observer: Observer<R>) => TeardownLogic): Observable<T> ***REMOVED***
 ...
 * ***REMOVED***@link Observable***REMOVED***.
 *
 * ```ts
 * interface Observer<T> ***REMOVED***
 *   closed?: boolean;
 *   next: (value: T) => void;
 *   error: (err: any) => void;
 *   complete: () => void;
 ...
 * @noimport true
 */
export class ObserverDoc<T> ***REMOVED***
  /**
  ...
  ***REMOVED***
   ...
   * with an attached ***REMOVED***@link Error***REMOVED***. Notifies the Observer that the Observable
 ...
 * ## Observable
 *
 * RxJS ***REMOVED***@link Observable***REMOVED*** instance.
 *
 ...
 * const nonRxJSObservable = ***REMOVED***
 *   subscribe(observer) ***REMOVED***
 *     observer.next(1000);
 *     observer.complete();
 *   ***REMOVED***,
 *   [Symbol.observable]() ***REMOVED***
 *     return this;
 *   ***REMOVED***
 * ***REMOVED***;
 *
 ...
 * @noimport true
 */
export class SubscribableOrPromiseDoc<T> ***REMOVED***

***REMOVED***

/**
 * `ObservableInput` interface describes all values that are either an
 * ***REMOVED***@link SubscribableOrPromise***REMOVED*** or some kind of collection of values that
 ...
 *
 * `ObservableInput` extends ***REMOVED***@link SubscribableOrPromise***REMOVED*** with following types:
 *
 * ## Array
 *
 ...
 * Rx.Observable.merge(***REMOVED***0: 1, 1: 2, length: 2***REMOVED***, ***REMOVED***0: 3, length: 1***REMOVED***)
 * .subscribe(
 *   value => console.log(value),
 *   err => ***REMOVED******REMOVED***,
 ...
 * const infinite = function* () ***REMOVED***
 *   let i = 0;
 *
 *   while (true) ***REMOVED***
 *     yield i++;
 ...
 * @noimport true
 */
export class ObservableInputDoc<T> ***REMOVED***
 ...
 * constructor or static ***REMOVED***@link create***REMOVED*** function. Value of that interface will be used
 ...
 * @noimport true
 */
export class TeardownLogicDoc ***REMOVED***
