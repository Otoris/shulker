...
import ***REMOVED*** ObservableInput, SchedulerLike, ObservedValueOf ***REMOVED*** from '../types';
...
/** @deprecated Passing a scheduler here is deprecated, use ***REMOVED***@link subscribeOn***REMOVED*** and/or ***REMOVED***@link observeOn***REMOVED*** instead */
 ...
 * ```ts
 * import ***REMOVED*** combineLatest, timer ***REMOVED*** from 'rxjs';
 *
 ...
 * ```ts
 * import ***REMOVED*** combineLatest, of ***REMOVED*** from 'rxjs';
 * import ***REMOVED*** delay, starWith ***REMOVED*** from 'rxjs/operators';
 *
 ...
 *
 * @param ***REMOVED***ObservableInput***REMOVED*** observable1 An input Observable to combine with other Observables.
 * @param ***REMOVED***ObservableInput***REMOVED*** observable2 An input Observable to combine with other Observables.
 * More than one input Observables may be given as arguments
 * or an array of Observables may be given as the first argument.
 * @param ***REMOVED***function***REMOVED*** [project] An optional function to project the values from
 ...
 * @return ***REMOVED***Observable***REMOVED*** An Observable of projected values from the most recent
 * values from each input Observable, or an array of the most recent values from
 * each input Observable.
 */
export function combineLatest<O extends ObservableInput<any>, R>(
  ...observables: (O | ((...values: ObservedValueOf<O>[]) => R) | SchedulerLike)[]
): Observable<R> ***REMOVED***
...
export class CombineLatestOperator<T, R> implements Operator<T, R> ***REMOVED***
  constructor(private resultSelector?: (...values: Array<any>) => R) ***REMOVED***
  ***REMOVED***
 ...
 */
export class CombineLatestSubscriber<T, R> extends OuterSubscriber<T, R> ***REMOVED***
  private active: number = 0;
  private values: any[] = [];
  private observables: any[] = [];
  private toRespond: number;

  constructor(destination: Subscriber<R>, private resultSelector?: (...values: Array<any>) => R) ***REMOVED***
    super(destination);
  ***REMOVED***

  protected _next(observable: any) ***REMOVED***
  ...
  ***REMOVED***
  ...
  notifyComplete(unused: Subscriber<R>): void ***REMOVED***
  ...
  ***REMOVED***
  ...
  private _tryResultSelector(values: any[]) ***REMOVED***
    let result: any;
    try ***REMOVED***
