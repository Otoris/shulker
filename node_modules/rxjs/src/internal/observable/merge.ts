...
import ***REMOVED*** ObservableInput, SchedulerLike***REMOVED*** from '../types';
...
/** @deprecated use ***REMOVED***@link scheduled***REMOVED*** and ***REMOVED***@link mergeAll***REMOVED*** (e.g. `scheduled([ob1, ob2, ob3], scheduled).pipe(mergeAll())*/
 ...
 * ```ts
 * import ***REMOVED*** merge, fromEvent, interval ***REMOVED*** from 'rxjs';
 *
 ...
 * ```ts
 * import ***REMOVED*** merge, interval ***REMOVED*** from 'rxjs';
 ...
 *
 * @param ***REMOVED***...ObservableInput***REMOVED*** observables Input Observables to merge together.
 * @param ***REMOVED***number***REMOVED*** [concurrent=Number.POSITIVE_INFINITY] Maximum number of input
 * Observables being subscribed to concurrently.
 * @param ***REMOVED***SchedulerLike***REMOVED*** [scheduler=null] The ***REMOVED***@link SchedulerLike***REMOVED*** to use for managing
 * concurrency of input Observables.
 * @return ***REMOVED***Observable***REMOVED*** an Observable that emits items that are the result of
 * every input Observable.
 * @static true
 * @name merge
 * @owner Observable
 */
export function merge<T, R>(...observables: Array<ObservableInput<any> | SchedulerLike | number>): Observable<R> ***REMOVED***
 ...
 let scheduler: SchedulerLike = null;
  ...
  if (isScheduler(last)) ***REMOVED***
    ...
    ***REMOVED***
  ***REMOVED*** else if (typeof last === 'number') ***REMOVED***
    concurrent = <number>observables.pop();
  ***REMOVED***
