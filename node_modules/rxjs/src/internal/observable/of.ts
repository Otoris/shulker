...
import ***REMOVED*** scheduleArray ***REMOVED*** from '../scheduled/scheduleArray';

/* tslint:disable:max-line-length */
/** @deprecated use ***REMOVED***@link scheduled***REMOVED*** instead `scheduled([a, b, c], scheduler)` */
 ...
 * ![](of.png)
 *
 * Unlike ***REMOVED***@link from***REMOVED***, it does not do any flattening and emits each argument in whole
 ...
 * @see ***REMOVED***@link range***REMOVED***
 *
 * @param ***REMOVED***...T***REMOVED*** values A comma separated list of arguments you want to be emitted
 * @return ***REMOVED***Observable***REMOVED*** An Observable that emits the arguments
 * described above and then completes.
 * @method of
 * @owner Observable
 */

export function of<T>(...args: Array<T | SchedulerLike>): Observable<T> ***REMOVED***
