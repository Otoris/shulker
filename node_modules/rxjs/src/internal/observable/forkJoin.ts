...
import ***REMOVED*** ObservableInput, ObservedValuesFromArray, ObservedValueOf, SubscribableOrPromise ***REMOVED*** from '../types';
...
import ***REMOVED*** isObservable ***REMOVED*** from '../util/isObservable';
...
// forkJoin(***REMOVED******REMOVED***)
export function forkJoin(sourcesObject: ***REMOVED******REMOVED***): Observable<never>;
export function forkJoin<T, K extends keyof T>(sourcesObject: T): Observable<***REMOVED*** [K in keyof T]: ObservedValueOf<T[K]> ***REMOVED***>;
...
/**
 * Accepts an `Array` of ***REMOVED***@link ObservableInput***REMOVED*** or a dictionary `Object` of ***REMOVED***@link ObservableInput***REMOVED*** and returns
 * an ***REMOVED***@link Observable***REMOVED*** that emits either an array of values in the exact same order as the passed array,
 ...
 * values not only at the end of lifecycle of passed observables, but also throughout it, try out ***REMOVED***@link combineLatest***REMOVED***
 * or ***REMOVED***@link zip***REMOVED*** instead.
 *
 ...
 * ```ts
 * import ***REMOVED*** forkJoin, of, timer ***REMOVED*** from 'rxjs';
 *
 * const observable = forkJoin(***REMOVED***
 *   foo: of(1, 2, 3, 4),
 *   bar: Promise.resolve(8),
 *   baz: timer(4000),
 * ***REMOVED***);
 * observable.subscribe(***REMOVED***
 *  next: value => console.log(value),
 *  complete: () => console.log('This is how it ends!'),
 * ***REMOVED***);
 *
 * // Logs:
 * // ***REMOVED*** foo: 4, bar: 8, baz: 0 ***REMOVED*** after 4 seconds
 ...
 *
 * @param ***REMOVED***...ObservableInput***REMOVED*** sources Any number of Observables provided either as an array or as an arguments
 * passed directly to the operator.
 * @param ***REMOVED***function***REMOVED*** [project] Function that takes values emitted by input Observables and returns value
 * that will appear in resulting Observable instead of default array.
 * @return ***REMOVED***Observable***REMOVED*** Observable emitting either an array of last values emitted by passed Observables
 * or value from project function.
 */
export function forkJoin(
  ...sources: any[]
): Observable<any> ***REMOVED***
...
function forkJoinInternal(sources: ObservableInput<any>[], keys: string[] | null): Observable<any> ***REMOVED***
