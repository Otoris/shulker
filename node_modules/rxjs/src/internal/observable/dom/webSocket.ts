import ***REMOVED*** WebSocketSubject, WebSocketSubjectConfig ***REMOVED*** from './WebSocketSubject';

/**
 * Wrapper around the w3c-compatible WebSocket object provided by the browser.
 *
 * <span class="informal">***REMOVED***@link Subject***REMOVED*** that communicates with a server via WebSocket</span>
 *
 * `webSocket` is a factory function that produces a `WebSocketSubject`,
 * which can be used to make WebSocket connection with an arbitrary endpoint.
 * `webSocket` accepts as an argument either a string with url of WebSocket endpoint, or an
 * ***REMOVED***@link WebSocketSubjectConfig***REMOVED*** object for providing additional configuration, as
 ...
 * function in ***REMOVED***@link WebSocketSubject***REMOVED***. When connection closes, stream will complete, provided it happened without
 * any errors. If at any point (starting, maintaining or closing a connection) there is an error,
 * stream will also error with whatever WebSocket API has thrown.
 *
 * By virtue of being a ***REMOVED***@link Subject***REMOVED***, `WebSocketSubject` allows for receiving and sending messages from the server. In order
 ...
 * on the server or using ***REMOVED***@link publish***REMOVED*** on a Observable returned from 'multiplex'.
 *
 ...
 *
 * subject.next(***REMOVED***message: 'some message'***REMOVED***);
 * // This will send a message to the server once a connection is made. Remember value is serialized with JSON.stringify by default!
 *
 * subject.complete(); // Closes the connection.
 *
 * subject.error(***REMOVED***code: 4000, reason: 'I think our app just broke!'***REMOVED***);
 ...
 *   () => (***REMOVED***subscribe: 'A'***REMOVED***), // When server gets this message, it will start sending messages for 'A'...
 *   () => (***REMOVED***unsubscribe: 'A'***REMOVED***), // ...and when gets this one, it will stop.
 *   message => message.type === 'A' // If the function returns `true` message is passed down the stream. Skipped if the function returns false.
 * );
 *
 * const observableB = subject.multiplex( // And the same goes for 'B'.
 *   () => (***REMOVED***subscribe: 'B'***REMOVED***),
 *   () => (***REMOVED***unsubscribe: 'B'***REMOVED***),
 *   message => message.type === 'B'
 * );
 *
 * const subA = observableA.subscribe(messageForA => console.log(messageForA));
 * // At this moment WebSocket connection is established. Server gets '***REMOVED***"subscribe": "A"***REMOVED***' message and starts sending messages for 'A',
 * // which we log here.
 *
 * const subB = observableB.subscribe(messageForB => console.log(messageForB));
 * // Since we already have a connection, we just send '***REMOVED***"subscribe": "B"***REMOVED***' message to the server. It starts sending messages for 'B',
 * // which we log here.
 *
 * subB.unsubscribe();
 * // Message '***REMOVED***"unsubscribe": "B"***REMOVED***' is sent to the server, which stops sending 'B' messages.
 *
 * subA.unsubscribe();
 * // Message '***REMOVED***"unsubscribe": "A"***REMOVED***' makes the server stop sending messages for 'A'. Since there is no more subscribers to root Subject,
 * // socket connection closes.
 * ```
 *
 *
 * @param ***REMOVED***string|WebSocketSubjectConfig***REMOVED*** urlConfigOrSource The WebSocket endpoint as an url or an object with
 * configuration and additional Observers.
 * @return ***REMOVED***WebSocketSubject***REMOVED*** Subject which allows to both send and receive messages via WebSocket connection.
 */
export function webSocket<T>(urlConfigOrSource: string | WebSocketSubjectConfig<T>): WebSocketSubject<T> ***REMOVED***
