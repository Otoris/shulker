...
import ***REMOVED*** mergeAll ***REMOVED*** from './mergeAll';
 ...
 * import ***REMOVED*** map, take, concatAll ***REMOVED*** from 'rxjs/operators';
 *
 ...
 *
 * @return ***REMOVED***Observable***REMOVED*** An Observable emitting values from all the inner
 * Observables concatenated.
 * @method concatAll
 * @owner Observable
 */
export function concatAll<T>(): OperatorFunction<ObservableInput<T>, T> ***REMOVED***
  return mergeAll<T>(1);
***REMOVED***
