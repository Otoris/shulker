 ...
 *
 * `onErrorResumeNext` can be therefore thought of as version of ***REMOVED***@link concat***REMOVED*** operator, which is more permissive
 * when it comes to the errors emitted by its input Observables. While `concat` subscribes to the next Observable
 * in series only if previous one successfully completed, `onErrorResumeNext` subscribes even if it ended with
 * an error.
 *
 * Note that you do not get any access to errors emitted by the Observables. In particular do not
 * expect these errors to appear in error callback passed to ***REMOVED***@link Observable#subscribe***REMOVED***. If you want to take
 * specific actions based on what error was emitted by an Observable, you should try out ***REMOVED***@link catchError***REMOVED*** instead.
 *
 *
 * ## Example
 ...
 * import ***REMOVED*** onErrorResumeNext, map ***REMOVED*** from 'rxjs/operators';
 *
 * of(1, 2, 3, 0).pipe(
 *   map(x => ***REMOVED***
 *       if (x === 0) ***REMOVED*** throw Error(); ***REMOVED***
 *        return 10 / x;
 *   ***REMOVED***),
 ...
 * ```
 *
 * @see ***REMOVED***@link concat***REMOVED***
 * @see ***REMOVED***@link catchError***REMOVED***
 *
 * @param ***REMOVED***...ObservableInput***REMOVED*** observables Observables passed either directly or as an array.
 * @return ***REMOVED***Observable***REMOVED*** An Observable that emits values from source Observable, but - if it errors - subscribes
...
export function onErrorResumeNext<T, R>(...nextSources: Array<ObservableInput<any> |
                                                       Array<ObservableInput<any>>>): OperatorFunction<T, R> ***REMOVED***
...
export function onErrorResumeNextStatic<T, R>(...nextSources: Array<ObservableInput<any> |
  ...
  ((...values: Array<any>) => R)>): Observable<R> ***REMOVED***
...
class OnErrorResumeNextOperator<T, R> implements Operator<T, R> ***REMOVED***
  constructor(private nextSources: Array<ObservableInput<any>>) ***REMOVED***
  ***REMOVED***
...
class OnErrorResumeNextSubscriber<T, R> extends OuterSubscriber<T, R> ***REMOVED***
  constructor(protected destination: Subscriber<T>,
              private nextSources: Array<ObservableInput<any>>) ***REMOVED***
    super(destination);
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  private subscribeToNextSource(): void ***REMOVED***
