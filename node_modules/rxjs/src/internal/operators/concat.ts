import ***REMOVED***  concat as concatStatic ***REMOVED*** from '../observable/concat';
...
/**
 * @deprecated Deprecated in favor of static ***REMOVED***@link concat***REMOVED***.
 */
export function concat<T, R>(...observables: Array<ObservableInput<any> | SchedulerLike>): OperatorFunction<T, R> ***REMOVED***
