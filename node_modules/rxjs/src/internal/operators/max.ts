 ...
 * import ***REMOVED*** max ***REMOVED*** from 'rxjs/operators';
 *
 * of(5, 4, 7, 2, 8).pipe(
 *   max(),
 * )
 ...
 * value of two items.
 * @return ***REMOVED***Observable***REMOVED*** An Observable that emits item with the largest value.
 * @method max
 * @owner Observable
 */
export function max<T>(comparer?: (x: T, y: T) => number): MonoTypeOperatorFunction<T> ***REMOVED***
