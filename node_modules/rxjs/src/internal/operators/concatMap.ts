 ...
 * these inner Observables using ***REMOVED***@link concatAll***REMOVED***.</span>
 *
 * ![](concatMap.png)
 *
 ...
 * import ***REMOVED*** concatMap, take ***REMOVED*** from 'rxjs/operators';
 *
 ...
 *
 * @param ***REMOVED***function(value: T, ?index: number): ObservableInput***REMOVED*** project A function
 * that, when applied to an item emitted by the source Observable, returns an
 * Observable.
 * @return ***REMOVED***Observable***REMOVED*** An Observable that emits the result of applying the
