...
import ***REMOVED*** switchMap ***REMOVED*** from './switchMap';
 ...
 * import ***REMOVED*** switchAll, map, tap ***REMOVED*** from 'rxjs/operators';
 *
...
export function switchAll<T>(): OperatorFunction<ObservableInput<T>, T> ***REMOVED***
