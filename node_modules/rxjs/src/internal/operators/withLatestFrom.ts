 ...
 * import ***REMOVED*** withLatestFrom ***REMOVED*** from 'rxjs/operators';
 *
 ...
 *
 * @param ***REMOVED***ObservableInput***REMOVED*** other An input Observable to combine with the source
 * Observable. More than one input Observables may be given as argument.
 * @param ***REMOVED***Function***REMOVED*** [project] Projection function for combining values
 ...
 * @owner Observable
 */
export function withLatestFrom<T, R>(...args: Array<ObservableInput<any> | ((...values: Array<any>) => R)>): OperatorFunction<T, R> ***REMOVED***
...
class WithLatestFromOperator<T, R> implements Operator<T, R> ***REMOVED***
  constructor(private observables: Observable<any>[],
              private project?: (...values: any[]) => Observable<R>) ***REMOVED***
  ***REMOVED***
 ...
 */
class WithLatestFromSubscriber<T, R> extends OuterSubscriber<T, R> ***REMOVED***
  private values: any[];
  ...
  ***REMOVED***
  ...
  private _tryProject(args: any[]) ***REMOVED***
    let result: any;
    try ***REMOVED***
