import ***REMOVED*** merge as mergeStatic ***REMOVED*** from '../observable/merge';
import ***REMOVED*** Observable ***REMOVED*** from '../Observable';
import ***REMOVED*** ObservableInput, OperatorFunction, MonoTypeOperatorFunction, SchedulerLike ***REMOVED*** from '../types';
...
/**
 * @deprecated Deprecated in favor of static ***REMOVED***@link merge***REMOVED***.
 */
export function merge<T, R>(...observables: Array<ObservableInput<any> | SchedulerLike | number>): OperatorFunction<T, R> ***REMOVED***
