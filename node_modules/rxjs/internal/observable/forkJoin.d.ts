...
export declare function forkJoin(sourcesObject: ***REMOVED******REMOVED***): Observable<never>;
export declare function forkJoin<T, K extends keyof T>(sourcesObject: T): Observable<***REMOVED***
