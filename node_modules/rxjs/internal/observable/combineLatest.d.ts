...
export declare class CombineLatestOperator<T, R> implements Operator<T, R> ***REMOVED***
 ...
 */
export declare class CombineLatestSubscriber<T, R> extends OuterSubscriber<T, R> ***REMOVED***
    private resultSelector?;
    private active;
    private values;
    private observables;
