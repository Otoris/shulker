...
function getCORSRequest() ***REMOVED***
    if (root_1.root.XMLHttpRequest) ***REMOVED***
        return new root_1.root.XMLHttpRequest();
    ***REMOVED***
    else if (!!root_1.root.XDomainRequest) ***REMOVED***
    ...
    ***REMOVED***
        ...
        try ***REMOVED***
            ...
            for (var i = 0; i < 3; i++) ***REMOVED***
                try ***REMOVED***
                    progId = progIds[i];
                    if (new root_1.root.ActiveXObject(progId)) ***REMOVED***
                        break;
                    ***REMOVED***
                ***REMOVED***
                catch (e) ***REMOVED***
...
var AjaxObservable = (function (_super) ***REMOVED***
...
var AjaxSubscriber = (function (_super) ***REMOVED***
    ...
    function AjaxSubscriber(destination, request) ***REMOVED***
        ...
        ***REMOVED***
        ...
        if (!contentTypeHeader && !(root_1.root.FormData && request.body instanceof root_1.root.FormData) && typeof request.body !== 'undefined') ***REMOVED***
    ...
    ***REMOVED***;
    AjaxSubscriber.prototype.serializeBody = function (body, contentType) ***REMOVED***
        if (!body || typeof body === 'string') ***REMOVED***
            return body;
        ***REMOVED***
        else if (root_1.root.FormData && body instanceof root_1.root.FormData) ***REMOVED***
            return body;
        ***REMOVED***
        ...
        ***REMOVED***
        ...
        if (xhr.upload && 'withCredentials' in xhr) ***REMOVED***
            if (progressSubscriber) ***REMOVED***
                ...
                ***REMOVED***;
                if (root_1.root.XDomainRequest) ***REMOVED***
...
var AjaxResponse = (function () ***REMOVED***
...
var AjaxErrorImpl = (function () ***REMOVED***
