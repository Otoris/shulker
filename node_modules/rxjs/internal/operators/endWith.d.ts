import ***REMOVED*** MonoTypeOperatorFunction, SchedulerLike, OperatorFunction ***REMOVED*** from '../types';
/** @deprecated use ***REMOVED***@link scheduled***REMOVED*** and ***REMOVED***@link concatAll***REMOVED*** (e.g. `scheduled([source, [a, b, c]], scheduler).pipe(concatAll())`) */
