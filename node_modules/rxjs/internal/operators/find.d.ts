...
export declare class FindValueOperator<T> implements Operator<T, T | number | undefined> ***REMOVED***
    private predicate;
    private source;
    private yieldIndex;
    private thisArg?;
 ...
 */
export declare class FindValueSubscriber<T> extends Subscriber<T> ***REMOVED***
    private predicate;
    private source;
    private yieldIndex;
    private thisArg?;
