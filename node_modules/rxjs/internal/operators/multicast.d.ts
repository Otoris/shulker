...
import ***REMOVED*** OperatorFunction, UnaryFunction, ObservedValueOf, ObservableInput ***REMOVED*** from '../types';
...
export declare class MulticastOperator<T, R> implements Operator<T, R> ***REMOVED***
