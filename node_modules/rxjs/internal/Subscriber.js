...
var Subscriber = (function (_super) ***REMOVED***
    ...
    function Subscriber(destinationOrNext, error, complete) ***REMOVED***
        ...
        ***REMOVED***
        return _this;
    ***REMOVED***
    Subscriber.prototype[rxSubscriber_1.rxSubscriber] = function () ***REMOVED*** return this; ***REMOVED***;
...
var SafeSubscriber = (function (_super) ***REMOVED***
    ...
    function SafeSubscriber(_parentSubscriber, observerOrNext, error, complete) ***REMOVED***
        ...
        var next;
        var context = _this;
        if (isFunction_1.isFunction(observerOrNext)) ***REMOVED***
            next = observerOrNext;
        ***REMOVED***
            ...
            if (observerOrNext !== Observer_1.empty) ***REMOVED***
                context = Object.create(observerOrNext);
                if (isFunction_1.isFunction(context.unsubscribe)) ***REMOVED***
    ...
    ***REMOVED***
    SafeSubscriber.prototype.next = function (value) ***REMOVED***
        if (!this.isStopped && this._next) ***REMOVED***
            ...
            if (!config_1.config.useDeprecatedSynchronousErrorHandling || !_parentSubscriber.syncErrorThrowable) ***REMOVED***
    ...
    ***REMOVED***;
    SafeSubscriber.prototype.__tryOrUnsub = function (fn, value) ***REMOVED***
        ...
        ***REMOVED***
            ...
            this.unsubscribe();
            if (config_1.config.useDeprecatedSynchronousErrorHandling) ***REMOVED***
                throw err;
            ***REMOVED***
            else ***REMOVED***
                hostReportError_1.hostReportError(err);
