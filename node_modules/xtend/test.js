...
test("prototype pollution", function (assert) ***REMOVED***
    ...
    var maliciousPayload = '***REMOVED***"__proto__":***REMOVED***"oops":"It works!"***REMOVED******REMOVED***'

    assert.strictEqual(a.oops, undefined)
    extend(***REMOVED******REMOVED***, maliciousPayload)
    assert.strictEqual(a.oops, undefined)
    assert.end()
***REMOVED***)
...
test("prototype pollution mutable", function (assert) ***REMOVED***
    ...
    assert.strictEqual(a.oops, undefined)
    mutableExtend(***REMOVED******REMOVED***, maliciousPayload)
    assert.strictEqual(a.oops, undefined)
    assert.end()
***REMOVED***)
