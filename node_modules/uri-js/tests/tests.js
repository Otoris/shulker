...
test("Acquire URI", function () ***REMOVED***
	//URI = require("./uri").URI;
	ok(URI);
***REMOVED***);

test("URI Parsing", function () ***REMOVED***
	var components;
...
test("URI Serialization", function () ***REMOVED***
	...
	***REMOVED***;
	...
	strictEqual(URI.serialize(***REMOVED***path:"//path"***REMOVED***), "/%2Fpath", "Double slash path");
	strictEqual(URI.serialize(***REMOVED***path:"foo:bar"***REMOVED***), "foo%3Abar", "Colon path");
	strictEqual(URI.serialize(***REMOVED***path:"?query"***REMOVED***), "%3Fquery", "Query path");

	//mixed IPv4address & reg-name, example from terion-name (https://github.com/garycourt/uri-js/issues/4)
	strictEqual(URI.serialize(***REMOVED***host:"10.10.10.10.example.com"***REMOVED***), "//10.10.10.10.example.com", "Mixed IPv4address & reg-name");

	//IPv6address
	strictEqual(URI.serialize(***REMOVED***host:"2001:db8::7"***REMOVED***), "//[2001:db8::7]", "IPv6 Host");
	strictEqual(URI.serialize(***REMOVED***host:"::ffff:129.144.52.38"***REMOVED***), "//[::ffff:129.144.52.38]", "IPv6 Mixed Host");
	strictEqual(URI.serialize(***REMOVED***host:"2606:2800:220:1:248:1893:25c8:1946"***REMOVED***), "//[2606:2800:220:1:248:1893:25c8:1946]", "IPv6 Full Host");

	//IPv6address with zone identifier, RFC 6874
	strictEqual(URI.serialize(***REMOVED***host:"fe80::a%en1"***REMOVED***), "//[fe80::a%25en1]", "IPv6 Zone Unescaped Host");
	strictEqual(URI.serialize(***REMOVED***host:"fe80::a%25en1"***REMOVED***), "//[fe80::a%25en1]", "IPv6 Zone Escaped Host");
***REMOVED***);

test("URI Resolving", function () ***REMOVED***
	...
	strictEqual(URI.resolve(base, "uri:g", ***REMOVED***tolerant:true***REMOVED***), "uri://a/b/c/g", "uri:g");
...
test("URI Normalizing", function () ***REMOVED***
	//test from RFC 3987
...
test("URI Equals", function () ***REMOVED***
	//test from RFC 3986
...
test("Escape Component", function () ***REMOVED***
	var chr;
	for (var d = 0; d <= 129; ++d) ***REMOVED***
		chr = String.fromCharCode(d);
		if (!chr.match(/[\$\&\+\,\;\=]/)) ***REMOVED***
...
test("Unescape Component", function () ***REMOVED***
	var chr;
	for (var d = 0; d <= 129; ++d) ***REMOVED***
		chr = String.fromCharCode(d);
...
var IRI_OPTION = ***REMOVED*** iri : true, unicodeSupport : true ***REMOVED***;

test("IRI Parsing", function () ***REMOVED***
...
test("IRI Serialization", function () ***REMOVED***
	var components = ***REMOVED***
		scheme : "uri",
...
test("Convert IRI to URI", function () ***REMOVED***
	//example from RFC 3987
	...
	strictEqual(URI.serialize(URI.parse("uri://r\xE9sum\xE9.example.org", ***REMOVED***iri:true, domainHost:true***REMOVED***), ***REMOVED***domainHost:true***REMOVED***), "uri://xn--rsum-bpad.example.org");
***REMOVED***);

test("Convert URI to IRI", function () ***REMOVED***
	...
	//Internationalized Domain Name conversion via punycode example from RFC 3987
	strictEqual(URI.serialize(URI.parse("uri://xn--rsum-bpad.example.org", ***REMOVED***domainHost:true***REMOVED***), ***REMOVED***iri:true, domainHost:true***REMOVED***), "uri://r\xE9sum\xE9.example.org");
***REMOVED***);
...
if (URI.SCHEMES["http"]) ***REMOVED***

	//module("HTTP");

	test("HTTP Equals", function () ***REMOVED***
		//test from RFC 2616
...
if (URI.SCHEMES["https"]) ***REMOVED***

	//module("HTTPS");

	test("HTTPS Equals", function () ***REMOVED***
...
if (URI.SCHEMES["urn"]) ***REMOVED***

	//module("URN");

	test("URN Parsing", function () ***REMOVED***
	...
	***REMOVED***);
	...
	test("URN Serialization", function () ***REMOVED***
		//example from RFC 2141
		var components = ***REMOVED***
			scheme : "urn",
			nid : "foo",
	...
	***REMOVED***);
	...
	test("URN Equals", function () ***REMOVED***
		//test from RFC 2141
	...
	***REMOVED***);
	...
	test("URN Resolving", function () ***REMOVED***
	...
	***REMOVED***);
	...
	test("UUID Parsing", function () ***REMOVED***
	...
	***REMOVED***);
	...
	test("UUID Serialization", function () ***REMOVED***
		//example from RFC 4122
		var components = ***REMOVED***
			scheme : "urn",
			nid : "uuid",
	...
	***REMOVED***);
	...
	test("UUID Equals", function () ***REMOVED***
		strictEqual(URI.equal("URN:UUID:F81D4FAE-7DEC-11D0-A765-00A0C91E6BF6", "urn:uuid:f81d4fae-7dec-11d0-a765-00a0c91e6bf6"), true);
	***REMOVED***);

	test("URN NID Override", function () ***REMOVED***
		var components = URI.parse("urn:foo:f81d4fae-7dec-11d0-a765-00a0c91e6bf6", ***REMOVED***nid:"uuid"***REMOVED***);
		strictEqual(components.error, undefined, "errors");
		strictEqual(components.scheme, "urn", "scheme");
		strictEqual(components.path, undefined, "path");
		strictEqual(components.nid, "foo", "nid");
		...
		var components = ***REMOVED***
			...
			uuid : "f81d4fae-7dec-11d0-a765-00a0c91e6bf6"
		***REMOVED***;
		strictEqual(URI.serialize(components, ***REMOVED***nid:"uuid"***REMOVED***), "urn:foo:f81d4fae-7dec-11d0-a765-00a0c91e6bf6");
	***REMOVED***);
***REMOVED***
...
if (URI.SCHEMES["mailto"]) ***REMOVED***

	//module("Mailto");

	test("Mailto Parse", function () ***REMOVED***
		var components;
		...
		deepEqual(components.headers, ***REMOVED***"In-Reply-To":"<3469A91.D10AF4C@example.com>"***REMOVED***, "headers");
		...
		deepEqual(components.headers, ***REMOVED***"cc":"bob@example.com"***REMOVED***, "headers");
		...
		deepEqual(components.headers, ***REMOVED***"blat":"foop"***REMOVED***, "headers");
	...
	***REMOVED***);
	...
	test("Mailto Serialize", function () ***REMOVED***
		var components;

		//tests from RFC 6068
		strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ["chris@example.com"]***REMOVED***), "mailto:chris@example.com");
		strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ["infobot@example.com"], body : "current-issue"***REMOVED***), "mailto:infobot@example.com?body=current-issue");
		strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ["infobot@example.com"], body : "send current-issue"***REMOVED***), "mailto:infobot@example.com?body=send%20current-issue");
		strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ["infobot@example.com"], body : "send current-issue\x0D\x0Asend index"***REMOVED***), "mailto:infobot@example.com?body=send%20current-issue%0D%0Asend%20index");
		strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ["list@example.org"], headers : ***REMOVED***"In-Reply-To" : "<3469A91.D10AF4C@example.com>"***REMOVED******REMOVED***), "mailto:list@example.org?In-Reply-To=%3C3469A91.D10AF4C@example.com%3E");
		strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ["majordomo@example.com"], body : "subscribe bamboo-l"***REMOVED***), "mailto:majordomo@example.com?body=subscribe%20bamboo-l");
		strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ["joe@example.com"], headers : ***REMOVED***"cc" : "bob@example.com", "body" : "hello"***REMOVED******REMOVED***), "mailto:joe@example.com?cc=bob@example.com&body=hello");
		strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ["gorby%25kremvax@example.com"]***REMOVED***), "mailto:gorby%25kremvax@example.com");
		strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ["unlikely%3Faddress@example.com"], headers : ***REMOVED***"blat" : "foop"***REMOVED******REMOVED***), "mailto:unlikely%3Faddress@example.com?blat=foop");
		strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ["Mike&family@example.org"]***REMOVED***), "mailto:Mike%26family@example.org");
		strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ['"not@me"@example.org']***REMOVED***), "mailto:%22not%40me%22@example.org");
		strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ['"oh\\\\no"@example.org']***REMOVED***), "mailto:%22oh%5C%5Cno%22@example.org");
		strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ['"\\\\\\"it\'s\\ ugly\\\\\\""@example.org']***REMOVED***), "mailto:%22%5C%5C%5C%22it's%5C%20ugly%5C%5C%5C%22%22@example.org");
		strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ["user@example.org"], subject : "caf\xE9"***REMOVED***), "mailto:user@example.org?subject=caf%C3%A9");
		strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ["user@example.org"], subject : "=?utf-8?Q?caf=C3=A9?="***REMOVED***), "mailto:user@example.org?subject=%3D%3Futf-8%3FQ%3Fcaf%3DC3%3DA9%3F%3D");
		strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ["user@example.org"], subject : "=?iso-8859-1?Q?caf=E9?="***REMOVED***), "mailto:user@example.org?subject=%3D%3Fiso-8859-1%3FQ%3Fcaf%3DE9%3F%3D");
		strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ["user@example.org"], subject : "caf\xE9", body : "caf\xE9"***REMOVED***), "mailto:user@example.org?subject=caf%C3%A9&body=caf%C3%A9");
		if (URI.IRI_SUPPORT) ***REMOVED***
			strictEqual(URI.serialize(***REMOVED***scheme : "mailto", to : ["us\xE9r@\u7d0d\u8c46.example.org"], subject : "Test", body : "NATTO"***REMOVED***), "mailto:us%C3%A9r@xn--99zt52a.example.org?subject=Test&body=NATTO");
		***REMOVED***

	***REMOVED***);

	test("Mailto Equals", function () ***REMOVED***
		//tests from RFC 6068
