...
var RuleWalker = (function (_super) ***REMOVED***
    ...
    ***REMOVED***
    RuleWalker.prototype.visitArrowFunction = function (node) ***REMOVED***
        ...
        if (node.parameters.length === 1) ***REMOVED***
            ...
            if (this.requireForBlockBody) ***REMOVED***
                if (isSingleIdentifier && !node.type && !bodyIsBlock) ***REMOVED***
                    if (hasParens) ***REMOVED***
                        this.report(position - 1, parensWidth, block);
                    ***REMOVED***
                    return;
                ***REMOVED***
                if (bodyIsBlock && !isGenerics) ***REMOVED***
                    if (!hasParens) ***REMOVED***
                ...
                ***REMOVED***
            ***REMOVED***
            if (this.asNeeded && isSingleIdentifier && !node.type) ***REMOVED***
                if (hasParens) ***REMOVED***
                    this.report(position - 1, parensWidth, asNeeded);
                ***REMOVED***
                return;
            ***REMOVED***
            if (!hasParens && !isGenerics) ***REMOVED***
                this.report(position, paramWidth, always);
            ***REMOVED***
        ***REMOVED***
    ***REMOVED***;
    RuleWalker.prototype.report = function (position, width, message) ***REMOVED***
