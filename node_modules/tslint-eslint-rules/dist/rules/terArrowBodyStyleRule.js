...
var RuleWalker = (function (_super) ***REMOVED***
    ...
    function RuleWalker(sourceFile, options) ***REMOVED***
        ...
        return _this;
    ***REMOVED***
    RuleWalker.prototype.visitArrowFunction = function (node) ***REMOVED***
        var arrowBody = node.body;
        if (arrowBody.kind === ts.SyntaxKind.Block) ***REMOVED***
            var blockBody = arrowBody.statements;
            if (blockBody.length !== 1 && !this.never) ***REMOVED***
                return;
            ***REMOVED***
            ...
            if (this.asNeeded &&
                ...
                (returnExpression && this.isObjectLiteral(returnExpression))) ***REMOVED***
                return;
            ***REMOVED***
            if (this.never || this.asNeeded && blockBody[0].kind === ts.SyntaxKind.ReturnStatement) ***REMOVED***
        ...
        ***REMOVED***
            ...
            if (this.always || (this.asNeeded &&
                this.requireReturnForObjectLiteral &&
                this.isObjectLiteral(arrowBody))) ***REMOVED***
                this.report(arrowBody, true);
            ***REMOVED***
        ***REMOVED***
        _super.prototype.visitArrowFunction.call(this, node);
    ***REMOVED***;
    RuleWalker.prototype.isObjectLiteral = function (node) ***REMOVED***
        var obj = node;
        while (obj.kind === ts.SyntaxKind.ParenthesizedExpression) ***REMOVED***
            obj = node.expression;
        ***REMOVED***
        return obj.kind === ts.SyntaxKind.ObjectLiteralExpression;
    ***REMOVED***;
    RuleWalker.prototype.report = function (arrowBody, expected) ***REMOVED***
