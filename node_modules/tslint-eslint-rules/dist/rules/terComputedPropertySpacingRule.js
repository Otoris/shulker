...
var Rule = (function (_super) ***REMOVED***
    ...
    ***REMOVED***
    Rule.prototype.formatOptions = function (_a) ***REMOVED***
...
var RuleWalker = (function (_super) ***REMOVED***
    ...
    function RuleWalker() ***REMOVED***
        return _super !== null && _super.apply(this, arguments) || this;
    ***REMOVED***
    RuleWalker.prototype.walk = function (sourceFile) ***REMOVED***
        var _this = this;
        var cb = function (node) ***REMOVED***
            if (node.kind === ts.SyntaxKind.ElementAccessExpression) ***REMOVED***
                _this.checkNode(node, node.getChildAt(1), node.getChildAt(3));
            ***REMOVED***
            else if (node.kind === ts.SyntaxKind.ComputedPropertyName) ***REMOVED***
    ...
    ***REMOVED***;
    RuleWalker.prototype.checkNode = function (node, leftBracketNode, rightBracketNode) ***REMOVED***
        ...
        ***REMOVED***
        ...
        if (this.options.always) ***REMOVED***
        ...
        ***REMOVED***
    ***REMOVED***;
    RuleWalker.prototype.getBeforeWhitespaceLength = function (content, newlinesCountAsWhitespace) ***REMOVED***
        ...
        ***REMOVED***
    ***REMOVED***;
    RuleWalker.prototype.getAfterWhitespaceLength = function (content, newlinesCountAsWhitespace) ***REMOVED***
        var regex = newlinesCountAsWhitespace ? /\s+$/ : /[^\S\n]+$/;
        var match = regex.exec(content);
        if (match) ***REMOVED***
            return match[0].length;
