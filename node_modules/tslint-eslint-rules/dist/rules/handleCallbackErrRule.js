...
exports.Rule = Rule;
var ErrCallbackHandlerWalker = (function (_super) ***REMOVED***
    tslib_1.__extends(ErrCallbackHandlerWalker, _super);
    function ErrCallbackHandlerWalker(sourceFile, options) ***REMOVED***
        ...
        var optObj = opt[0];
        if (typeof opt[0] === 'string') ***REMOVED***
            errorArgument = opt[0];
            optObj = opt[1];
        ***REMOVED***
        if (optObj) ***REMOVED***
        ...
        ***REMOVED***
        if (errorArgument.charAt(0) === '^') ***REMOVED***
            _this.errorCheck = RegExp.prototype.test.bind(new RegExp(errorArgument));
        ***REMOVED***
        else ***REMOVED***
            _this.errorCheck = (function (name) ***REMOVED*** return name === errorArgument; ***REMOVED***);
        ***REMOVED***
        _this.firstParameterName = function (node) ***REMOVED***
            var param = node.parameters[0];
            return param ? param.name.getText(sourceFile) : undefined;
        ***REMOVED***;
        return _this;
    ***REMOVED***
    ErrCallbackHandlerWalker.prototype.enterScope = function (firstParamName) ***REMOVED***
        this.stack.push(***REMOVED***
            firstParamName: firstParamName,
            hasFirstParam: false
        ***REMOVED***);
    ***REMOVED***;
    ErrCallbackHandlerWalker.prototype.exitScope = function () ***REMOVED***
        return this.stack.pop();
    ***REMOVED***;
    ErrCallbackHandlerWalker.prototype.visitSourceFile = function (node) ***REMOVED***
        this.stack = [];
        _super.prototype.visitSourceFile.call(this, node);
    ***REMOVED***;
    ErrCallbackHandlerWalker.prototype.visitFunctionDeclaration = function (node) ***REMOVED***
        this.enterScope(this.firstParameterName(node));
        _super.prototype.visitFunctionDeclaration.call(this, node);
        this.exitFunction(node);
    ***REMOVED***;
    ErrCallbackHandlerWalker.prototype.visitFunctionExpression = function (node) ***REMOVED***
        this.enterScope(this.firstParameterName(node));
        _super.prototype.visitFunctionExpression.call(this, node);
        this.exitFunction(node);
    ***REMOVED***;
    ErrCallbackHandlerWalker.prototype.visitArrowFunction = function (node) ***REMOVED***
        this.enterScope(this.firstParameterName(node));
        _super.prototype.visitArrowFunction.call(this, node);
        this.exitFunction(node);
    ***REMOVED***;
    ErrCallbackHandlerWalker.prototype.visitCatchClause = function (node) ***REMOVED***
        this.enterScope(node.variableDeclaration ? node.variableDeclaration.name.getText() : undefined);
        _super.prototype.visitCatchClause.call(this, node);
        this.exitScope();
    ***REMOVED***;
    ErrCallbackHandlerWalker.prototype.exitFunction = function (node) ***REMOVED***
        var scopeInfo = this.exitScope();
        var param = scopeInfo.firstParamName;
        if (param && this.errorCheck(param) && !scopeInfo.hasFirstParam) ***REMOVED***
        ...
        ***REMOVED***
    ***REMOVED***;
    ErrCallbackHandlerWalker.prototype.isPropAccess = function (node) ***REMOVED***
        return node.kind === ts.SyntaxKind.PropertyAccessExpression;
    ***REMOVED***;
    ErrCallbackHandlerWalker.prototype.visitNode = function (node) ***REMOVED***
        if (this.stack.length > 0 &&
            node.kind === ts.SyntaxKind.Identifier &&
            node.parent &&
            node.parent.kind !== ts.SyntaxKind.Parameter) ***REMOVED***
            var doCheck = false;
            var inPropertyAccess = this.isPropAccess(node.parent);
            if (!this.allowProperties) ***REMOVED***
                doCheck = !inPropertyAccess;
            ***REMOVED***
            else if (inPropertyAccess) ***REMOVED***
            ...
            ***REMOVED***
            if (doCheck) ***REMOVED***
                ...
                while (i--) ***REMOVED***
                    ...
                    if (text === info.firstParamName) ***REMOVED***
