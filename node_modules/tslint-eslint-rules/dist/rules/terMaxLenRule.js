...
function computeLineLength(line, tabWidth) ***REMOVED***
    ...
    line.replace(/\t/g, function (_, offset) ***REMOVED***
...
function groupByLineNumber(acc, node) ***REMOVED***
    ...
    var endLoc = node.end;
    for (var i = startLoc[0]; i <= endLoc[0]; ++i) ***REMOVED***
        if (!Array.isArray(acc[i])) ***REMOVED***
            acc[i] = [];
        ***REMOVED***
        acc[i].push(node);
    ***REMOVED***
...
var Rule = (function (_super) ***REMOVED***
    ...
    ***REMOVED***
    Rule.mergeOptions = function (options) ***REMOVED***
        var optionsObj = ***REMOVED******REMOVED***;
        var obj = options[0];
        ...
        ***REMOVED***
        if (typeof obj === 'number') ***REMOVED***
            ...
            obj = options[2];
        ***REMOVED***
        if (typeof obj === 'object' && !Array.isArray(obj)) ***REMOVED***
        ...
        ***REMOVED***
        ...
        return optionsObj;
    ***REMOVED***;
    Rule.prototype.isEnabled = function () ***REMOVED***
        if (_super.prototype.isEnabled.call(this)) ***REMOVED***
            var options = this.getOptions().ruleArguments;
            var option = options[0];
            if (typeof option === 'number' && option > 0) ***REMOVED***
                return true;
            ***REMOVED***
            var optionsObj = Rule.mergeOptions(options);
            if (optionsObj[CODE]) ***REMOVED***
                return true;
            ***REMOVED***
        ***REMOVED***
        return false;
                    ...
                    properties: (_a = ***REMOVED******REMOVED***,
                        ...
                        ***REMOVED***,
                        _a[COMMENTS] = ***REMOVED***
                            ...
                            minumum: '1'
                        ***REMOVED***,
                        _a[TAB_WIDTH] = ***REMOVED***
                            type: 'number',
                            minumum: '1'
                        ***REMOVED***,
                        _a[IGNORE_PATTERN] = ***REMOVED***
                            type: 'string'
                        ***REMOVED***,
                        _a[IGNORE_COMMENTS] = ***REMOVED***
                            type: 'boolean'
                        ***REMOVED***,
                        _a[IGNORE_STRINGS] = ***REMOVED***
                            type: 'boolean'
                        ***REMOVED***,
                        _a[IGNORE_URLS] = ***REMOVED***
                            type: 'boolean'
                        ***REMOVED***,
                        _a[IGNORE_TEMPLATE_LITERALS] = ***REMOVED***
                            type: 'boolean'
                        ***REMOVED***,
                        _a[IGNORE_REG_EXP_LITERALS] = ***REMOVED***
                            type: 'boolean'
                        ***REMOVED***,
                        _a[IGNORE_TRAILING_COMMENTS] = ***REMOVED***
                            type: 'boolean'
                        ***REMOVED***,
                        _a[IGNORE_IMPORTS] = ***REMOVED***
                            type: 'boolean'
                        ***REMOVED***,
                        _a),
...
exports.Rule = Rule;
var MaxLenWalker = (function (_super) ***REMOVED***
    tslib_1.__extends(MaxLenWalker, _super);
    function MaxLenWalker(sourceFile, options) ***REMOVED***
        var _this = _super.call(this, sourceFile, options) || this;
        _this.ignoredIntervals = [];
        _this.optionsObj = ***REMOVED******REMOVED***;
        _this.comments = [];
        _this.strings = [];
        _this.templates = [];
        _this.regExp = [];
        ...
        return _this;
    ***REMOVED***
    MaxLenWalker.prototype.hasOption = function (option) ***REMOVED***
        if (this.optionsObj[option] && this.optionsObj[option]) ***REMOVED***
            return true;
        ***REMOVED***
        return false;
    ***REMOVED***;
    MaxLenWalker.prototype.getOption = function (option) ***REMOVED***
        return this.optionsObj[option];
    ***REMOVED***;
    MaxLenWalker.prototype.visitStringLiteral = function (node) ***REMOVED***
        this.strings.push(this.getINode(node.kind, node.getText(), node.getStart()));
        _super.prototype.visitStringLiteral.call(this, node);
    ***REMOVED***;
    MaxLenWalker.prototype.visitRegularExpressionLiteral = function (node) ***REMOVED***
    ...
    ***REMOVED***;
    MaxLenWalker.prototype.getINode = function (kind, text, startPos) ***REMOVED***
        ...
        ***REMOVED***;
    ***REMOVED***;
    MaxLenWalker.prototype.visitSourceFile = function (node) ***REMOVED***
        var _this = this;
        _super.prototype.visitSourceFile.call(this, node);
        tsutils_1.forEachTokenWithTrivia(node, function (text, token, range) ***REMOVED***
            if (token === ts.SyntaxKind.SingleLineCommentTrivia ||
                token === ts.SyntaxKind.MultiLineCommentTrivia) ***REMOVED***
                _this.comments.push(_this.getINode(token, text.substring(range.pos, range.end), range.pos));
            ***REMOVED***
            else if (token === ts.SyntaxKind.FirstTemplateToken) ***REMOVED***
                _this.templates.push(_this.getINode(token, text.substring(range.pos, range.end), range.pos));
            ***REMOVED***
        ***REMOVED***);
        this.findFailures(node);
    ***REMOVED***;
    MaxLenWalker.prototype.visitImportDeclaration = function (node) ***REMOVED***
        _super.prototype.visitImportDeclaration.call(this, node);
        var startPos = node.moduleSpecifier.getStart();
        var text = node.moduleSpecifier.getText();
        var width = text.length;
        if (this.hasOption(IGNORE_IMPORTS)) ***REMOVED***
            this.ignoredIntervals.push(***REMOVED***
                endPosition: startPos + width,
                startPosition: startPos
            ***REMOVED***);
        ***REMOVED***
    ***REMOVED***;
    MaxLenWalker.prototype.findFailures = function (sourceFile) ***REMOVED***
        ...
        var commentsIndex = 0;
        var stringsByLine = this.strings.reduce(groupByLineNumber, ***REMOVED******REMOVED***);
        var templatesByLine = this.templates.reduce(groupByLineNumber, ***REMOVED******REMOVED***);
        var regExpByLine = this.regExp.reduce(groupByLineNumber, ***REMOVED******REMOVED***);
        var totalLines = lineStarts.length;
        for (var i = 0; i < totalLines; ++i) ***REMOVED***
            ...
            if (commentsIndex < comments.length) ***REMOVED***
                ...
                ***REMOVED*** while (comment && comment.start[0] <= i);
                comment = comments[--commentsIndex];
                if (isFullLineComment(line, i, comment)) ***REMOVED***
                    lineIsComment = true;
                ***REMOVED***
                else if (ignoreTrailingComments && isTrailingComment(line, i, comment)) ***REMOVED***
            ...
            ***REMOVED***
            if (ignoreUrls && Rule.URL_REGEXP.test(line) ||
                ...
                ignoreRexExpLiterals && regExpByLine[i]) ***REMOVED***
                continue;
            ***REMOVED***
            ...
            ***REMOVED***
            ...
            if (lineIsComment && exceedLineLimit(lineLength, maxCommentLength, source[to - 2])) ***REMOVED***
            ...
            ***REMOVED***
            else if (exceedLineLimit(lineLength, lineLimit, source[to - 2])) ***REMOVED***
                ruleFailure = new Lint.RuleFailure(sourceFile, from, to - 1, "Line " + (i + 1) + " exceeds the maximum line length of " + lineLimit + ".", RULE_NAME);
            ***REMOVED***
            if (ruleFailure && !Lint.doesIntersect(ruleFailure, this.ignoredIntervals)) ***REMOVED***
...
function exceedLineLimit(lineLength, lineLimit, secondToLast) ***REMOVED***
