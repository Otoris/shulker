...
var Rule = (function (_super) ***REMOVED***
    ...
    ***REMOVED***
    Rule.FAILURE_STRING = function (expected, mixed) ***REMOVED***
        if (!mixed) ***REMOVED***
            return expected + " indentation expected";
        ***REMOVED***
        return "indentation has mixed tabs and spaces";
    ***REMOVED***;
    Rule.prototype.formatOptions = function (ruleArguments) ***REMOVED***
        var tabs = undefined;
        var smartTabs = false;
...
function walk(ctx) ***REMOVED***
    ...
    ***REMOVED***
    ...
    for (var _i = 0, _b = tsutils_1.getLineRanges(sourceFile); _i < _b.length; _i++) ***REMOVED***
        ...
        ***REMOVED***
        ...
        if (indentEnd === 0) ***REMOVED***
            continue;
        ***REMOVED***
        if (indentEnd === -1) ***REMOVED***
            indentEnd = contentLength;
        ***REMOVED***
        var indentSpace = line.slice(0, indentEnd);
        if (!regExp.test(indentSpace)) ***REMOVED***
            continue;
        ***REMOVED***
        var token = tsutils_1.getTokenAtPosition(sourceFile, pos);
        if (token.kind !== ts.SyntaxKind.JsxText &&
            (pos >= token.getStart(sourceFile) || tsutils_1.isPositionInComment(sourceFile, pos, token))) ***REMOVED***
            continue;
        ***REMOVED***
