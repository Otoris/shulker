...
parse('***REMOVED***a: String, b: Number***REMOVED***', '***REMOVED***a: str, b: 2***REMOVED***'); // ***REMOVED***a: 'str', b: 2***REMOVED***

// at the top level, you can ommit surrounding delimiters
parse('[Number]', '1,2,3');                      // [1,2,3]
parse('(String, Boolean)', 'hi, false');         // ['hi', false]
parse('***REMOVED***a: String, b: Number***REMOVED***', 'a: str, b: 2'); // ***REMOVED***a: 'str', b: 2***REMOVED***

// wildcard - auto choose type
parse('*', '[hi,(null,[42]),***REMOVED***k: true***REMOVED***]'); // ['hi', [null, [42]], ***REMOVED***k: true***REMOVED***]
```
## Usage
...
* `***REMOVED***key1: val1, key2: val2, ...***REMOVED***` is an Object, and the casting procedure is recursively applied to each property. Eg. `***REMOVED***a: 1, b: 2***REMOVED***` is `***REMOVED***a: 1, b: 2***REMOVED***`.
* Any test which does not fall under the above, and which does not contain special characters (`[``]``(``)``***REMOVED***``***REMOVED***``:``,`) is a string, eg. `$12- blah` is `"$12- blah"`.
...
* If a String is expected, and only a String, all characters of the input (including any special ones) will become part of the output. Eg. `[(***REMOVED******REMOVED***)]` is `"[(***REMOVED******REMOVED***)]"`, and `"hi"` is `'"hi"'`.
...
* If an Object is expected, and it is the root node (at the top level), the opening `***REMOVED***` and closing `***REMOVED***` can be omitted. Eg `a: 1, b: 2` is `***REMOVED***a: 1, b: 2***REMOVED***`.
...
```js
parse('RegExp', 're', ***REMOVED***explicit: false***REMOVED***);          // /re/
parse('RegExp', 're', ***REMOVED***explicit: true***REMOVED***);           // Error: ... does not type check...
parse('RegExp | String', 're', ***REMOVED***explicit: true***REMOVED***);  // 're'
```
...
An `Object`. Empty `***REMOVED******REMOVED***` by default.
    ...
    Even: ***REMOVED***
      ...
      ***REMOVED***,
      cast: function (x) ***REMOVED***
        return ***REMOVED***type: 'Just', value: parseInt(x)***REMOVED***;
      ***REMOVED***
    ***REMOVED***
  ***REMOVED***
***REMOVED***
    ...
    Person: ***REMOVED***
      ...
      ***REMOVED***,
      cast: function (value, options, typesCast) ***REMOVED***
        var name, age;
        if (***REMOVED******REMOVED***.toString.call(value).slice(8, -1) !== 'Object') ***REMOVED***
          return ***REMOVED***type: 'Nothing'***REMOVED***;
        ***REMOVED***
        name = typesCast(value.name, [***REMOVED***type: 'String'***REMOVED***], options);
        age = typesCast(value.age, [***REMOVED***type: 'Numger'***REMOVED***], options);
        return ***REMOVED***type: 'Just', value: new Person(name, age)***REMOVED***;
    ***REMOVED***
  ***REMOVED***
***REMOVED***
parse('Person', '***REMOVED***name: Laura, age: 25***REMOVED***', options); // Person ***REMOVED***name: 'Laura', age: 25***REMOVED***
```
...
`cast` is a function which receives three arguments, the value under question, options, and the typesCast function. In `cast`, attempt to cast the value into the specified type. If you are successful, return an object in the format `***REMOVED***type: 'Just', value: CAST-VALUE***REMOVED***`, if you know it won't work, return `***REMOVED***type: 'Nothing'***REMOVED***`.  You can use the `typesCast` function to cast any child values. Remember to pass `options` to it. In your function you can also check for `options.explicit` and act accordingly.
