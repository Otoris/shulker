 ...
 * @returns ***REMOVED***border***REMOVED***
 */
const getBorderCharacters = name => ***REMOVED***
  if (name === 'honeywell') ***REMOVED***
    return ***REMOVED***
      topBody: '═',
      topJoin: '╤',
      topLeft: '╔',
