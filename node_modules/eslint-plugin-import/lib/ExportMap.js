...
class ExportMap ***REMOVED***
  constructor(path) ***REMOVED***
    ...
    /**
     * star-exports
     * @type ***REMOVED***Set***REMOVED*** of () => ExportMap
     */
    this.dependencies = new Set();
    /**
     * dependencies of this module that are not explicitly re-exported
     * @type ***REMOVED***Map***REMOVED*** from path = () => ExportMap
     */
    this.imports = new Map();
    this.errors = [];
  ***REMOVED***

  get hasDefault() ***REMOVED***
    return this.get('default') != null;
  ***REMOVED*** // stronger than this.has
  ...
  ***REMOVED***
   ...
   * @return ***REMOVED***Boolean***REMOVED*** true if `name` is exported by this module.
   */
  has(name) ***REMOVED***
    ...
    if (name !== 'default') ***REMOVED***
      for (let dep of this.dependencies) ***REMOVED***
        let innerMap = dep();
  ...
  ***REMOVED***
   ...
   * @param  ***REMOVED***[type]***REMOVED***  name [description]
   * @return ***REMOVED***Boolean***REMOVED***      [description]
   */
  hasDeep(name) ***REMOVED***
    if (this.namespace.has(name)) return ***REMOVED*** found: true, path: [this] ***REMOVED***;

    if (this.reexports.has(name)) ***REMOVED***
      const reexports = this.reexports.get(name),
            imported = reexports.getImport();

      // if import is ignored, return explicit 'null'
      if (imported == null) return ***REMOVED*** found: true, path: [this]

        // safeguard against cycles, only if name matches
      ***REMOVED***;if (imported.path === this.path && reexports.local === name) ***REMOVED***
        return ***REMOVED*** found: false, path: [this] ***REMOVED***;
      ***REMOVED***
  ...
  ***REMOVED***
  ...
  forEach(callback, thisArg) ***REMOVED***
    ...
    this.reexports.forEach((reexports, name) => ***REMOVED***
  ...
  ***REMOVED***
  ...
  reportErrors(context, declaration) ***REMOVED***
    context.report(***REMOVED***
      node: declaration.source,
      message: `Parse errors in imported module '$***REMOVED***declaration.source.value***REMOVED***': ` + `$***REMOVED***this.errors.map(e => `$***REMOVED***e.message***REMOVED*** ($***REMOVED***e.lineNumber***REMOVED***:$***REMOVED***e.column***REMOVED***)`).join(', ')***REMOVED***`
    ***REMOVED***);
  ***REMOVED***
***REMOVED***
...
function captureDoc(source, docStyleParsers) ***REMOVED***
  const metadata = ***REMOVED******REMOVED***;

  // 'some' short-circuits on first 'true'

  for (var _len = arguments.length, nodes = Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) ***REMOVED***
    nodes[_key - 2] = arguments[_key];
  ***REMOVED***

  nodes.some(n => ***REMOVED***
    try ***REMOVED***

      let leadingComments;

      // n.leadingComments is legacy `attachComments` behavior
      if ('leadingComments' in n) ***REMOVED***
        leadingComments = n.leadingComments;
      ***REMOVED*** else if (n.range) ***REMOVED***
        leadingComments = source.getCommentsBefore(n);
      ***REMOVED***

      if (!leadingComments || leadingComments.length === 0) return false;

      for (let name in docStyleParsers) ***REMOVED***
...
const availableDocStyleParsers = ***REMOVED***
  jsdoc: captureJsDoc,
  tomdoc: captureTomDoc

  /**
   * parse JSDoc from leading comments
   * @param  ***REMOVED***...[type]***REMOVED*** comments [description]
   * @return ***REMOVED******REMOVED***doc: object***REMOVED******REMOVED***
   */
***REMOVED***;function captureJsDoc(comments) ***REMOVED***
  let doc;
  ...
  comments.forEach(comment => ***REMOVED***
    ...
    try ***REMOVED***
      doc = _doctrine2.default.parse(comment.value, ***REMOVED*** unwrap: true ***REMOVED***);
    ***REMOVED*** catch (err) ***REMOVED***
...
/**
  ...
  */
function captureTomDoc(comments) ***REMOVED***
...
ExportMap.get = function (source, context) ***REMOVED***
...
ExportMap.for = function (context) ***REMOVED***
  ...
  if (exportMap != null) ***REMOVED***
    // date equality check
    if (exportMap.mtime - stats.mtime === 0) ***REMOVED***
      return exportMap;
    ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!(0, _ignore.hasValidExtension)(path, context)) ***REMOVED***
    exportCache.set(cacheKey, null);
    return null;
  ***REMOVED***

  const content = _fs2.default.readFileSync(path, ***REMOVED*** encoding: 'utf8' ***REMOVED***);

  // check for and cache ignore
  if ((0, _ignore2.default)(path, context) || !unambiguous.test(content)) ***REMOVED***
...
ExportMap.parse = function (path, content, context) ***REMOVED***
  ...
  ***REMOVED***
  ...
  const docStyleParsers = ***REMOVED******REMOVED***;
  docstyle.forEach(style => ***REMOVED***
    docStyleParsers[style] = availableDocStyleParsers[style];
  ***REMOVED***);

  // attempt to collect module doc
  if (ast.comments) ***REMOVED***
    ast.comments.some(c => ***REMOVED***
      if (c.type !== 'Block') return false;
      try ***REMOVED***
        const doc = _doctrine2.default.parse(c.value, ***REMOVED*** unwrap: true ***REMOVED***);
        if (doc.tags.some(t => t.title === 'module')) ***REMOVED***
          m.doc = doc;
          return true;
        ***REMOVED***
      ***REMOVED*** catch (err) ***REMOVED***/* ignore */***REMOVED***
      return false;
    ***REMOVED***);
  ***REMOVED***
  ...
  function remotePath(value) ***REMOVED***
    return _resolve2.default.relative(value, path, context.settings);
  ***REMOVED***

  function resolveImport(value) ***REMOVED***
    const rp = remotePath(value);
    if (rp == null) return null;
    return ExportMap.for(childContext(rp, context));
  ***REMOVED***

  function getNamespace(identifier) ***REMOVED***
  ...
  ***REMOVED***
  ...
  function addNamespace(object, identifier) ***REMOVED***
    const nsfn = getNamespace(identifier);
    if (nsfn) ***REMOVED***
      Object.defineProperty(object, 'namespace', ***REMOVED*** get: nsfn ***REMOVED***);
    ***REMOVED***

    return object;
  ***REMOVED***

  function captureDependency(declaration) ***REMOVED***
    if (declaration.source == null) return null;
    const importedSpecifiers = new Set();
    const supportedTypes = new Set(['ImportDefaultSpecifier', 'ImportNamespaceSpecifier']);
    if (declaration.specifiers) ***REMOVED***
      declaration.specifiers.forEach(specifier => ***REMOVED***
        if (supportedTypes.has(specifier.type)) ***REMOVED***
          importedSpecifiers.add(specifier.type);
        ***REMOVED***
        if (specifier.type === 'ImportSpecifier') ***REMOVED***
    ...
    ***REMOVED***
    ...
    m.imports.set(p, ***REMOVED***
      getter,
      source: ***REMOVED*** // capturing actual node reference holds full AST in memory!
  ...
  ***REMOVED***
  ...
  ast.body.forEach(function (n) ***REMOVED***

    if (n.type === 'ExportDefaultDeclaration') ***REMOVED***
      const exportMeta = captureDoc(source, docStyleParsers, n);
      if (n.declaration.type === 'Identifier') ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (n.type === 'ExportAllDeclaration') ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (n.type === 'ImportDeclaration') ***REMOVED***
      captureDependency(n);
      let ns;
      if (n.specifiers.some(s => s.type === 'ImportNamespaceSpecifier' && (ns = s))) ***REMOVED***
        namespaces.set(ns.local.name, n.source.value);
      ***REMOVED***
      return;
    ***REMOVED***

    if (n.type === 'ExportNamedDeclaration') ***REMOVED***
      // capture declaration
      if (n.declaration != null) ***REMOVED***
        switch (n.declaration.type) ***REMOVED***
      ...
      ***REMOVED***
      ...
      n.specifiers.forEach(s => ***REMOVED***
        const exportMeta = ***REMOVED******REMOVED***;
        let local;
        ...
        switch (s.type) ***REMOVED***
          ...
          case 'ExportNamespaceSpecifier':
            m.namespace.set(s.exported.name, Object.defineProperty(exportMeta, 'namespace', ***REMOVED***
              get() ***REMOVED***
        ...
        ***REMOVED***
        ...
        // todo: JSDoc
        m.reexports.set(s.exported.name, ***REMOVED*** local, getImport: () => resolveImport(nsource) ***REMOVED***);
      ***REMOVED***);
    ***REMOVED***

    // This doesn't declare anything, but changes what's being exported.
    if (n.type === 'TSExportAssignment') ***REMOVED***
      const moduleDecl = ast.body.find(bodyNode => bodyNode.type === 'TSModuleDeclaration' && bodyNode.id.name === n.expression.name);
      if (moduleDecl && moduleDecl.body && moduleDecl.body.body) ***REMOVED***
        moduleDecl.body.body.forEach(moduleBlockNode => ***REMOVED***
          ...
          if (exportedDecl.type === 'VariableDeclaration') ***REMOVED***
 ...
 */
function thunkFor(p, context) ***REMOVED***
 ...
 * @param  ***REMOVED***node***REMOVED***   pattern
 * @param  ***REMOVED***Function***REMOVED*** callback
 * @return ***REMOVED***void***REMOVED***
 */
function recursivePatternCapture(pattern, callback) ***REMOVED***
  switch (pattern.type) ***REMOVED***
    case 'Identifier':
      // base case
      callback(pattern);
      break;
    ...
    case 'ObjectPattern':
      pattern.properties.forEach(p => ***REMOVED***
        recursivePatternCapture(p.value, callback);
      ***REMOVED***);
      break;

    case 'ArrayPattern':
      pattern.elements.forEach(element => ***REMOVED***
 ...
 */
function childContext(path, context) ***REMOVED***
 ...
 */
function makeSourceCode(text, ast) ***REMOVED***
  if (_eslint.SourceCode.length > 1) ***REMOVED***
    // ESLint 3
    return new _eslint.SourceCode(text, ast);
  ***REMOVED*** else ***REMOVED***
    // ESLint 4, 5
    return new _eslint.SourceCode(***REMOVED*** text, ast ***REMOVED***);
  ***REMOVED***
***REMOVED***
