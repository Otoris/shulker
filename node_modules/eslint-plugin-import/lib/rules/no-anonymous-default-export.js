...
const schemaProperties = Object.keys(defs).map(key => defs[key]).reduce((acc, def) => ***REMOVED***
  acc[def.option] = ***REMOVED***
...
const defaults = Object.keys(defs).map(key => defs[key]).reduce((acc, def) => ***REMOVED***
...
module.exports = ***REMOVED***
  ...
  ***REMOVED***,
  ...
  create: function (context) ***REMOVED***
    const options = Object.assign(***REMOVED******REMOVED***, defaults, context.options[0]);
    ...
    return ***REMOVED***
      'ExportDefaultDeclaration': node => ***REMOVED***
        ...
        if (def && !options[def.option] && (!def.forbid || def.forbid(node))) ***REMOVED***
          context.report(***REMOVED*** node, message: def.message ***REMOVED***);
        ***REMOVED***
      ***REMOVED***
    ***REMOVED***;
  ***REMOVED***
