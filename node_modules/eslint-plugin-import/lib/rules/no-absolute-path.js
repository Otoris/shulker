...
module.exports = ***REMOVED***
  ...
  ***REMOVED***,
  ...
  create: function (context) ***REMOVED***
    function reportIfAbsolute(source) ***REMOVED***
      if ((0, _importType.isAbsolute)(source.value)) ***REMOVED***
        context.report(source, 'Do not import modules using an absolute path');
      ***REMOVED***
    ***REMOVED***

    const options = Object.assign(***REMOVED*** esmodule: true, commonjs: true ***REMOVED***, context.options[0]);
