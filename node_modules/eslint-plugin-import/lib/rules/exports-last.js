...
function isNonExportStatement(_ref) ***REMOVED***
  let type = _ref.type;
  ...
  create: function (context) ***REMOVED***
    return ***REMOVED***
      Program: function (_ref2) ***REMOVED***
        ...
        const lastNonExportStatementIndex = body.reduce(function findLastIndex(acc, item, index) ***REMOVED***
          if (isNonExportStatement(item)) ***REMOVED***
            return index;
          ***REMOVED***
          return acc;
        ***REMOVED***, -1);

        if (lastNonExportStatementIndex !== -1) ***REMOVED***
          body.slice(0, lastNonExportStatementIndex).forEach(function checkNonExport(node) ***REMOVED***
            if (!isNonExportStatement(node)) ***REMOVED***
