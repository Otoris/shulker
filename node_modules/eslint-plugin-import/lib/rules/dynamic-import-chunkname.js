...
module.exports = ***REMOVED***
    ...
    schema: [***REMOVED***
      ...
      properties: ***REMOVED***
        importFunctions: ***REMOVED***
          ...
          ***REMOVED***
        ***REMOVED***,
        webpackChunknameFormat: ***REMOVED***
          type: 'string'
        ***REMOVED***
      ***REMOVED***
    ***REMOVED***]
  ***REMOVED***,
  ...
  create: function (context) ***REMOVED***
    ...
    const chunkSubstrFormat = ` webpackChunkName: "$***REMOVED***webpackChunknameFormat***REMOVED***",? `;
    const chunkSubstrRegex = new RegExp(chunkSubstrFormat);

    return ***REMOVED***
      CallExpression(node) ***REMOVED***
        if (node.callee.type !== 'Import' && importFunctions.indexOf(node.callee.name) < 0) ***REMOVED***
          return;
        ***REMOVED***
        ...
        if (!leadingComments || leadingComments.length === 0) ***REMOVED***
        ...
        ***REMOVED***
        ...
        for (const comment of leadingComments) ***REMOVED***
          if (comment.type !== 'Block') ***REMOVED***
            context.report(***REMOVED***
              node,
          ...
          ***REMOVED***
          ...
          if (!paddedCommentRegex.test(comment.value)) ***REMOVED***
            context.report(***REMOVED***
              node,
          ...
          ***REMOVED***
          ...
          try ***REMOVED***
            ...
            _vm2.default.runInNewContext(`(function()***REMOVED***return ***REMOVED***$***REMOVED***comment.value***REMOVED******REMOVED******REMOVED***)()`);
          ...
          ***REMOVED***
          ...
          if (!commentStyleRegex.test(comment.value)) ***REMOVED***
            context.report(***REMOVED***
              node,
              message: `dynamic imports require a leading comment in the form /*$***REMOVED***chunkSubstrFormat***REMOVED****/`
            ***REMOVED***);
            return;
          ***REMOVED***

          if (chunkSubstrRegex.test(comment.value)) ***REMOVED***
            isChunknamePresent = true;
          ***REMOVED***
        ***REMOVED***

        if (!isChunknamePresent) ***REMOVED***
          context.report(***REMOVED***
            node,
            message: `dynamic imports require a leading comment in the form /*$***REMOVED***chunkSubstrFormat***REMOVED****/`
          ***REMOVED***);
