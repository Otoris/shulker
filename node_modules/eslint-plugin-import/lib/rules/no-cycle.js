...
module.exports = ***REMOVED***
  meta: ***REMOVED***
    type: 'suggestion',
    docs: ***REMOVED*** url: (0, _docsUrl2.default)('no-cycle') ***REMOVED***,
  ...
  ***REMOVED***,
  ...
  create: function (context) ***REMOVED***
    ...
    function checkSourceValue(sourceNode, importer) ***REMOVED***
      const imported = _ExportMap2.default.get(sourceNode.value, context);

      if (importer.importKind === 'type') ***REMOVED***
        return; // no Flow import resolution
      ***REMOVED***

      if (imported == null) ***REMOVED***
        return; // no-unresolved territory
      ***REMOVED***

      if (imported.path === myPath) ***REMOVED***
        return; // no-self-import territory
      ***REMOVED***

      const untraversed = [***REMOVED*** mget: () => imported, route: [] ***REMOVED***];
      const traversed = new Set();
      function detectCycle(_ref) ***REMOVED***
        let mget = _ref.mget,
            route = _ref.route;
        ...
        for (let _ref2 of m.imports) ***REMOVED***
          ...
          if (route.length + 1 < maxDepth) ***REMOVED***
            untraversed.push(***REMOVED***
              mget: getter,
      ...
      ***REMOVED***
      ...
      while (untraversed.length > 0) ***REMOVED***
        const next = untraversed.shift(); // bfs!
        if (detectCycle(next)) ***REMOVED***
          const message = next.route.length > 0 ? `Dependency cycle via $***REMOVED***routeString(next.route)***REMOVED***` : 'Dependency cycle detected.';
...
function routeString(route) ***REMOVED***
  return route.map(s => `$***REMOVED***s.value***REMOVED***:$***REMOVED***s.loc.start.line***REMOVED***`).join('=>');
***REMOVED***
