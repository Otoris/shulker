...
module.exports = ***REMOVED***
  ...
  ***REMOVED***,
  ...
  create: function (context) ***REMOVED***
    ...
    function checkDefault(specifierType, node) ***REMOVED***

      // poor man's Array.find
      let defaultSpecifier;
      node.specifiers.some(n => ***REMOVED***
        if (n.type === specifierType) ***REMOVED***
          defaultSpecifier = n;
          return true;
        ***REMOVED***
      ***REMOVED***);
      ...
      ***REMOVED*** else if (imports.get('default') === undefined) ***REMOVED***
