...
module.exports = ***REMOVED***
  ...
  ***REMOVED***,
  ...
  create: function namespaceRule(context) ***REMOVED***

    // read options
    var _ref = context.options[0] || ***REMOVED******REMOVED***,
    ...
    function makeMessage(last, namepath) ***REMOVED***
      return `'$***REMOVED***last.name***REMOVED***' not found in` + (namepath.length > 1 ? ' deeply ' : ' ') + `imported namespace '$***REMOVED***namepath.join('.')***REMOVED***'.`;
    ***REMOVED***

    return ***REMOVED***

      // pick up all imports at body entry time, to properly respect hoisting
      Program: function (_ref2) ***REMOVED***
        let body = _ref2.body;

        function processBodyStatement(declaration) ***REMOVED***
          ...
          if (imports.errors.length) ***REMOVED***
            imports.reportErrors(context, declaration);
            return;
          ***REMOVED***

          for (const specifier of declaration.specifiers) ***REMOVED***
            switch (specifier.type) ***REMOVED***
              case 'ImportNamespaceSpecifier':
                if (!imports.size) ***REMOVED***
                  context.report(specifier, `No exported names found in module '$***REMOVED***declaration.source.value***REMOVED***'.`);
                ***REMOVED***
      ...
      ***REMOVED***,
      ...
      ExportNamespaceSpecifier: function (namespace) ***REMOVED***
        ...
        ***REMOVED***
        ...
        if (!imports.size) ***REMOVED***
          context.report(namespace, `No exported names found in module '$***REMOVED***declaration.source.value***REMOVED***'.`);
        ***REMOVED***
      ***REMOVED***,

      // todo: check for possible redefinition

      MemberExpression: function (dereference) ***REMOVED***
        if (dereference.object.type !== 'Identifier') return;
        if (!namespaces.has(dereference.object.name)) return;

        if (dereference.parent.type === 'AssignmentExpression' && dereference.parent.left === dereference) ***REMOVED***
          context.report(dereference.parent, `Assignment to member of namespace '$***REMOVED***dereference.object.name***REMOVED***'.`);
        ***REMOVED***
        ...
        while (namespace instanceof _ExportMap2.default && dereference.type === 'MemberExpression') ***REMOVED***

          if (dereference.computed) ***REMOVED***
            if (!allowComputed) ***REMOVED***
              context.report(dereference.property, 'Unable to validate computed reference to imported namespace \'' + dereference.object.name + '\'.');
            ***REMOVED***
            return;
          ***REMOVED***

          if (!namespace.has(dereference.property.name)) ***REMOVED***
      ...
      ***REMOVED***,
      ...
      VariableDeclarator: function (_ref3) ***REMOVED***
        let id = _ref3.id,
            init = _ref3.init;
        ...
        function testKey(pattern, namespace) ***REMOVED***
          ...
          for (const property of pattern.properties) ***REMOVED***
            if (property.type === 'ExperimentalRestProperty' || property.type === 'RestElement' || !property.key) ***REMOVED***
              continue;
            ***REMOVED***

            if (property.key.type !== 'Identifier') ***REMOVED***
            ...
            ***REMOVED***
            ...
            if (!namespace.has(property.key.name)) ***REMOVED***
              context.report(***REMOVED***
                node: property,
            ...
            ***REMOVED***
            ...
            if (dependencyExportMap !== null) ***REMOVED***
