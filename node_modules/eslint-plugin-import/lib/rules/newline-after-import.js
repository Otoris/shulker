...
function containsNodeOrEqual(outerNode, innerNode) ***REMOVED***
  return outerNode.range[0] <= innerNode.range[0] && outerNode.range[1] >= innerNode.range[1];
***REMOVED***

function getScopeBody(scope) ***REMOVED***
  if (scope.block.type === 'SwitchStatement') ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (body && body.type === 'BlockStatement') ***REMOVED***
    return body.body;
  ***REMOVED***
...
function findNodeIndexInScopeBody(body, nodeToFind) ***REMOVED***
  return body.findIndex(node => containsNodeOrEqual(node, nodeToFind));
***REMOVED***

function getLineDifference(node, nextNode) ***REMOVED***
  return nextNode.loc.start.line - node.loc.end.line;
***REMOVED***

function isClassWithDecorator(node) ***REMOVED***
...
module.exports = ***REMOVED***
  ...
  ***REMOVED***,
  create: function (context) ***REMOVED***
    ...
    function checkForNewLine(node, nextNode, type) ***REMOVED***
      if (isClassWithDecorator(nextNode)) ***REMOVED***
        nextNode = nextNode.decorators[0];
      ***REMOVED***

      const options = context.options[0] || ***REMOVED*** count: 1 ***REMOVED***;
      const lineDifference = getLineDifference(node, nextNode);
      const EXPECTED_LINE_DIFFERENCE = options.count + 1;

      if (lineDifference < EXPECTED_LINE_DIFFERENCE) ***REMOVED***
        let column = node.loc.start.column;

        if (node.loc.start.line !== node.loc.end.line) ***REMOVED***
          column = 0;
        ***REMOVED***
        ...
        context.report(***REMOVED***
          loc: ***REMOVED***
            ...
            column
          ***REMOVED***,
          message: `Expected $***REMOVED***options.count***REMOVED*** empty line$***REMOVED***options.count > 1 ? 's' : ''***REMOVED*** \
after $***REMOVED***type***REMOVED*** statement not followed by another $***REMOVED***type***REMOVED***.`,
    ...
    ***REMOVED***
    ...
    return ***REMOVED***
      ImportDeclaration: function (node) ***REMOVED***
        ...
        if (nextNode && nextNode.type !== 'ImportDeclaration') ***REMOVED***
          checkForNewLine(node, nextNode, 'import');
        ***REMOVED***
      ***REMOVED***,
      CallExpression: function (node) ***REMOVED***
        if ((0, _staticRequire2.default)(node) && level === 0) ***REMOVED***
      ...
      ***REMOVED***,
      'Program:exit': function () ***REMOVED***
        ...
        requireCalls.forEach(function (node, index) ***REMOVED***
          ...
          if (nextRequireCall && containsNodeOrEqual(statementWithRequireCall, nextRequireCall)) ***REMOVED***
            return;
          ***REMOVED***

          if (nextStatement && (!nextRequireCall || !containsNodeOrEqual(nextStatement, nextRequireCall))) ***REMOVED***
