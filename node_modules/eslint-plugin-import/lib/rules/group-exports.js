...
***REMOVED***;const errors = ***REMOVED***
   ...
   * Example:
   *
   * `module.exports = ***REMOVED******REMOVED***` => ['module', 'exports']
   * `module.exports.property = true` => ['module', 'exports', 'property']
   *
   * @param     ***REMOVED***Node***REMOVED***    node    AST Node (MemberExpression)
   * @return    ***REMOVED***Array***REMOVED***           Array with the property names in the chain
   * @private
   */
***REMOVED***;function accessorChain(node) ***REMOVED***
  const chain = [];
...
function create(context) ***REMOVED***
  const nodes = ***REMOVED***
    modules: new Set(),
    commonjs: new Set()
  ***REMOVED***;
  ...
  return ***REMOVED***
    ...
    ***REMOVED***,
    ...
    AssignmentExpression(node) ***REMOVED***
      if (node.left.type !== 'MemberExpression') ***REMOVED***
        return;
      ***REMOVED***
      ...
      if (chain[0] === 'module' && chain[1] === 'exports' && chain.length <= 3) ***REMOVED***
        nodes.commonjs.add(node);
        return;
      ***REMOVED***

      // Assignments to exports (exports.* = *)
      if (chain[0] === 'exports' && chain.length === 2) ***REMOVED***
        nodes.commonjs.add(node);
        return;
      ***REMOVED***
    ***REMOVED***,

    'Program:exit': function onExit() ***REMOVED***
      // Report multiple `export` declarations (ES2015 modules)
      if (nodes.modules.size > 1) ***REMOVED***
        nodes.modules.forEach(node => ***REMOVED***
      ...
      ***REMOVED***
      ...
      if (nodes.commonjs.size > 1) ***REMOVED***
        nodes.commonjs.forEach(node => ***REMOVED***
          context.report(***REMOVED***
            node,
            message: errors[node.type]
          ***REMOVED***);
