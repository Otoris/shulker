...
function _toConsumableArray(arr) ***REMOVED*** if (Array.isArray(arr)) ***REMOVED*** for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) arr2[i] = arr[i]; return arr2; ***REMOVED*** else ***REMOVED*** return Array.from(arr); ***REMOVED*** ***REMOVED*** /**
...
try ***REMOVED***
  ...
  listFilesToProcess = function (src) ***REMOVED***
    var e = new FileEnumerator();
    return Array.from(e.iterateFiles(src), (_ref) => ***REMOVED***
...
const isNodeModule = path => ***REMOVED***
 ...
 */
const prepareImportsAndExports = (srcFiles, context) => ***REMOVED***
  const exportAll = new Map();
  srcFiles.forEach(file => ***REMOVED***
    const exports = new Map();
    const imports = new Map();
    const currentExports = _ExportMap2.default.get(file, context);
    if (currentExports) ***REMOVED***
      ...
      dependencies.forEach(value => ***REMOVED***
        currentExportAll.add(value().path);
      ***REMOVED***);
      exportAll.set(file, currentExportAll);

      reexports.forEach((value, key) => ***REMOVED***
        if (key === DEFAULT) ***REMOVED***
          exports.set(IMPORT_DEFAULT_SPECIFIER, ***REMOVED*** whereUsed: new Set() ***REMOVED***);
        ***REMOVED*** else ***REMOVED***
          exports.set(key, ***REMOVED*** whereUsed: new Set() ***REMOVED***);
        ***REMOVED***
        ...
        ***REMOVED***
        ...
        let currentValue;
        if (value.local === DEFAULT) ***REMOVED***
          currentValue = IMPORT_DEFAULT_SPECIFIER;
        ***REMOVED*** else ***REMOVED***
          currentValue = value.local;
        ***REMOVED***
        if (typeof localImport !== 'undefined') ***REMOVED***
      ...
      ***REMOVED***);
      ...
      localImportList.forEach((value, key) => ***REMOVED***
        if (isNodeModule(key)) ***REMOVED***
          return;
        ***REMOVED***
      ...
      ***REMOVED***);
      ...
      if (ignoredFiles.has(file)) ***REMOVED***
        return;
      ***REMOVED***
      namespace.forEach((value, key) => ***REMOVED***
        if (key === DEFAULT) ***REMOVED***
          exports.set(IMPORT_DEFAULT_SPECIFIER, ***REMOVED*** whereUsed: new Set() ***REMOVED***);
        ***REMOVED*** else ***REMOVED***
          exports.set(key, ***REMOVED*** whereUsed: new Set() ***REMOVED***);
      ...
      ***REMOVED***);
    ***REMOVED***
    exports.set(EXPORT_ALL_DECLARATION, ***REMOVED*** whereUsed: new Set() ***REMOVED***);
    exports.set(IMPORT_NAMESPACE_SPECIFIER, ***REMOVED*** whereUsed: new Set() ***REMOVED***);
    exportList.set(file, exports);
  ***REMOVED***);
  exportAll.forEach((value, key) => ***REMOVED***
    value.forEach(val => ***REMOVED***
 ...
 */
const determineUsage = () => ***REMOVED***
  importList.forEach((listValue, listKey) => ***REMOVED***
    listValue.forEach((value, key) => ***REMOVED***
      const exports = exportList.get(key);
      if (typeof exports !== 'undefined') ***REMOVED***
        value.forEach(currentImport => ***REMOVED***
          let specifier;
          if (currentImport === IMPORT_NAMESPACE_SPECIFIER) ***REMOVED***
            specifier = IMPORT_NAMESPACE_SPECIFIER;
          ***REMOVED*** else if (currentImport === IMPORT_DEFAULT_SPECIFIER) ***REMOVED***
            specifier = IMPORT_DEFAULT_SPECIFIER;
          ***REMOVED*** else ***REMOVED***
            specifier = currentImport;
          ***REMOVED***
          if (typeof specifier !== 'undefined') ***REMOVED***
            const exportStatement = exports.get(specifier);
            if (typeof exportStatement !== 'undefined') ***REMOVED***
              const whereUsed = exportStatement.whereUsed;

              whereUsed.add(listKey);
              exports.set(specifier, ***REMOVED*** whereUsed ***REMOVED***);
            ***REMOVED***
          ***REMOVED***
        ***REMOVED***);
      ***REMOVED***
 ...
 */
const doPreparation = (src, ignoreExports, context) => ***REMOVED***
...
const newNamespaceImportExists = specifiers => specifiers.some((_ref5) => ***REMOVED***
  let type = _ref5.type;
  return type === IMPORT_NAMESPACE_SPECIFIER;
***REMOVED***);

const newDefaultImportExists = specifiers => specifiers.some((_ref6) => ***REMOVED***
  let type = _ref6.type;
  return type === IMPORT_DEFAULT_SPECIFIER;
***REMOVED***);

const fileIsInPkg = file => ***REMOVED***
  var _readPkgUp$sync = _readPkgUp2.default.sync(***REMOVED*** cwd: file, normalize: false ***REMOVED***);
  ...
  const checkPkgFieldString = pkgField => ***REMOVED***
    if ((0, _path.join)(basePath, pkgField) === file) ***REMOVED***
      return true;
    ***REMOVED***
  ***REMOVED***;

  const checkPkgFieldObject = pkgField => ***REMOVED***
    const pkgFieldFiles = (0, _object2.default)(pkgField).map(value => (0, _path.join)(basePath, value));
    if ((0, _arrayIncludes2.default)(pkgFieldFiles, file)) ***REMOVED***
      return true;
    ***REMOVED***
  ***REMOVED***;

  const checkPkgField = pkgField => ***REMOVED***
    if (typeof pkgField === 'string') ***REMOVED***
      return checkPkgFieldString(pkgField);
    ***REMOVED***

    if (typeof pkgField === 'object') ***REMOVED***
      return checkPkgFieldObject(pkgField);
    ***REMOVED***
  ***REMOVED***;

  if (pkg.private === true) ***REMOVED***
    return false;
  ***REMOVED***

  if (pkg.bin) ***REMOVED***
    if (checkPkgField(pkg.bin)) ***REMOVED***
      return true;
    ***REMOVED***
  ***REMOVED***

  if (pkg.browser) ***REMOVED***
    if (checkPkgField(pkg.browser)) ***REMOVED***
      return true;
    ***REMOVED***
  ***REMOVED***

  if (pkg.main) ***REMOVED***
    if (checkPkgFieldString(pkg.main)) ***REMOVED***
      return true;
    ***REMOVED***
  ***REMOVED***
...
module.exports = ***REMOVED***
  meta: ***REMOVED***
    docs: ***REMOVED*** url: (0, _docsUrl2.default)('no-unused-modules') ***REMOVED***,
    schema: [***REMOVED***
      properties: ***REMOVED***
        src: ***REMOVED***
      ...
      ***REMOVED***,
      not: ***REMOVED***
        properties: ***REMOVED***
          unusedExports: ***REMOVED*** enum: [false] ***REMOVED***,
          missingExports: ***REMOVED*** enum: [false] ***REMOVED***
        ***REMOVED***
      ***REMOVED***,
      anyOf: [***REMOVED***
        not: ***REMOVED***
          properties: ***REMOVED***
            unusedExports: ***REMOVED*** enum: [true] ***REMOVED***
          ***REMOVED***
        ***REMOVED***,
      ...
      ***REMOVED***, ***REMOVED***
        not: ***REMOVED***
          properties: ***REMOVED***
            missingExports: ***REMOVED*** enum: [true] ***REMOVED***
          ***REMOVED***
        ***REMOVED***,
  ...
  ***REMOVED***,
  ...
  create: context => ***REMOVED***
    var _ref7 = context.options[0] || ***REMOVED******REMOVED***;
    ...
    if (unusedExports && !preparationDone) ***REMOVED***
      doPreparation(src, ignoreExports, context);
    ***REMOVED***

    const file = context.getFilename();

    const checkExportPresence = node => ***REMOVED***
      if (!missingExports) ***REMOVED***
        return;
      ***REMOVED***
      ...
      ***REMOVED***
      ...
      if (missingExports && exportCount.size < 1) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    const checkUsage = (node, exportedValue) => ***REMOVED***
      if (!unusedExports) ***REMOVED***
        return;
      ***REMOVED***
      ...
      ***REMOVED***
      ...
      if (typeof exportAll !== 'undefined' && exportedValue !== IMPORT_DEFAULT_SPECIFIER) ***REMOVED***
        if (exportAll.whereUsed.size > 0) ***REMOVED***
          return;
        ***REMOVED***
      ***REMOVED***
      ...
      if (typeof namespaceImports !== 'undefined') ***REMOVED***
        if (namespaceImports.whereUsed.size > 0) ***REMOVED***
          return;
        ***REMOVED***
      ***REMOVED***
      ...
      if (typeof exportStatement !== 'undefined') ***REMOVED***
        if (exportStatement.whereUsed.size < 1) ***REMOVED***
          context.report(node, `exported declaration '$***REMOVED***value***REMOVED***' not used within other modules`);
        ***REMOVED***
      ***REMOVED*** else ***REMOVED***
        context.report(node, `exported declaration '$***REMOVED***value***REMOVED***' not used within other modules`);
      ***REMOVED***
    ***REMOVED***;
     ...
     */
    const updateExportUsage = node => ***REMOVED***
      if (ignoredFiles.has(file)) ***REMOVED***
        return;
      ***REMOVED***
      ...
      ***REMOVED***
      ...
      node.body.forEach((_ref8) => ***REMOVED***
        let type = _ref8.type,
            declaration = _ref8.declaration,
            specifiers = _ref8.specifiers;

        if (type === EXPORT_DEFAULT_DECLARATION) ***REMOVED***
          newExportIdentifiers.add(IMPORT_DEFAULT_SPECIFIER);
        ***REMOVED***
        if (type === EXPORT_NAMED_DECLARATION) ***REMOVED***
          if (specifiers.length > 0) ***REMOVED***
            specifiers.forEach(specifier => ***REMOVED***
              if (specifier.exported) ***REMOVED***
                newExportIdentifiers.add(specifier.exported.name);
              ***REMOVED***
            ***REMOVED***);
          ***REMOVED***
          if (declaration) ***REMOVED***
            if (declaration.type === FUNCTION_DECLARATION || declaration.type === CLASS_DECLARATION) ***REMOVED***
              newExportIdentifiers.add(declaration.id.name);
            ***REMOVED***
            if (declaration.type === VARIABLE_DECLARATION) ***REMOVED***
              declaration.declarations.forEach((_ref9) => ***REMOVED***
                let id = _ref9.id;
      ...
      ***REMOVED***);
      ...
      exports.forEach((value, key) => ***REMOVED***
        if (newExportIdentifiers.has(key)) ***REMOVED***
          newExports.set(key, value);
        ***REMOVED***
      ***REMOVED***);

      // new export identifiers added: add to map of new exports
      newExportIdentifiers.forEach(key => ***REMOVED***
        if (!exports.has(key)) ***REMOVED***
          newExports.set(key, ***REMOVED*** whereUsed: new Set() ***REMOVED***);
        ***REMOVED***
      ***REMOVED***);
      ...
      if (typeof namespaceImports === 'undefined') ***REMOVED***
        namespaceImports = ***REMOVED*** whereUsed: new Set() ***REMOVED***;
      ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    const updateImportUsage = node => ***REMOVED***
      if (!unusedExports) ***REMOVED***
        return;
      ***REMOVED***

      let oldImportPaths = importList.get(file);
      if (typeof oldImportPaths === 'undefined') ***REMOVED***
      ...
      ***REMOVED***
      ...
      oldImportPaths.forEach((value, key) => ***REMOVED***
        if (value.has(EXPORT_ALL_DECLARATION)) ***REMOVED***
          oldExportAll.add(key);
        ***REMOVED***
        if (value.has(IMPORT_NAMESPACE_SPECIFIER)) ***REMOVED***
          oldNamespaceImports.add(key);
        ***REMOVED***
        if (value.has(IMPORT_DEFAULT_SPECIFIER)) ***REMOVED***
          oldDefaultImports.add(key);
        ***REMOVED***
        value.forEach(val => ***REMOVED***
          if (val !== IMPORT_NAMESPACE_SPECIFIER && val !== IMPORT_DEFAULT_SPECIFIER) ***REMOVED***
            oldImports.set(val, key);
          ***REMOVED***
        ***REMOVED***);
      ***REMOVED***);

      node.body.forEach(astNode => ***REMOVED***
        let resolvedPath;

        // support for export ***REMOVED*** value ***REMOVED*** from 'module'
        if (astNode.type === EXPORT_NAMED_DECLARATION) ***REMOVED***
          if (astNode.source) ***REMOVED***
            resolvedPath = (0, _resolve2.default)(astNode.source.raw.replace(/('|")/g, ''), context);
            astNode.specifiers.forEach(specifier => ***REMOVED***
              let name;
              if (specifier.exported.name === DEFAULT) ***REMOVED***
        ...
        ***REMOVED***
        ...
        if (astNode.type === EXPORT_ALL_DECLARATION) ***REMOVED***
          resolvedPath = (0, _resolve2.default)(astNode.source.raw.replace(/('|")/g, ''), context);
          newExportAll.add(resolvedPath);
        ***REMOVED***

        if (astNode.type === IMPORT_DECLARATION) ***REMOVED***
          resolvedPath = (0, _resolve2.default)(astNode.source.raw.replace(/('|")/g, ''), context);
          if (!resolvedPath) ***REMOVED***
            return;
          ***REMOVED***

          if (isNodeModule(resolvedPath)) ***REMOVED***
            return;
          ***REMOVED***

          if (newNamespaceImportExists(astNode.specifiers)) ***REMOVED***
            newNamespaceImports.add(resolvedPath);
          ***REMOVED***

          if (newDefaultImportExists(astNode.specifiers)) ***REMOVED***
            newDefaultImports.add(resolvedPath);
          ***REMOVED***

          astNode.specifiers.forEach(specifier => ***REMOVED***
            if (specifier.type === IMPORT_DEFAULT_SPECIFIER || specifier.type === IMPORT_NAMESPACE_SPECIFIER) ***REMOVED***
              return;
            ***REMOVED***
      ...
      ***REMOVED***);
      ...
      newExportAll.forEach(value => ***REMOVED***
        if (!oldExportAll.has(value)) ***REMOVED***
          let imports = oldImportPaths.get(value);
          if (typeof imports === 'undefined') ***REMOVED***
            imports = new Set();
          ***REMOVED***
          ...
          ***REMOVED***
          ...
          if (typeof currentExport !== 'undefined') ***REMOVED***
            currentExport.whereUsed.add(file);
          ***REMOVED*** else ***REMOVED***
            const whereUsed = new Set();
            whereUsed.add(file);
            exports.set(EXPORT_ALL_DECLARATION, ***REMOVED*** whereUsed ***REMOVED***);
          ***REMOVED***
        ***REMOVED***
      ***REMOVED***);

      oldExportAll.forEach(value => ***REMOVED***
        if (!newExportAll.has(value)) ***REMOVED***
      ...
      ***REMOVED***);
      ...
      newDefaultImports.forEach(value => ***REMOVED***
        if (!oldDefaultImports.has(value)) ***REMOVED***
          let imports = oldImportPaths.get(value);
          if (typeof imports === 'undefined') ***REMOVED***
            imports = new Set();
          ***REMOVED***
          ...
          ***REMOVED*** else ***REMOVED***
            const whereUsed = new Set();
            whereUsed.add(file);
            exports.set(IMPORT_DEFAULT_SPECIFIER, ***REMOVED*** whereUsed ***REMOVED***);
          ***REMOVED***
        ***REMOVED***
      ***REMOVED***);

      oldDefaultImports.forEach(value => ***REMOVED***
        if (!newDefaultImports.has(value)) ***REMOVED***
          const imports = oldImportPaths.get(value);
      ...
      ***REMOVED***);
      ...
      newNamespaceImports.forEach(value => ***REMOVED***
        if (!oldNamespaceImports.has(value)) ***REMOVED***
          let imports = oldImportPaths.get(value);
          if (typeof imports === 'undefined') ***REMOVED***
            imports = new Set();
          ***REMOVED***
          ...
          ***REMOVED*** else ***REMOVED***
            const whereUsed = new Set();
            whereUsed.add(file);
            exports.set(IMPORT_NAMESPACE_SPECIFIER, ***REMOVED*** whereUsed ***REMOVED***);
          ***REMOVED***
        ***REMOVED***
      ***REMOVED***);

      oldNamespaceImports.forEach(value => ***REMOVED***
        if (!newNamespaceImports.has(value)) ***REMOVED***
          const imports = oldImportPaths.get(value);
      ...
      ***REMOVED***);
      ...
      newImports.forEach((value, key) => ***REMOVED***
        if (!oldImports.has(key)) ***REMOVED***
          let imports = oldImportPaths.get(value);
          if (typeof imports === 'undefined') ***REMOVED***
            imports = new Set();
          ***REMOVED***
          ...
          ***REMOVED*** else ***REMOVED***
            const whereUsed = new Set();
            whereUsed.add(file);
            exports.set(key, ***REMOVED*** whereUsed ***REMOVED***);
          ***REMOVED***
        ***REMOVED***
      ***REMOVED***);

      oldImports.forEach((value, key) => ***REMOVED***
        if (!newImports.has(key)) ***REMOVED***
          const imports = oldImportPaths.get(value);
          imports.delete(key);
      ...
      'ExportNamedDeclaration': node => ***REMOVED***
        ...
        ***REMOVED***);
        if (node.declaration) ***REMOVED***
          if (node.declaration.type === FUNCTION_DECLARATION || node.declaration.type === CLASS_DECLARATION) ***REMOVED***
            checkUsage(node, node.declaration.id.name);
          ***REMOVED***
          if (node.declaration.type === VARIABLE_DECLARATION) ***REMOVED***
            node.declaration.declarations.forEach(declaration => ***REMOVED***
