...
const enumValues = ***REMOVED*** enum: ['always', 'ignorePackages', 'never'] ***REMOVED***;
const patternProperties = ***REMOVED***
  type: 'object',
  patternProperties: ***REMOVED*** '.*': enumValues ***REMOVED***
***REMOVED***;
const properties = ***REMOVED***
  type: 'object',
  properties: ***REMOVED***
    'pattern': patternProperties,
    'ignorePackages': ***REMOVED*** type: 'boolean' ***REMOVED***
  ***REMOVED***
***REMOVED***;

function buildProperties(context) ***REMOVED***
  ...
  ***REMOVED***;
  ...
  context.options.forEach(obj => ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (obj.pattern === undefined && obj.ignorePackages === undefined) ***REMOVED***
      Object.assign(result.pattern, obj);
      return;
    ***REMOVED***

    // If pattern is provided, transfer all props
    if (obj.pattern !== undefined) ***REMOVED***
      Object.assign(result.pattern, obj.pattern);
    ***REMOVED***

    // If ignorePackages is provided, transfer it to result
    if (obj.ignorePackages !== undefined) ***REMOVED***
...
module.exports = ***REMOVED***
  ...
  ***REMOVED***,
  ...
  create: function (context) ***REMOVED***
    ...
    function getModifier(extension) ***REMOVED***
      return props.pattern[extension] || props.defaultConfig;
    ***REMOVED***

    function isUseOfExtensionRequired(extension, isPackageMain) ***REMOVED***
      return getModifier(extension) === 'always' && (!props.ignorePackages || !isPackageMain);
    ***REMOVED***

    function isUseOfExtensionForbidden(extension) ***REMOVED***
      return getModifier(extension) === 'never';
    ***REMOVED***

    function isResolvableWithoutExtension(file) ***REMOVED***
    ...
    ***REMOVED***
    ...
    function checkFileExtension(node) ***REMOVED***
      const source = node.source;

      // bail if the declaration doesn't have a source, e.g. "export ***REMOVED*** foo ***REMOVED***;"
      ...
      if (!extension || !importPath.endsWith(`.$***REMOVED***extension***REMOVED***`)) ***REMOVED***
        const extensionRequired = isUseOfExtensionRequired(extension, isPackageMain);
        const extensionForbidden = isUseOfExtensionForbidden(extension);
        if (extensionRequired && !extensionForbidden) ***REMOVED***
          context.report(***REMOVED***
            node: source,
            message: `Missing file extension $***REMOVED***extension ? `"$***REMOVED***extension***REMOVED***" ` : ''***REMOVED***for "$***REMOVED***importPath***REMOVED***"`
          ***REMOVED***);
        ***REMOVED***
      ***REMOVED*** else if (extension) ***REMOVED***
        if (isUseOfExtensionForbidden(extension) && isResolvableWithoutExtension(importPath)) ***REMOVED***
          context.report(***REMOVED***
            node: source,
            message: `Unexpected use of file extension "$***REMOVED***extension***REMOVED***" for "$***REMOVED***importPath***REMOVED***"`
          ***REMOVED***);
        ***REMOVED***
      ***REMOVED***
    ***REMOVED***
