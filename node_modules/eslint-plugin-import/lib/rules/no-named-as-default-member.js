...
module.exports = ***REMOVED***
  ...
  ***REMOVED***,
  ...
  create: function (context) ***REMOVED***
    ...
    function handleImportDefault(node) ***REMOVED***
      ...
      if (exportMap.errors.length) ***REMOVED***
        exportMap.reportErrors(context, declaration);
        return;
      ***REMOVED***

      fileImports.set(node.local.name, ***REMOVED***
        exportMap,
        sourcePath: declaration.source.value
      ***REMOVED***);
    ***REMOVED***

    function storePropertyLookup(objectName, propName, node) ***REMOVED***
      const lookups = allPropertyLookups.get(objectName) || [];
      lookups.push(***REMOVED*** node, propName ***REMOVED***);
      allPropertyLookups.set(objectName, lookups);
    ***REMOVED***

    function handlePropLookup(node) ***REMOVED***
      const objectName = node.object.name;
      const propName = node.property.name;
      storePropertyLookup(objectName, propName, node);
    ***REMOVED***

    function handleDestructuringAssignment(node) ***REMOVED***
      const isDestructure = node.id.type === 'ObjectPattern' && node.init != null && node.init.type === 'Identifier';
      if (!isDestructure) return;

      const objectName = node.init.name;
      for (const _ref of node.id.properties) ***REMOVED***
        const key = _ref.key;
    ...
    ***REMOVED***
    ...
    function handleProgramExit() ***REMOVED***
      allPropertyLookups.forEach((lookups, objectName) => ***REMOVED***
        const fileImport = fileImports.get(objectName);
        if (fileImport == null) return;

        for (const _ref2 of lookups) ***REMOVED***
          ...
          context.report(***REMOVED***
            node,
            message: `Caution: \`$***REMOVED***objectName***REMOVED***\` also has a named export ` + `\`$***REMOVED***propName***REMOVED***\`. Check if you meant to write ` + `\`import ***REMOVED***$***REMOVED***propName***REMOVED******REMOVED*** from '$***REMOVED***fileImport.sourcePath***REMOVED***'\` ` + 'instead.'
          ***REMOVED***);
        ***REMOVED***
      ***REMOVED***);
    ***REMOVED***
