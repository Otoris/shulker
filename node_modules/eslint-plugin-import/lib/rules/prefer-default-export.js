...
module.exports = ***REMOVED***
  ...
  ***REMOVED***,
  ...
  create: function (context) ***REMOVED***
    ...
    function captureDeclaration(identifierOrPattern) ***REMOVED***
      if (identifierOrPattern.type === 'ObjectPattern') ***REMOVED***
        // recursively capture
        identifierOrPattern.properties.forEach(function (property) ***REMOVED***
    ...
    ***REMOVED***
    ...
    return ***REMOVED***
      'ExportDefaultSpecifier': function () ***REMOVED***
        hasDefaultExport = true;
      ***REMOVED***,

      'ExportSpecifier': function (node) ***REMOVED***
        if (node.exported.name === 'default') ***REMOVED***
          hasDefaultExport = true;
        ***REMOVED*** else ***REMOVED***
          specifierExportCount++;
      ...
      ***REMOVED***,
      ...
      'ExportNamedDeclaration': function (node) ***REMOVED***
        ...
        if (type === 'TSTypeAliasDeclaration' || type === 'TypeAlias' || type === 'TSInterfaceDeclaration' || type === 'InterfaceDeclaration') ***REMOVED***
          return;
        ***REMOVED***

        if (node.declaration.declarations) ***REMOVED***
          node.declaration.declarations.forEach(function (declaration) ***REMOVED***
            captureDeclaration(declaration.id);
          ***REMOVED***);
        ***REMOVED*** else ***REMOVED***
          // captures 'export function foo() ***REMOVED******REMOVED***' syntax
          specifierExportCount++;
        ***REMOVED***
      ...
      ***REMOVED***,
      ...
      'ExportDefaultDeclaration': function () ***REMOVED***
        hasDefaultExport = true;
      ***REMOVED***,

      'ExportAllDeclaration': function () ***REMOVED***
        hasStarExport = true;
      ***REMOVED***,

      'Program:exit': function () ***REMOVED***
        if (specifierExportCount === 1 && !hasDefaultExport && !hasStarExport) ***REMOVED***
