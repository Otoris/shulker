 ...
 * foo/bar -> ./foo/bar
 *
 * @param relativePath ***REMOVED***string***REMOVED*** relative posix path potentially missing leading './'
 * @returns ***REMOVED***string***REMOVED*** relative posix path that always starts with a ./
 **/
function toRelativePath(relativePath) ***REMOVED***
  const stripped = relativePath.replace(/\/$/g, ''); // Remove trailing /

  return (/^((\.\.)|(\.))($|\/)/.test(stripped) ? stripped : `./$***REMOVED***stripped***REMOVED***`
  );
***REMOVED*** /**
...
function normalize(fn) ***REMOVED***
  return toRelativePath(_path2.default.posix.normalize(fn));
***REMOVED***

function countRelativeParents(pathSegments) ***REMOVED***
...
module.exports = ***REMOVED***
    ...
    ***REMOVED***,
    ...
    schema: [***REMOVED***
      ...
      properties: ***REMOVED***
        ...
        noUselessIndex: ***REMOVED*** type: 'boolean' ***REMOVED***
      ***REMOVED***,
  ...
  ***REMOVED***,
  ...
  create(context) ***REMOVED***
    ...
    function checkSourceValue(source) ***REMOVED***
      const importPath = source.value;


      function reportWithProposedPath(proposedPath) ***REMOVED***
        context.report(***REMOVED***
          node: source,
          // Note: Using messageIds is not possible due to the support for ESLint 2 and 3
          message: `Useless path segments for "$***REMOVED***importPath***REMOVED***", should be "$***REMOVED***proposedPath***REMOVED***"`,
      ...
      ***REMOVED***
      ...
      if (!importPath.startsWith('.')) ***REMOVED***
        return;
      ***REMOVED***
      ...
      if (normedPath !== importPath && resolvedPath === resolvedNormedPath) ***REMOVED***
        return reportWithProposedPath(normedPath);
      ***REMOVED***

      const fileExtensions = (0, _ignore.getFileExtensions)(context.settings);
      const regexUnnecessaryIndex = new RegExp(`.*\\/index(\\$***REMOVED***Array.from(fileExtensions).join('|\\')***REMOVED***)?$`);

      // Check if path contains unnecessary index (including a configured extension)
      if (options && options.noUselessIndex && regexUnnecessaryIndex.test(importPath)) ***REMOVED***
        const parentDirectory = _path2.default.dirname(importPath);

        // Try to find ambiguous imports
        if (parentDirectory !== '.' && parentDirectory !== '..') ***REMOVED***
          for (let fileExtension of fileExtensions) ***REMOVED***
            if ((0, _resolve2.default)(`$***REMOVED***parentDirectory***REMOVED***$***REMOVED***fileExtension***REMOVED***`, context)) ***REMOVED***
              return reportWithProposedPath(`$***REMOVED***parentDirectory***REMOVED***/`);
            ***REMOVED***
          ***REMOVED***
        ***REMOVED***
      ...
      ***REMOVED***
      ...
      if (resolvedPath === undefined) ***REMOVED***
        return;
      ***REMOVED***
