...
function message(deprecation) ***REMOVED***
  return 'Deprecated' + (deprecation.description ? ': ' + deprecation.description : '.');
***REMOVED***

function getDeprecation(metadata) ***REMOVED***
  if (!metadata || !metadata.doc) return;

  let deprecation;
  if (metadata.doc.tags.some(t => t.title === 'deprecated' && (deprecation = t))) ***REMOVED***
    return deprecation;
  ***REMOVED***
***REMOVED***
...
module.exports = ***REMOVED***
  ...
  ***REMOVED***,
  ...
  create: function (context) ***REMOVED***
    ...
    function checkSpecifiers(node) ***REMOVED***
      ...
      if (imports.doc && imports.doc.tags.some(t => t.title === 'deprecated' && (moduleDeprecation = t))) ***REMOVED***
        context.report(***REMOVED*** node, message: message(moduleDeprecation) ***REMOVED***);
      ***REMOVED***
      ...
      ***REMOVED***
      ...
      node.specifiers.forEach(function (im) ***REMOVED***
        let imported, local;
        switch (im.type) ***REMOVED***
        ...
        ***REMOVED***
        ...
        context.report(***REMOVED*** node: im, message: message(deprecation) ***REMOVED***);
    ...
    ***REMOVED***
    ...
    return ***REMOVED***
      'Program': (_ref) => ***REMOVED***
        let body = _ref.body;
        return body.forEach(checkSpecifiers);
      ***REMOVED***,

      'Identifier': function (node) ***REMOVED***
        if (node.parent.type === 'MemberExpression' && node.parent.property === node) ***REMOVED***
      ...
      'MemberExpression': function (dereference) ***REMOVED***
        ...
        while (namespace instanceof _ExportMap2.default && dereference.type === 'MemberExpression') ***REMOVED***
          ...
          if (deprecation) ***REMOVED***
            context.report(***REMOVED*** node: dereference.property, message: message(deprecation) ***REMOVED***);
          ***REMOVED***
