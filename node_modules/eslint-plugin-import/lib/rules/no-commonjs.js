...
function normalizeLegacyOptions(options) ***REMOVED***
  if (options.indexOf('allow-primitive-modules') >= 0) ***REMOVED***
    return ***REMOVED*** allowPrimitiveModules: true ***REMOVED***;
  ***REMOVED***
  return options[0] || ***REMOVED******REMOVED***;
***REMOVED***

function allowPrimitive(node, options) ***REMOVED***
  if (!options.allowPrimitiveModules) return false;
  if (node.parent.type !== 'AssignmentExpression') return false;
  return node.parent.right.type !== 'ObjectExpression';
***REMOVED***

function allowRequire(node, options) ***REMOVED***
...
const schemaString = ***REMOVED*** enum: ['allow-primitive-modules'] ***REMOVED***;
const schemaObject = ***REMOVED***
  type: 'object',
  properties: ***REMOVED***
    allowPrimitiveModules: ***REMOVED*** 'type': 'boolean' ***REMOVED***,
    allowRequire: ***REMOVED*** 'type': 'boolean' ***REMOVED***
  ***REMOVED***,
  ...
  ***REMOVED***,
  ...
  create: function (context) ***REMOVED***
    ...
    return ***REMOVED***
      ...
      'MemberExpression': function (node) ***REMOVED***

        // module.exports
        if (node.object.name === 'module' && node.property.name === 'exports') ***REMOVED***
          if (allowPrimitive(node, options)) return;
          context.report(***REMOVED*** node, message: EXPORT_MESSAGE ***REMOVED***);
        ***REMOVED***

        // exports.
        if (node.object.name === 'exports') ***REMOVED***
          const isInScope = context.getScope().variables.some(variable => variable.name === 'exports');
          if (!isInScope) ***REMOVED***
            context.report(***REMOVED*** node, message: EXPORT_MESSAGE ***REMOVED***);
          ***REMOVED***
        ***REMOVED***
      ***REMOVED***,
      'CallExpression': function (call) ***REMOVED***
