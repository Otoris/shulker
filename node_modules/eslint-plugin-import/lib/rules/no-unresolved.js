  ...
  meta: ***REMOVED***
    ...
    ***REMOVED***,
    ...
    schema: [(0, _moduleVisitor.makeOptionsSchema)(***REMOVED***
      caseSensitive: ***REMOVED*** type: 'boolean', default: true ***REMOVED***
    ***REMOVED***)]
  ***REMOVED***,
  ...
  create: function (context) ***REMOVED***
    ...
    function checkSourceValue(source) ***REMOVED***
      ...
      if (resolvedPath === undefined) ***REMOVED***
        context.report(source, `Unable to resolve path to module '$***REMOVED***source.value***REMOVED***'.`);
      ***REMOVED*** else if (shouldCheckCase) ***REMOVED***
        const cacheSettings = _ModuleCache2.default.getSettings(context.settings);
        if (!(0, _resolve.fileExistsWithCaseSync)(resolvedPath, cacheSettings)) ***REMOVED***
          context.report(source, `Casing of $***REMOVED***source.value***REMOVED*** does not match the underlying filesystem.`);
        ***REMOVED***
      ***REMOVED***
    ***REMOVED***
