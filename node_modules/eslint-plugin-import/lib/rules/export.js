...
There are two forms:
- active namespaces: namespace Foo ***REMOVED******REMOVED*** / module Foo ***REMOVED******REMOVED***
- ambient modules; declare module "eslint-plugin-import" ***REMOVED******REMOVED***

active namespaces:
- cannot contain a default export
- cannot contain an export all
- cannot contain a multi name export (export ***REMOVED*** a, b ***REMOVED***)
 ...
 * export function foo(a: number|string) ***REMOVED*** return a; ***REMOVED***
 * ```
 * @param ***REMOVED***Set<Object>***REMOVED*** nodes
 * @returns ***REMOVED***boolean***REMOVED***
 */
function isTypescriptFunctionOverloads(nodes) ***REMOVED***
...
module.exports = ***REMOVED***
  ...
  ***REMOVED***,
  ...
  create: function (context) ***REMOVED***
    ...
    function addNamed(name, node, parent, isType) ***REMOVED***
      if (!namespace.has(parent)) ***REMOVED***
        namespace.set(parent, new Map());
      ***REMOVED***
      const named = namespace.get(parent);

      const key = isType ? `$***REMOVED***tsTypePrefix***REMOVED***$***REMOVED***name***REMOVED***` : name;
      let nodes = named.get(key);

      if (nodes == null) ***REMOVED***
        nodes = new Set();
        named.set(key, nodes);
      ***REMOVED***
    ...
    ***REMOVED***
    ...
    function getParent(node) ***REMOVED***
      if (node.parent && node.parent.type === 'TSModuleBlock') ***REMOVED***
    ...
    ***REMOVED***
    ...
    return ***REMOVED***
      ...
      'ExportNamedDeclaration': function (node) ***REMOVED***
        ...
        if (node.declaration.id != null) ***REMOVED***
          if ((0, _arrayIncludes2.default)(['TSTypeAliasDeclaration', 'TSInterfaceDeclaration'], node.declaration.type)) ***REMOVED***
        ...
        ***REMOVED***
        ...
        if (node.declaration.declarations != null) ***REMOVED***
          for (let declaration of node.declaration.declarations) ***REMOVED***
            (0, _ExportMap.recursivePatternCapture)(declaration.id, v => addNamed(v.name, v, parent, isTypeVariableDecl));
          ***REMOVED***
        ***REMOVED***
      ***REMOVED***,

      'ExportAllDeclaration': function (node) ***REMOVED***
        if (node.source == null) return; // not sure if this is ever true

        const remoteExports = _ExportMap2.default.get(node.source.value, context);
        if (remoteExports == null) return;

        if (remoteExports.errors.length) ***REMOVED***
        ...
        ***REMOVED***
        ...
        if (!any) ***REMOVED***
          context.report(node.source, `No named exports found in module '$***REMOVED***node.source.value***REMOVED***'.`);
        ***REMOVED***
      ***REMOVED***,

      'Program:exit': function () ***REMOVED***
        for (let _ref of namespace) ***REMOVED***
          var _ref2 = _slicedToArray(_ref, 2);

          let named = _ref2[1];

          for (let _ref3 of named) ***REMOVED***
            ...
            for (let node of nodes) ***REMOVED***
              ...
              ***REMOVED*** else ***REMOVED***
                context.report(node, `Multiple exports of name '$***REMOVED***name.replace(tsTypePrefix, '')***REMOVED***'.`);
              ***REMOVED***
            ***REMOVED***
          ***REMOVED***
        ***REMOVED***
