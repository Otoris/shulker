...
module.exports = ***REMOVED***
  ...
  ***REMOVED***,
  ...
  create: function (context) ***REMOVED***
    function isPossibleDirective(node) ***REMOVED***
      return node.type === 'ExpressionStatement' && node.expression.type === 'Literal' && typeof node.expression.value === 'string';
    ***REMOVED***

    return ***REMOVED***
      'Program': function (n) ***REMOVED***
        const body = n.body,
        ...
        body.forEach(function (node, index) ***REMOVED***
          if (!anyExpressions && isPossibleDirective(node)) ***REMOVED***
            return;
          ***REMOVED***

          anyExpressions = true;

          if (node.type === 'ImportDeclaration') ***REMOVED***
            if (absoluteFirst) ***REMOVED***
              if (/^\./.test(node.source.value)) ***REMOVED***
                anyRelative = true;
              ***REMOVED*** else if (anyRelative) ***REMOVED***
              ...
              ***REMOVED***
            ***REMOVED***
            if (nonImportCount > 0) ***REMOVED***
              for (let variable of context.getDeclaredVariables(node)) ***REMOVED***
                if (!shouldSort) break;
                const references = variable.references;
                if (references.length) ***REMOVED***
                  for (let reference of references) ***REMOVED***
                    if (reference.identifier.range[0] < node.range[1]) ***REMOVED***
                      shouldSort = false;
                      break;
                    ***REMOVED***
                  ***REMOVED***
        ...
        ***REMOVED***);
        ...
        errorInfos.forEach(function (errorInfo, index) ***REMOVED***
          const node = errorInfo.node,
                infos = ***REMOVED***
            node,
            message
          ***REMOVED***;
          if (index < lastSortNodesIndex) ***REMOVED***
            infos.fix = function (fixer) ***REMOVED***
              return fixer.insertTextAfter(node, '');
            ***REMOVED***;
          ***REMOVED*** else if (index === lastSortNodesIndex) ***REMOVED***
            const sortNodes = errorInfos.slice(0, lastSortNodesIndex + 1);
            infos.fix = function (fixer) ***REMOVED***
              const removeFixers = sortNodes.map(function (_errorInfo) ***REMOVED***
                return fixer.removeRange(_errorInfo.range);
              ***REMOVED***),
                    range = [0, removeFixers[removeFixers.length - 1].range[1]];
              let insertSourceCode = sortNodes.map(function (_errorInfo) ***REMOVED***
                const nodeSourceCode = String.prototype.slice.apply(originSourceCode, _errorInfo.range);
                if (/\S/.test(nodeSourceCode[0])) ***REMOVED***
                  return '\n' + nodeSourceCode;
                ***REMOVED***
              ...
              ***REMOVED***
              ...
              fixers.forEach(function (computedFixer, i) ***REMOVED***
