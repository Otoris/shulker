      ...
      properties: ***REMOVED***
        zones: ***REMOVED***
          ...
          items: ***REMOVED***
            type: 'object',
            properties: ***REMOVED***
              target: ***REMOVED*** type: 'string' ***REMOVED***,
              from: ***REMOVED*** type: 'string' ***REMOVED***
            ***REMOVED***,
            additionalProperties: false
          ***REMOVED***
        ***REMOVED***,
        basePath: ***REMOVED*** type: 'string' ***REMOVED***
      ***REMOVED***,
      additionalProperties: false
    ***REMOVED***]
  ***REMOVED***,

  create: function noRestrictedPaths(context) ***REMOVED***
    const options = context.options[0] || ***REMOVED******REMOVED***;
    const restrictedPaths = options.zones || [];
    const basePath = options.basePath || process.cwd();
    const currentFilename = context.getFilename();
    const matchingZones = restrictedPaths.filter(zone => ***REMOVED***
      const targetPath = _path2.default.resolve(basePath, zone.target);

      return (0, _containsPath2.default)(currentFilename, targetPath);
    ***REMOVED***);

    function checkForRestrictedImportPath(importPath, node) ***REMOVED***
      const absoluteImportPath = (0, _resolve2.default)(importPath, context);

      if (!absoluteImportPath) ***REMOVED***
        return;
      ***REMOVED***

      matchingZones.forEach(zone => ***REMOVED***
        const absoluteFrom = _path2.default.resolve(basePath, zone.from);

        if ((0, _containsPath2.default)(absoluteImportPath, absoluteFrom)) ***REMOVED***
          context.report(***REMOVED***
            node,
            message: `Unexpected path "$***REMOVED***importPath***REMOVED***" imported in restricted zone.`
          ***REMOVED***);
        ***REMOVED***
      ***REMOVED***);
    ***REMOVED***
