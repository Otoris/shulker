...
function reportIfNonStandard(context, node, name) ***REMOVED***
  if (name.indexOf('!') !== -1) ***REMOVED***
    context.report(node, `Unexpected '!' in '$***REMOVED***name***REMOVED***'. ` + 'Do not use import syntax to configure webpack loaders.');
  ***REMOVED***
***REMOVED***
