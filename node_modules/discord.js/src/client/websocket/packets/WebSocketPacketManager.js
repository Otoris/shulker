...
class WebSocketPacketManager ***REMOVED***
  ...
  ***REMOVED***
  ...
  register(event, Handler) ***REMOVED***
    this.handlers[event] = new Handler(this);
  ***REMOVED***

  handleQueue() ***REMOVED***
    this.queue.forEach((element, index) => ***REMOVED***
      this.handle(this.queue[index], true);
      this.queue.splice(index, 1);
    ***REMOVED***);
  ***REMOVED***

  handle(packet, queue = false) ***REMOVED***
    if (packet.op === Constants.OPCodes.HEARTBEAT_ACK) ***REMOVED***
      this.ws.client._pong(this.ws.client._pingTimestamp);
      this.ws.lastHeartbeatAck = true;
      this.ws.client.emit('debug', 'Heartbeat acknowledged');
    ***REMOVED*** else if (packet.op === Constants.OPCodes.HEARTBEAT) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (this.ws.status === Constants.Status.RECONNECTING) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (this.ws.status !== Constants.Status.READY) ***REMOVED***
      if (BeforeReadyWhitelist.indexOf(packet.t) === -1) ***REMOVED***
