 ...
 * @param ***REMOVED***number***REMOVED*** c The character code to check.
 * @returns ***REMOVED***boolean***REMOVED*** `true` if the character belongs to the category, one of `Mc`, `Me`, and `Mn`.
 */
module.exports = function isCombiningCharacter(c) ***REMOVED***
