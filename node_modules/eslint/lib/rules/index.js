...
const ***REMOVED*** LazyLoadingRuleMap ***REMOVED*** = require("./utils/lazy-loading-rule-map");

/** @type ***REMOVED***Map<string, import("../shared/types").Rule>***REMOVED*** */
module.exports = new LazyLoadingRuleMap(Object.entries(***REMOVED***
