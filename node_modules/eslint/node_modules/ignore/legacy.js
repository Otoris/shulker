...
function make_array(subject) ***REMOVED***
...
var define = function define(object, key, value) ***REMOVED***
  return Object.defineProperty(object, key, ***REMOVED*** value ***REMOVED***);
***REMOVED***;
...
[/[\\^$.|*+()***REMOVED***]/g, function (match) ***REMOVED***
  return `\\$***REMOVED***match***REMOVED***`;
***REMOVED***], [
// > [abc] matches any character inside the brackets
// >    (in this case a, b, or c);
/\[([^\]/]*)($|\])/g, function (match, p1, p2) ***REMOVED***
  return p2 === ']' ? `[$***REMOVED***sanitizeRange(p1)***REMOVED***]` : `\\$***REMOVED***match***REMOVED***`;
***REMOVED***], [
...
function (match, index, str) ***REMOVED***
...
var make_regex = function make_regex(pattern, negative, ignorecase) ***REMOVED***
  var r = cache[pattern];
  if (r) ***REMOVED***
    return r;
  ***REMOVED***
...
var IgnoreBase = function () ***REMOVED***
  function IgnoreBase() ***REMOVED***
  ...
  ***REMOVED***
  ...
  _createClass(IgnoreBase, [***REMOVED***
    key: '_initCache',
  ...
  ***REMOVED***, ***REMOVED***
    ...
    value: function filter(paths) ***REMOVED***
      ...
      return make_array(paths).filter(function (path) ***REMOVED***
  ...
  ***REMOVED***, ***REMOVED***
    key: '_filter',
    value: function _filter(path, slices) ***REMOVED***
      if (!path) ***REMOVED***
        return false;
      ***REMOVED***

      if (path in this._cache) ***REMOVED***
    ...
    ***REMOVED***
    ...
    // @returns ***REMOVED***Boolean***REMOVED*** true if a file is NOT ignored

  ***REMOVED***, ***REMOVED***
    key: '_test',
    value: function _test(path) ***REMOVED***
      ...
      this._rules.forEach(function (rule) ***REMOVED***
        ...
        if (!(matched ^ rule.negative)) ***REMOVED***
...
typeof process !== 'undefined' && (process.env && process.env.IGNORE_TEST_WIN32 || process.platform === 'win32')) ***REMOVED***
  ...
  var make_posix = function make_posix(str) ***REMOVED***
    return (/^\\\\\?\\/.test(str) || /[^\x00-\x80]+/.test(str) ? str : str.replace(/\\/g, '/')
    );
  ***REMOVED***;

  IgnoreBase.prototype._filter = function filterWin32(path, slices) ***REMOVED***
