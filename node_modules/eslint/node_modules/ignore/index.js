...
const DEFAULT_REPLACER_PREFIX = [
  ...
  [
    ...
    /\[([^\]/]*)($|\])/g,
    (match, p1, p2) => p2 === ']'
      ? `[$***REMOVED***sanitizeRange(p1)***REMOVED***]`
...
const make_regex = (pattern, negative, ignorecase) => ***REMOVED***
