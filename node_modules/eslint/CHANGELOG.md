...
* 54b329a Docs: fix substitution of ***REMOVED******REMOVED*** name ***REMOVED******REMOVED*** (#9822) (Andres Kalle)

v4.15.0 - January 6, 2018

* 6ab04b5 New: Add context.report(***REMOVED*** messageId ***REMOVED***) (fixes #6740) (#9165) (Jed Fox)
...
* aafebb2 Docs: Wrap placeholder sample in ***REMOVED***% raw %***REMOVED*** (#7798) (Daniel Lo Nigro)
...
* 3c379ff Update: `no-restricted-***REMOVED***imports,modules***REMOVED***`: add “patterns” (fixes #6963) (#7433) (Jordan Harband)
...
* Fix: camelcase rule with ***REMOVED***properties: never***REMOVED*** shouldn't check assignment (fixes #2189) (Gyandeep Singh)
...
* #595 remove needless 'function Foo() ***REMOVED******REMOVED***' in tests (Kyle Nunery)
...
* remove "function invalid()***REMOVED*** return D ***REMOVED***" from some tests (Michael Ficarra)
