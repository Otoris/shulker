...
interface BigIntConstructor ***REMOVED***
    (value?: any): bigint;
 ...
 */
interface BigInt64Array ***REMOVED***
...
interface BigInt64ArrayConstructor ***REMOVED***
 ...
 * requested number of bytes could not be allocated, an exception is raised.
 */
interface BigUint64Array ***REMOVED***
    /** The size in bytes of each element in the array. */
    readonly BYTES_PER_ELEMENT: number;
...
interface BigUint64ArrayConstructor ***REMOVED***
