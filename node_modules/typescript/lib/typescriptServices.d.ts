...
declare namespace ts ***REMOVED***
     ...
     */
    interface MapLike<T> ***REMOVED***
        [index: string]: T;
    ***REMOVED***
    interface SortedReadonlyArray<T> extends ReadonlyArray<T> ***REMOVED***
        " __sortedArrayBrand": any;
    ***REMOVED***
    interface SortedArray<T> extends Array<T> ***REMOVED***
        " __sortedArrayBrand": any;
    ***REMOVED***
    /** ES6 Map interface, only read methods included. */
    interface ReadonlyMap<T> ***REMOVED***
    ...
    ***REMOVED***
    /** ES6 Map interface. */
    interface Map<T> extends ReadonlyMap<T> ***REMOVED***
    ...
    ***REMOVED***
    ...
    interface Push<T> ***REMOVED***
        push(...values: T[]): void;
    ***REMOVED***
***REMOVED***
declare namespace ts ***REMOVED***
    export type Path = string & ***REMOVED***
        __pathBrand: any;
    ***REMOVED***;
    export interface TextRange ***REMOVED***
        pos: number;
        end: number;
    ***REMOVED***
    ...
    export enum SyntaxKind ***REMOVED***
        Unknown = 0,
        EndOfFileToken = 1,
    ...
    ***REMOVED***
    export enum ModifierFlags ***REMOVED***
        None = 0,
        Export = 1,
        Ambient = 2,
        Public = 4,
    ...
    ***REMOVED***
    export enum JsxFlags ***REMOVED***
        ...
        IntrinsicElement = 3
    ***REMOVED***
    export interface Node extends TextRange ***REMOVED***
        kind: SyntaxKind;
        flags: NodeFlags;
        ...
        parent: Node;
    ***REMOVED***
    export interface JSDocContainer ***REMOVED***
    ***REMOVED***
    ...
    export interface NodeArray<T extends Node> extends ReadonlyArray<T>, TextRange ***REMOVED***
        hasTrailingComma?: boolean;
    ***REMOVED***
    export interface Token<TKind extends SyntaxKind> extends Node ***REMOVED***
        kind: TKind;
    ***REMOVED***
    ...
    export interface Identifier extends PrimaryExpression, Declaration ***REMOVED***
    ...
    ***REMOVED***
    export interface TransientIdentifier extends Identifier ***REMOVED***
        resolvedSymbol: Symbol;
    ***REMOVED***
    export interface QualifiedName extends Node ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface Declaration extends Node ***REMOVED***
        _declarationBrand: any;
    ***REMOVED***
    export interface NamedDeclaration extends Declaration ***REMOVED***
        name?: DeclarationName;
    ***REMOVED***
    export interface DeclarationStatement extends NamedDeclaration, Statement ***REMOVED***
        name?: Identifier | StringLiteral | NumericLiteral;
    ***REMOVED***
    export interface ComputedPropertyName extends Node ***REMOVED***
        parent: Declaration;
        kind: SyntaxKind.ComputedPropertyName;
        expression: Expression;
    ***REMOVED***
    export interface Decorator extends Node ***REMOVED***
        kind: SyntaxKind.Decorator;
        parent: NamedDeclaration;
        expression: LeftHandSideExpression;
    ***REMOVED***
    export interface TypeParameterDeclaration extends NamedDeclaration ***REMOVED***
        ...
        expression?: Expression;
    ***REMOVED***
    export interface SignatureDeclarationBase extends NamedDeclaration, JSDocContainer ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface CallSignatureDeclaration extends SignatureDeclarationBase, TypeElement ***REMOVED***
        kind: SyntaxKind.CallSignature;
    ***REMOVED***
    export interface ConstructSignatureDeclaration extends SignatureDeclarationBase, TypeElement ***REMOVED***
        kind: SyntaxKind.ConstructSignature;
    ***REMOVED***
    export type BindingName = Identifier | BindingPattern;
    export interface VariableDeclaration extends NamedDeclaration ***REMOVED***
    ...
    ***REMOVED***
    export interface VariableDeclarationList extends Node ***REMOVED***
        kind: SyntaxKind.VariableDeclarationList;
        parent: VariableStatement | ForStatement | ForOfStatement | ForInStatement;
        declarations: NodeArray<VariableDeclaration>;
    ***REMOVED***
    export interface ParameterDeclaration extends NamedDeclaration, JSDocContainer ***REMOVED***
        ...
        initializer?: Expression;
    ***REMOVED***
    export interface BindingElement extends NamedDeclaration ***REMOVED***
        ...
        initializer?: Expression;
    ***REMOVED***
    export interface PropertySignature extends TypeElement, JSDocContainer ***REMOVED***
        ...
        initializer?: Expression;
    ***REMOVED***
    export interface PropertyDeclaration extends ClassElement, JSDocContainer ***REMOVED***
        ...
        initializer?: Expression;
    ***REMOVED***
    export interface ObjectLiteralElement extends NamedDeclaration ***REMOVED***
        _objectLiteralBrand: any;
        name?: PropertyName;
    ***REMOVED***
    /** Unlike ObjectLiteralElement, excludes JSXAttribute and JSXSpreadAttribute. */
    export type ObjectLiteralElementLike = PropertyAssignment | ShorthandPropertyAssignment | SpreadAssignment | MethodDeclaration | AccessorDeclaration;
    export interface PropertyAssignment extends ObjectLiteralElement, JSDocContainer ***REMOVED***
        ...
        initializer: Expression;
    ***REMOVED***
    export interface ShorthandPropertyAssignment extends ObjectLiteralElement, JSDocContainer ***REMOVED***
        parent: ObjectLiteralExpression;
    ...
    ***REMOVED***
    export interface SpreadAssignment extends ObjectLiteralElement, JSDocContainer ***REMOVED***
        parent: ObjectLiteralExpression;
    ...
    ***REMOVED***
    ...
    export interface PropertyLikeDeclaration extends NamedDeclaration ***REMOVED***
        name: PropertyName;
    ***REMOVED***
    export interface ObjectBindingPattern extends Node ***REMOVED***
        kind: SyntaxKind.ObjectBindingPattern;
        parent: VariableDeclaration | ParameterDeclaration | BindingElement;
        elements: NodeArray<BindingElement>;
    ***REMOVED***
    export interface ArrayBindingPattern extends Node ***REMOVED***
    ...
    ***REMOVED***
     ...
     * - AccessorDeclaration
     */
    export interface FunctionLikeDeclarationBase extends SignatureDeclarationBase ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface FunctionDeclaration extends FunctionLikeDeclarationBase, DeclarationStatement ***REMOVED***
        kind: SyntaxKind.FunctionDeclaration;
        name?: Identifier;
        body?: FunctionBody;
    ***REMOVED***
    export interface MethodSignature extends SignatureDeclarationBase, TypeElement ***REMOVED***
        kind: SyntaxKind.MethodSignature;
        parent: ObjectTypeDeclaration;
        name: PropertyName;
    ***REMOVED***
    export interface MethodDeclaration extends FunctionLikeDeclarationBase, ClassElement, ObjectLiteralElement, JSDocContainer ***REMOVED***
        kind: SyntaxKind.MethodDeclaration;
        parent: ClassLikeDeclaration | ObjectLiteralExpression;
        name: PropertyName;
        body?: FunctionBody;
    ***REMOVED***
    export interface ConstructorDeclaration extends FunctionLikeDeclarationBase, ClassElement, JSDocContainer ***REMOVED***
        kind: SyntaxKind.Constructor;
        parent: ClassLikeDeclaration;
        body?: FunctionBody;
    ***REMOVED***
    /** For when we encounter a semicolon in a class declaration. ES6 allows these as class elements. */
    export interface SemicolonClassElement extends ClassElement ***REMOVED***
        kind: SyntaxKind.SemicolonClassElement;
        parent: ClassLikeDeclaration;
    ***REMOVED***
    export interface GetAccessorDeclaration extends FunctionLikeDeclarationBase, ClassElement, ObjectLiteralElement, JSDocContainer ***REMOVED***
        kind: SyntaxKind.GetAccessor;
        parent: ClassLikeDeclaration | ObjectLiteralExpression;
        name: PropertyName;
        body?: FunctionBody;
    ***REMOVED***
    export interface SetAccessorDeclaration extends FunctionLikeDeclarationBase, ClassElement, ObjectLiteralElement, JSDocContainer ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface IndexSignatureDeclaration extends SignatureDeclarationBase, ClassElement, TypeElement ***REMOVED***
        kind: SyntaxKind.IndexSignature;
        parent: ObjectTypeDeclaration;
    ***REMOVED***
    export interface TypeNode extends Node ***REMOVED***
        _typeNodeBrand: any;
    ***REMOVED***
    export interface KeywordTypeNode extends TypeNode ***REMOVED***
    ...
    ***REMOVED***
    export interface ImportTypeNode extends NodeWithTypeArguments ***REMOVED***
        kind: SyntaxKind.ImportType;
        isTypeOf?: boolean;
        argument: TypeNode;
        qualifier?: EntityName;
    ***REMOVED***
    export interface ThisTypeNode extends TypeNode ***REMOVED***
        kind: SyntaxKind.ThisType;
    ***REMOVED***
    export type FunctionOrConstructorTypeNode = FunctionTypeNode | ConstructorTypeNode;
    export interface FunctionOrConstructorTypeNodeBase extends TypeNode, SignatureDeclarationBase ***REMOVED***
        kind: SyntaxKind.FunctionType | SyntaxKind.ConstructorType;
        type: TypeNode;
    ***REMOVED***
    export interface FunctionTypeNode extends FunctionOrConstructorTypeNodeBase ***REMOVED***
        kind: SyntaxKind.FunctionType;
    ***REMOVED***
    export interface ConstructorTypeNode extends FunctionOrConstructorTypeNodeBase ***REMOVED***
        kind: SyntaxKind.ConstructorType;
    ***REMOVED***
    export interface NodeWithTypeArguments extends TypeNode ***REMOVED***
        typeArguments?: NodeArray<TypeNode>;
    ***REMOVED***
    export type TypeReferenceType = TypeReferenceNode | ExpressionWithTypeArguments;
    export interface TypeReferenceNode extends NodeWithTypeArguments ***REMOVED***
        kind: SyntaxKind.TypeReference;
        typeName: EntityName;
    ***REMOVED***
    export interface TypePredicateNode extends TypeNode ***REMOVED***
        ...
        type?: TypeNode;
    ***REMOVED***
    export interface TypeQueryNode extends TypeNode ***REMOVED***
        kind: SyntaxKind.TypeQuery;
        exprName: EntityName;
    ***REMOVED***
    export interface TypeLiteralNode extends TypeNode, Declaration ***REMOVED***
        kind: SyntaxKind.TypeLiteral;
        members: NodeArray<TypeElement>;
    ***REMOVED***
    export interface ArrayTypeNode extends TypeNode ***REMOVED***
        kind: SyntaxKind.ArrayType;
        elementType: TypeNode;
    ***REMOVED***
    export interface TupleTypeNode extends TypeNode ***REMOVED***
        kind: SyntaxKind.TupleType;
        elementTypes: NodeArray<TypeNode>;
    ***REMOVED***
    export interface OptionalTypeNode extends TypeNode ***REMOVED***
        kind: SyntaxKind.OptionalType;
        type: TypeNode;
    ***REMOVED***
    export interface RestTypeNode extends TypeNode ***REMOVED***
        kind: SyntaxKind.RestType;
        type: TypeNode;
    ***REMOVED***
    export type UnionOrIntersectionTypeNode = UnionTypeNode | IntersectionTypeNode;
    export interface UnionTypeNode extends TypeNode ***REMOVED***
        kind: SyntaxKind.UnionType;
        types: NodeArray<TypeNode>;
    ***REMOVED***
    export interface IntersectionTypeNode extends TypeNode ***REMOVED***
        kind: SyntaxKind.IntersectionType;
        types: NodeArray<TypeNode>;
    ***REMOVED***
    export interface ConditionalTypeNode extends TypeNode ***REMOVED***
        ...
        falseType: TypeNode;
    ***REMOVED***
    export interface InferTypeNode extends TypeNode ***REMOVED***
        kind: SyntaxKind.InferType;
        typeParameter: TypeParameterDeclaration;
    ***REMOVED***
    export interface ParenthesizedTypeNode extends TypeNode ***REMOVED***
        kind: SyntaxKind.ParenthesizedType;
        type: TypeNode;
    ***REMOVED***
    export interface TypeOperatorNode extends TypeNode ***REMOVED***
        kind: SyntaxKind.TypeOperator;
        operator: SyntaxKind.KeyOfKeyword | SyntaxKind.UniqueKeyword | SyntaxKind.ReadonlyKeyword;
        type: TypeNode;
    ***REMOVED***
    export interface IndexedAccessTypeNode extends TypeNode ***REMOVED***
        kind: SyntaxKind.IndexedAccessType;
        objectType: TypeNode;
        indexType: TypeNode;
    ***REMOVED***
    export interface MappedTypeNode extends TypeNode, Declaration ***REMOVED***
        ...
        type?: TypeNode;
    ***REMOVED***
    export interface LiteralTypeNode extends TypeNode ***REMOVED***
        kind: SyntaxKind.LiteralType;
        literal: BooleanLiteral | LiteralExpression | PrefixUnaryExpression;
    ***REMOVED***
    export interface StringLiteral extends LiteralExpression, Declaration ***REMOVED***
        kind: SyntaxKind.StringLiteral;
    ***REMOVED***
    export type StringLiteralLike = StringLiteral | NoSubstitutionTemplateLiteral;
    export interface Expression extends Node ***REMOVED***
        _expressionBrand: any;
    ***REMOVED***
    export interface OmittedExpression extends Expression ***REMOVED***
        kind: SyntaxKind.OmittedExpression;
    ***REMOVED***
    export interface PartiallyEmittedExpression extends LeftHandSideExpression ***REMOVED***
        kind: SyntaxKind.PartiallyEmittedExpression;
        expression: Expression;
    ***REMOVED***
    export interface UnaryExpression extends Expression ***REMOVED***
        _unaryExpressionBrand: any;
    ***REMOVED***
    /** Deprecated, please use UpdateExpression */
    export type IncrementExpression = UpdateExpression;
    export interface UpdateExpression extends UnaryExpression ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface PrefixUnaryExpression extends UpdateExpression ***REMOVED***
        kind: SyntaxKind.PrefixUnaryExpression;
        operator: PrefixUnaryOperator;
        operand: UnaryExpression;
    ***REMOVED***
    export type PostfixUnaryOperator = SyntaxKind.PlusPlusToken | SyntaxKind.MinusMinusToken;
    export interface PostfixUnaryExpression extends UpdateExpression ***REMOVED***
        kind: SyntaxKind.PostfixUnaryExpression;
        operand: LeftHandSideExpression;
        operator: PostfixUnaryOperator;
    ***REMOVED***
    export interface LeftHandSideExpression extends UpdateExpression ***REMOVED***
        _leftHandSideExpressionBrand: any;
    ***REMOVED***
    export interface MemberExpression extends LeftHandSideExpression ***REMOVED***
        _memberExpressionBrand: any;
    ***REMOVED***
    export interface PrimaryExpression extends MemberExpression ***REMOVED***
        _primaryExpressionBrand: any;
    ***REMOVED***
    export interface NullLiteral extends PrimaryExpression, TypeNode ***REMOVED***
        kind: SyntaxKind.NullKeyword;
    ***REMOVED***
    export interface BooleanLiteral extends PrimaryExpression, TypeNode ***REMOVED***
        kind: SyntaxKind.TrueKeyword | SyntaxKind.FalseKeyword;
    ***REMOVED***
    export interface ThisExpression extends PrimaryExpression, KeywordTypeNode ***REMOVED***
        kind: SyntaxKind.ThisKeyword;
    ***REMOVED***
    export interface SuperExpression extends PrimaryExpression ***REMOVED***
        kind: SyntaxKind.SuperKeyword;
    ***REMOVED***
    export interface ImportExpression extends PrimaryExpression ***REMOVED***
        kind: SyntaxKind.ImportKeyword;
    ***REMOVED***
    export interface DeleteExpression extends UnaryExpression ***REMOVED***
        kind: SyntaxKind.DeleteExpression;
        expression: UnaryExpression;
    ***REMOVED***
    export interface TypeOfExpression extends UnaryExpression ***REMOVED***
        kind: SyntaxKind.TypeOfExpression;
        expression: UnaryExpression;
    ***REMOVED***
    export interface VoidExpression extends UnaryExpression ***REMOVED***
        kind: SyntaxKind.VoidExpression;
        expression: UnaryExpression;
    ***REMOVED***
    export interface AwaitExpression extends UnaryExpression ***REMOVED***
        kind: SyntaxKind.AwaitExpression;
        expression: UnaryExpression;
    ***REMOVED***
    export interface YieldExpression extends Expression ***REMOVED***
        kind: SyntaxKind.YieldExpression;
        asteriskToken?: AsteriskToken;
        expression?: Expression;
    ***REMOVED***
    export interface SyntheticExpression extends Expression ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface BinaryExpression extends Expression, Declaration ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface AssignmentExpression<TOperator extends AssignmentOperatorToken> extends BinaryExpression ***REMOVED***
        left: LeftHandSideExpression;
        operatorToken: TOperator;
    ***REMOVED***
    export interface ObjectDestructuringAssignment extends AssignmentExpression<EqualsToken> ***REMOVED***
        left: ObjectLiteralExpression;
    ***REMOVED***
    export interface ArrayDestructuringAssignment extends AssignmentExpression<EqualsToken> ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface ConditionalExpression extends Expression ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface FunctionExpression extends PrimaryExpression, FunctionLikeDeclarationBase, JSDocContainer ***REMOVED***
        kind: SyntaxKind.FunctionExpression;
        name?: Identifier;
        body: FunctionBody;
    ***REMOVED***
    export interface ArrowFunction extends Expression, FunctionLikeDeclarationBase, JSDocContainer ***REMOVED***
        kind: SyntaxKind.ArrowFunction;
        equalsGreaterThanToken: EqualsGreaterThanToken;
        body: ConciseBody;
        name: never;
    ***REMOVED***
    export interface LiteralLikeNode extends Node ***REMOVED***
        text: string;
        isUnterminated?: boolean;
        hasExtendedUnicodeEscape?: boolean;
    ***REMOVED***
    export interface TemplateLiteralLikeNode extends LiteralLikeNode ***REMOVED***
        rawText?: string;
    ***REMOVED***
    export interface LiteralExpression extends LiteralLikeNode, PrimaryExpression ***REMOVED***
        _literalExpressionBrand: any;
    ***REMOVED***
    export interface RegularExpressionLiteral extends LiteralExpression ***REMOVED***
        kind: SyntaxKind.RegularExpressionLiteral;
    ***REMOVED***
    export interface NoSubstitutionTemplateLiteral extends LiteralExpression, TemplateLiteralLikeNode, Declaration ***REMOVED***
        kind: SyntaxKind.NoSubstitutionTemplateLiteral;
    ***REMOVED***
    export enum TokenFlags ***REMOVED***
        None = 0,
        Scientific = 16,
        Octal = 32,
        HexSpecifier = 64,
        ...
        OctalSpecifier = 256,
    ***REMOVED***
    export interface NumericLiteral extends LiteralExpression, Declaration ***REMOVED***
        kind: SyntaxKind.NumericLiteral;
    ***REMOVED***
    export interface BigIntLiteral extends LiteralExpression ***REMOVED***
        kind: SyntaxKind.BigIntLiteral;
    ***REMOVED***
    export interface TemplateHead extends TemplateLiteralLikeNode ***REMOVED***
        kind: SyntaxKind.TemplateHead;
        parent: TemplateExpression;
    ***REMOVED***
    export interface TemplateMiddle extends TemplateLiteralLikeNode ***REMOVED***
        kind: SyntaxKind.TemplateMiddle;
        parent: TemplateSpan;
    ***REMOVED***
    export interface TemplateTail extends TemplateLiteralLikeNode ***REMOVED***
        kind: SyntaxKind.TemplateTail;
        parent: TemplateSpan;
    ***REMOVED***
    export type TemplateLiteral = TemplateExpression | NoSubstitutionTemplateLiteral;
    export interface TemplateExpression extends PrimaryExpression ***REMOVED***
        kind: SyntaxKind.TemplateExpression;
        head: TemplateHead;
        templateSpans: NodeArray<TemplateSpan>;
    ***REMOVED***
    export interface TemplateSpan extends Node ***REMOVED***
        kind: SyntaxKind.TemplateSpan;
        parent: TemplateExpression;
        expression: Expression;
        literal: TemplateMiddle | TemplateTail;
    ***REMOVED***
    export interface ParenthesizedExpression extends PrimaryExpression, JSDocContainer ***REMOVED***
        kind: SyntaxKind.ParenthesizedExpression;
        expression: Expression;
    ***REMOVED***
    export interface ArrayLiteralExpression extends PrimaryExpression ***REMOVED***
        kind: SyntaxKind.ArrayLiteralExpression;
        elements: NodeArray<Expression>;
    ***REMOVED***
    export interface SpreadElement extends Expression ***REMOVED***
    ...
    ***REMOVED***
     ...
     */
    export interface ObjectLiteralExpressionBase<T extends ObjectLiteralElement> extends PrimaryExpression, Declaration ***REMOVED***
        properties: NodeArray<T>;
    ***REMOVED***
    export interface ObjectLiteralExpression extends ObjectLiteralExpressionBase<ObjectLiteralElementLike> ***REMOVED***
        kind: SyntaxKind.ObjectLiteralExpression;
    ***REMOVED***
    export type EntityNameExpression = Identifier | PropertyAccessEntityNameExpression;
    export type EntityNameOrEntityNameExpression = EntityName | EntityNameExpression;
    export interface PropertyAccessExpression extends MemberExpression, NamedDeclaration ***REMOVED***
        kind: SyntaxKind.PropertyAccessExpression;
        expression: LeftHandSideExpression;
        questionDotToken?: QuestionDotToken;
        name: Identifier;
    ***REMOVED***
    export interface PropertyAccessChain extends PropertyAccessExpression ***REMOVED***
        _optionalChainBrand: any;
    ***REMOVED***
    export interface SuperPropertyAccessExpression extends PropertyAccessExpression ***REMOVED***
        expression: SuperExpression;
    ***REMOVED***
    /** Brand for a PropertyAccessExpression which, like a QualifiedName, consists of a sequence of identifiers separated by dots. */
    export interface PropertyAccessEntityNameExpression extends PropertyAccessExpression ***REMOVED***
        _propertyAccessExpressionLikeQualifiedNameBrand?: any;
        expression: EntityNameExpression;
    ***REMOVED***
    export interface ElementAccessExpression extends MemberExpression ***REMOVED***
        kind: SyntaxKind.ElementAccessExpression;
        expression: LeftHandSideExpression;
        questionDotToken?: QuestionDotToken;
        argumentExpression: Expression;
    ***REMOVED***
    export interface ElementAccessChain extends ElementAccessExpression ***REMOVED***
        _optionalChainBrand: any;
    ***REMOVED***
    export interface SuperElementAccessExpression extends ElementAccessExpression ***REMOVED***
        expression: SuperExpression;
    ***REMOVED***
    export type SuperProperty = SuperPropertyAccessExpression | SuperElementAccessExpression;
    export interface CallExpression extends LeftHandSideExpression, Declaration ***REMOVED***
    ...
    ***REMOVED***
    export interface CallChain extends CallExpression ***REMOVED***
        _optionalChainBrand: any;
    ***REMOVED***
    export type OptionalChain = PropertyAccessChain | ElementAccessChain | CallChain;
    export interface SuperCall extends CallExpression ***REMOVED***
        expression: SuperExpression;
    ***REMOVED***
    export interface ImportCall extends CallExpression ***REMOVED***
        expression: ImportExpression;
    ***REMOVED***
    export interface ExpressionWithTypeArguments extends NodeWithTypeArguments ***REMOVED***
        kind: SyntaxKind.ExpressionWithTypeArguments;
        parent: HeritageClause | JSDocAugmentsTag;
        expression: LeftHandSideExpression;
    ***REMOVED***
    export interface NewExpression extends PrimaryExpression, Declaration ***REMOVED***
        kind: SyntaxKind.NewExpression;
        expression: LeftHandSideExpression;
        typeArguments?: NodeArray<TypeNode>;
        arguments?: NodeArray<Expression>;
    ***REMOVED***
    export interface TaggedTemplateExpression extends MemberExpression ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface AsExpression extends Expression ***REMOVED***
        kind: SyntaxKind.AsExpression;
        expression: Expression;
        type: TypeNode;
    ***REMOVED***
    export interface TypeAssertion extends UnaryExpression ***REMOVED***
        kind: SyntaxKind.TypeAssertionExpression;
        type: TypeNode;
        expression: UnaryExpression;
    ***REMOVED***
    export type AssertionExpression = TypeAssertion | AsExpression;
    export interface NonNullExpression extends LeftHandSideExpression ***REMOVED***
        kind: SyntaxKind.NonNullExpression;
        expression: Expression;
    ***REMOVED***
    export interface MetaProperty extends PrimaryExpression ***REMOVED***
        kind: SyntaxKind.MetaProperty;
        keywordToken: SyntaxKind.NewKeyword | SyntaxKind.ImportKeyword;
        name: Identifier;
    ***REMOVED***
    export interface JsxElement extends PrimaryExpression ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface JsxTagNamePropertyAccess extends PropertyAccessExpression ***REMOVED***
        expression: JsxTagNameExpression;
    ***REMOVED***
    export interface JsxAttributes extends ObjectLiteralExpressionBase<JsxAttributeLike> ***REMOVED***
        kind: SyntaxKind.JsxAttributes;
        parent: JsxOpeningLikeElement;
    ***REMOVED***
    export interface JsxOpeningElement extends Expression ***REMOVED***
    ...
    ***REMOVED***
    export interface JsxSelfClosingElement extends PrimaryExpression ***REMOVED***
        kind: SyntaxKind.JsxSelfClosingElement;
        tagName: JsxTagNameExpression;
        typeArguments?: NodeArray<TypeNode>;
        attributes: JsxAttributes;
    ***REMOVED***
    export interface JsxFragment extends PrimaryExpression ***REMOVED***
        kind: SyntaxKind.JsxFragment;
        openingFragment: JsxOpeningFragment;
        children: NodeArray<JsxChild>;
        closingFragment: JsxClosingFragment;
    ***REMOVED***
    export interface JsxOpeningFragment extends Expression ***REMOVED***
        kind: SyntaxKind.JsxOpeningFragment;
        parent: JsxFragment;
    ***REMOVED***
    export interface JsxClosingFragment extends Expression ***REMOVED***
        kind: SyntaxKind.JsxClosingFragment;
        parent: JsxFragment;
    ***REMOVED***
    export interface JsxAttribute extends ObjectLiteralElement ***REMOVED***
        kind: SyntaxKind.JsxAttribute;
        parent: JsxAttributes;
        name: Identifier;
        initializer?: StringLiteral | JsxExpression;
    ***REMOVED***
    export interface JsxSpreadAttribute extends ObjectLiteralElement ***REMOVED***
        kind: SyntaxKind.JsxSpreadAttribute;
        parent: JsxAttributes;
        expression: Expression;
    ***REMOVED***
    export interface JsxClosingElement extends Node ***REMOVED***
        kind: SyntaxKind.JsxClosingElement;
        parent: JsxElement;
        tagName: JsxTagNameExpression;
    ***REMOVED***
    export interface JsxExpression extends Expression ***REMOVED***
        kind: SyntaxKind.JsxExpression;
        parent: JsxElement | JsxAttributeLike;
        dotDotDotToken?: Token<SyntaxKind.DotDotDotToken>;
        expression?: Expression;
    ***REMOVED***
    export interface JsxText extends LiteralLikeNode ***REMOVED***
        kind: SyntaxKind.JsxText;
        containsOnlyTriviaWhiteSpaces: boolean;
        parent: JsxElement;
    ***REMOVED***
    export type JsxChild = JsxText | JsxExpression | JsxElement | JsxSelfClosingElement | JsxFragment;
    export interface Statement extends Node ***REMOVED***
        _statementBrand: any;
    ***REMOVED***
    export interface NotEmittedStatement extends Statement ***REMOVED***
        kind: SyntaxKind.NotEmittedStatement;
    ***REMOVED***
    /**
     * A list of comma-separated expressions. This node is only created by transformations.
     */
    export interface CommaListExpression extends Expression ***REMOVED***
        kind: SyntaxKind.CommaListExpression;
        elements: NodeArray<Expression>;
    ***REMOVED***
    export interface EmptyStatement extends Statement ***REMOVED***
        kind: SyntaxKind.EmptyStatement;
    ***REMOVED***
    export interface DebuggerStatement extends Statement ***REMOVED***
        kind: SyntaxKind.DebuggerStatement;
    ***REMOVED***
    export interface MissingDeclaration extends DeclarationStatement ***REMOVED***
        kind: SyntaxKind.MissingDeclaration;
        name?: Identifier;
    ***REMOVED***
    export type BlockLike = SourceFile | Block | ModuleBlock | CaseOrDefaultClause;
    export interface Block extends Statement ***REMOVED***
        kind: SyntaxKind.Block;
        statements: NodeArray<Statement>;
    ***REMOVED***
    export interface VariableStatement extends Statement, JSDocContainer ***REMOVED***
        kind: SyntaxKind.VariableStatement;
        declarationList: VariableDeclarationList;
    ***REMOVED***
    export interface ExpressionStatement extends Statement, JSDocContainer ***REMOVED***
        kind: SyntaxKind.ExpressionStatement;
        expression: Expression;
    ***REMOVED***
    export interface IfStatement extends Statement ***REMOVED***
        kind: SyntaxKind.IfStatement;
        expression: Expression;
        thenStatement: Statement;
        elseStatement?: Statement;
    ***REMOVED***
    export interface IterationStatement extends Statement ***REMOVED***
        statement: Statement;
    ***REMOVED***
    export interface DoStatement extends IterationStatement ***REMOVED***
        kind: SyntaxKind.DoStatement;
        expression: Expression;
    ***REMOVED***
    export interface WhileStatement extends IterationStatement ***REMOVED***
        kind: SyntaxKind.WhileStatement;
        expression: Expression;
    ***REMOVED***
    export type ForInitializer = VariableDeclarationList | Expression;
    export interface ForStatement extends IterationStatement ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface ForInStatement extends IterationStatement ***REMOVED***
        kind: SyntaxKind.ForInStatement;
        initializer: ForInitializer;
        expression: Expression;
    ***REMOVED***
    export interface ForOfStatement extends IterationStatement ***REMOVED***
        kind: SyntaxKind.ForOfStatement;
        awaitModifier?: AwaitKeywordToken;
        initializer: ForInitializer;
        expression: Expression;
    ***REMOVED***
    export interface BreakStatement extends Statement ***REMOVED***
        kind: SyntaxKind.BreakStatement;
        label?: Identifier;
    ***REMOVED***
    export interface ContinueStatement extends Statement ***REMOVED***
        kind: SyntaxKind.ContinueStatement;
        label?: Identifier;
    ***REMOVED***
    export type BreakOrContinueStatement = BreakStatement | ContinueStatement;
    export interface ReturnStatement extends Statement ***REMOVED***
        kind: SyntaxKind.ReturnStatement;
        expression?: Expression;
    ***REMOVED***
    export interface WithStatement extends Statement ***REMOVED***
        kind: SyntaxKind.WithStatement;
        expression: Expression;
        statement: Statement;
    ***REMOVED***
    export interface SwitchStatement extends Statement ***REMOVED***
        kind: SyntaxKind.SwitchStatement;
        expression: Expression;
        caseBlock: CaseBlock;
        possiblyExhaustive?: boolean;
    ***REMOVED***
    export interface CaseBlock extends Node ***REMOVED***
        kind: SyntaxKind.CaseBlock;
        parent: SwitchStatement;
        clauses: NodeArray<CaseOrDefaultClause>;
    ***REMOVED***
    export interface CaseClause extends Node ***REMOVED***
        kind: SyntaxKind.CaseClause;
        parent: CaseBlock;
        expression: Expression;
        statements: NodeArray<Statement>;
    ***REMOVED***
    export interface DefaultClause extends Node ***REMOVED***
        kind: SyntaxKind.DefaultClause;
        parent: CaseBlock;
        statements: NodeArray<Statement>;
    ***REMOVED***
    export type CaseOrDefaultClause = CaseClause | DefaultClause;
    export interface LabeledStatement extends Statement, JSDocContainer ***REMOVED***
        kind: SyntaxKind.LabeledStatement;
        label: Identifier;
        statement: Statement;
    ***REMOVED***
    export interface ThrowStatement extends Statement ***REMOVED***
        kind: SyntaxKind.ThrowStatement;
        expression?: Expression;
    ***REMOVED***
    export interface TryStatement extends Statement ***REMOVED***
        kind: SyntaxKind.TryStatement;
        tryBlock: Block;
        catchClause?: CatchClause;
        finallyBlock?: Block;
    ***REMOVED***
    export interface CatchClause extends Node ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface ClassLikeDeclarationBase extends NamedDeclaration, JSDocContainer ***REMOVED***
    ...
    ***REMOVED***
    export interface ClassDeclaration extends ClassLikeDeclarationBase, DeclarationStatement ***REMOVED***
        kind: SyntaxKind.ClassDeclaration;
        /** May be undefined in `export default class ***REMOVED*** ... ***REMOVED***`. */
        name?: Identifier;
    ***REMOVED***
    export interface ClassExpression extends ClassLikeDeclarationBase, PrimaryExpression ***REMOVED***
        kind: SyntaxKind.ClassExpression;
    ***REMOVED***
    export type ClassLikeDeclaration = ClassDeclaration | ClassExpression;
    export interface ClassElement extends NamedDeclaration ***REMOVED***
        _classElementBrand: any;
        name?: PropertyName;
    ***REMOVED***
    export interface TypeElement extends NamedDeclaration ***REMOVED***
        _typeElementBrand: any;
        name?: PropertyName;
        questionToken?: QuestionToken;
    ***REMOVED***
    export interface InterfaceDeclaration extends DeclarationStatement, JSDocContainer ***REMOVED***
        ...
        members: NodeArray<TypeElement>;
    ***REMOVED***
    export interface HeritageClause extends Node ***REMOVED***
        kind: SyntaxKind.HeritageClause;
        parent: InterfaceDeclaration | ClassLikeDeclaration;
        token: SyntaxKind.ExtendsKeyword | SyntaxKind.ImplementsKeyword;
        types: NodeArray<ExpressionWithTypeArguments>;
    ***REMOVED***
    export interface TypeAliasDeclaration extends DeclarationStatement, JSDocContainer ***REMOVED***
        kind: SyntaxKind.TypeAliasDeclaration;
        name: Identifier;
        typeParameters?: NodeArray<TypeParameterDeclaration>;
        type: TypeNode;
    ***REMOVED***
    export interface EnumMember extends NamedDeclaration, JSDocContainer ***REMOVED***
        kind: SyntaxKind.EnumMember;
        parent: EnumDeclaration;
        name: PropertyName;
        initializer?: Expression;
    ***REMOVED***
    export interface EnumDeclaration extends DeclarationStatement, JSDocContainer ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface ModuleDeclaration extends DeclarationStatement, JSDocContainer ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface NamespaceDeclaration extends ModuleDeclaration ***REMOVED***
        name: Identifier;
        body: NamespaceBody;
    ***REMOVED***
    export type JSDocNamespaceBody = Identifier | JSDocNamespaceDeclaration;
    export interface JSDocNamespaceDeclaration extends ModuleDeclaration ***REMOVED***
        name: Identifier;
        body?: JSDocNamespaceBody;
    ***REMOVED***
    export interface ModuleBlock extends Node, Statement ***REMOVED***
    ...
    ***REMOVED***
     ...
     * - import x = M.x;
     */
    export interface ImportEqualsDeclaration extends DeclarationStatement, JSDocContainer ***REMOVED***
        kind: SyntaxKind.ImportEqualsDeclaration;
        parent: SourceFile | ModuleBlock;
        name: Identifier;
        moduleReference: ModuleReference;
    ***REMOVED***
    export interface ExternalModuleReference extends Node ***REMOVED***
        kind: SyntaxKind.ExternalModuleReference;
        parent: ImportEqualsDeclaration;
        expression: Expression;
    ***REMOVED***
    export interface ImportDeclaration extends Statement ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface ImportClause extends NamedDeclaration ***REMOVED***
        kind: SyntaxKind.ImportClause;
        parent: ImportDeclaration;
        name?: Identifier;
        namedBindings?: NamedImportBindings;
    ***REMOVED***
    export interface NamespaceImport extends NamedDeclaration ***REMOVED***
        kind: SyntaxKind.NamespaceImport;
        parent: ImportClause;
        name: Identifier;
    ***REMOVED***
    export interface NamespaceExportDeclaration extends DeclarationStatement ***REMOVED***
        kind: SyntaxKind.NamespaceExportDeclaration;
        name: Identifier;
    ***REMOVED***
    export interface ExportDeclaration extends DeclarationStatement, JSDocContainer ***REMOVED***
        ...
        moduleSpecifier?: Expression;
    ***REMOVED***
    export interface NamedImports extends Node ***REMOVED***
        kind: SyntaxKind.NamedImports;
        parent: ImportClause;
        elements: NodeArray<ImportSpecifier>;
    ***REMOVED***
    export interface NamedExports extends Node ***REMOVED***
        kind: SyntaxKind.NamedExports;
        parent: ExportDeclaration;
        elements: NodeArray<ExportSpecifier>;
    ***REMOVED***
    export type NamedImportsOrExports = NamedImports | NamedExports;
    export interface ImportSpecifier extends NamedDeclaration ***REMOVED***
        kind: SyntaxKind.ImportSpecifier;
        parent: NamedImports;
        propertyName?: Identifier;
        name: Identifier;
    ***REMOVED***
    export interface ExportSpecifier extends NamedDeclaration ***REMOVED***
    ...
    ***REMOVED***
     ...
     */
    export interface ExportAssignment extends DeclarationStatement ***REMOVED***
        kind: SyntaxKind.ExportAssignment;
        parent: SourceFile;
        isExportEquals?: boolean;
        expression: Expression;
    ***REMOVED***
    export interface FileReference extends TextRange ***REMOVED***
        fileName: string;
    ***REMOVED***
    export interface CheckJsDirective extends TextRange ***REMOVED***
        enabled: boolean;
    ***REMOVED***
    export type CommentKind = SyntaxKind.SingleLineCommentTrivia | SyntaxKind.MultiLineCommentTrivia;
    export interface CommentRange extends TextRange ***REMOVED***
        hasTrailingNewLine?: boolean;
        kind: CommentKind;
    ***REMOVED***
    export interface SynthesizedComment extends CommentRange ***REMOVED***
        text: string;
        pos: -1;
        end: -1;
    ***REMOVED***
    export interface JSDocTypeExpression extends TypeNode ***REMOVED***
        kind: SyntaxKind.JSDocTypeExpression;
        type: TypeNode;
    ***REMOVED***
    export interface JSDocType extends TypeNode ***REMOVED***
        _jsDocTypeBrand: any;
    ***REMOVED***
    export interface JSDocAllType extends JSDocType ***REMOVED***
        kind: SyntaxKind.JSDocAllType;
    ***REMOVED***
    export interface JSDocUnknownType extends JSDocType ***REMOVED***
        kind: SyntaxKind.JSDocUnknownType;
    ***REMOVED***
    export interface JSDocNonNullableType extends JSDocType ***REMOVED***
        kind: SyntaxKind.JSDocNonNullableType;
        type: TypeNode;
    ***REMOVED***
    export interface JSDocNullableType extends JSDocType ***REMOVED***
        kind: SyntaxKind.JSDocNullableType;
        type: TypeNode;
    ***REMOVED***
    export interface JSDocOptionalType extends JSDocType ***REMOVED***
        kind: SyntaxKind.JSDocOptionalType;
        type: TypeNode;
    ***REMOVED***
    export interface JSDocFunctionType extends JSDocType, SignatureDeclarationBase ***REMOVED***
        kind: SyntaxKind.JSDocFunctionType;
    ***REMOVED***
    export interface JSDocVariadicType extends JSDocType ***REMOVED***
        kind: SyntaxKind.JSDocVariadicType;
        type: TypeNode;
    ***REMOVED***
    export interface JSDocNamepathType extends JSDocType ***REMOVED***
        kind: SyntaxKind.JSDocNamepathType;
        type: TypeNode;
    ***REMOVED***
    export type JSDocTypeReferencingNode = JSDocVariadicType | JSDocOptionalType | JSDocNullableType | JSDocNonNullableType;
    export interface JSDoc extends Node ***REMOVED***
        kind: SyntaxKind.JSDocComment;
        parent: HasJSDoc;
        tags?: NodeArray<JSDocTag>;
        comment?: string;
    ***REMOVED***
    export interface JSDocTag extends Node ***REMOVED***
        parent: JSDoc | JSDocTypeLiteral;
        tagName: Identifier;
        comment?: string;
    ***REMOVED***
    export interface JSDocUnknownTag extends JSDocTag ***REMOVED***
    ...
    ***REMOVED***
     ...
     */
    export interface JSDocAugmentsTag extends JSDocTag ***REMOVED***
        kind: SyntaxKind.JSDocAugmentsTag;
        class: ExpressionWithTypeArguments & ***REMOVED***
            expression: Identifier | PropertyAccessEntityNameExpression;
        ***REMOVED***;
    ***REMOVED***
    export interface JSDocAuthorTag extends JSDocTag ***REMOVED***
        kind: SyntaxKind.JSDocAuthorTag;
    ***REMOVED***
    export interface JSDocClassTag extends JSDocTag ***REMOVED***
        kind: SyntaxKind.JSDocClassTag;
    ***REMOVED***
    export interface JSDocEnumTag extends JSDocTag, Declaration ***REMOVED***
        parent: JSDoc;
        kind: SyntaxKind.JSDocEnumTag;
        typeExpression?: JSDocTypeExpression;
    ***REMOVED***
    export interface JSDocThisTag extends JSDocTag ***REMOVED***
        kind: SyntaxKind.JSDocThisTag;
        typeExpression?: JSDocTypeExpression;
    ***REMOVED***
    export interface JSDocTemplateTag extends JSDocTag ***REMOVED***
        kind: SyntaxKind.JSDocTemplateTag;
        constraint: JSDocTypeExpression | undefined;
        typeParameters: NodeArray<TypeParameterDeclaration>;
    ***REMOVED***
    export interface JSDocReturnTag extends JSDocTag ***REMOVED***
        kind: SyntaxKind.JSDocReturnTag;
        typeExpression?: JSDocTypeExpression;
    ***REMOVED***
    export interface JSDocTypeTag extends JSDocTag ***REMOVED***
        kind: SyntaxKind.JSDocTypeTag;
        typeExpression: JSDocTypeExpression;
    ***REMOVED***
    export interface JSDocTypedefTag extends JSDocTag, NamedDeclaration ***REMOVED***
        parent: JSDoc;
    ...
    ***REMOVED***
    export interface JSDocCallbackTag extends JSDocTag, NamedDeclaration ***REMOVED***
        parent: JSDoc;
    ...
    ***REMOVED***
    export interface JSDocSignature extends JSDocType, Declaration ***REMOVED***
        kind: SyntaxKind.JSDocSignature;
        typeParameters?: readonly JSDocTemplateTag[];
        parameters: readonly JSDocParameterTag[];
        type: JSDocReturnTag | undefined;
    ***REMOVED***
    export interface JSDocPropertyLikeTag extends JSDocTag, Declaration ***REMOVED***
        parent: JSDoc;
        name: EntityName;
        typeExpression?: JSDocTypeExpression;
        ...
        isBracketed: boolean;
    ***REMOVED***
    export interface JSDocPropertyTag extends JSDocPropertyLikeTag ***REMOVED***
        kind: SyntaxKind.JSDocPropertyTag;
    ***REMOVED***
    export interface JSDocParameterTag extends JSDocPropertyLikeTag ***REMOVED***
        kind: SyntaxKind.JSDocParameterTag;
    ***REMOVED***
    export interface JSDocTypeLiteral extends JSDocType ***REMOVED***
        kind: SyntaxKind.JSDocTypeLiteral;
        jsDocPropertyTags?: readonly JSDocPropertyLikeTag[];
        /** If true, then this type literal represents an *array* of its type. */
        isArrayType?: boolean;
    ***REMOVED***
    export enum FlowFlags ***REMOVED***
        Unreachable = 1,
        Start = 2,
        BranchLabel = 4,
        LoopLabel = 8,
    ...
    ***REMOVED***
    ...
    export interface FlowNodeBase ***REMOVED***
        flags: FlowFlags;
        id?: number;
    ***REMOVED***
    export interface FlowLock ***REMOVED***
        locked?: boolean;
    ***REMOVED***
    export interface AfterFinallyFlow extends FlowNodeBase, FlowLock ***REMOVED***
        antecedent: FlowNode;
    ***REMOVED***
    export interface PreFinallyFlow extends FlowNodeBase ***REMOVED***
        antecedent: FlowNode;
        lock: FlowLock;
    ***REMOVED***
    export interface FlowStart extends FlowNodeBase ***REMOVED***
        node?: FunctionExpression | ArrowFunction | MethodDeclaration;
    ***REMOVED***
    export interface FlowLabel extends FlowNodeBase ***REMOVED***
        antecedents: FlowNode[] | undefined;
    ***REMOVED***
    export interface FlowAssignment extends FlowNodeBase ***REMOVED***
        node: Expression | VariableDeclaration | BindingElement;
        antecedent: FlowNode;
    ***REMOVED***
    export interface FlowCall extends FlowNodeBase ***REMOVED***
        node: CallExpression;
        antecedent: FlowNode;
    ***REMOVED***
    export interface FlowCondition extends FlowNodeBase ***REMOVED***
        node: Expression;
        antecedent: FlowNode;
    ***REMOVED***
    export interface FlowSwitchClause extends FlowNodeBase ***REMOVED***
        switchStatement: SwitchStatement;
        clauseStart: number;
        clauseEnd: number;
        antecedent: FlowNode;
    ***REMOVED***
    export interface FlowArrayMutation extends FlowNodeBase ***REMOVED***
        node: CallExpression | BinaryExpression;
        antecedent: FlowNode;
    ***REMOVED***
    export type FlowType = Type | IncompleteType;
    export interface IncompleteType ***REMOVED***
        flags: TypeFlags;
        type: Type;
    ***REMOVED***
    export interface AmdDependency ***REMOVED***
        path: string;
        name?: string;
    ***REMOVED***
    export interface SourceFile extends Declaration ***REMOVED***
    ...
    ***REMOVED***
    export interface Bundle extends Node ***REMOVED***
        kind: SyntaxKind.Bundle;
        prepends: readonly (InputFiles | UnparsedSource)[];
        sourceFiles: readonly SourceFile[];
    ***REMOVED***
    export interface InputFiles extends Node ***REMOVED***
    ...
    ***REMOVED***
    export interface UnparsedSource extends Node ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface UnparsedSection extends Node ***REMOVED***
        kind: SyntaxKind;
        data?: string;
        parent: UnparsedSource;
    ***REMOVED***
    export interface UnparsedPrologue extends UnparsedSection ***REMOVED***
        kind: SyntaxKind.UnparsedPrologue;
        data: string;
        parent: UnparsedSource;
    ***REMOVED***
    export interface UnparsedPrepend extends UnparsedSection ***REMOVED***
        kind: SyntaxKind.UnparsedPrepend;
        data: string;
        parent: UnparsedSource;
        texts: readonly UnparsedTextLike[];
    ***REMOVED***
    export interface UnparsedTextLike extends UnparsedSection ***REMOVED***
        kind: SyntaxKind.UnparsedText | SyntaxKind.UnparsedInternalText;
        parent: UnparsedSource;
    ***REMOVED***
    export interface UnparsedSyntheticReference extends UnparsedSection ***REMOVED***
        kind: SyntaxKind.UnparsedSyntheticReference;
        parent: UnparsedSource;
    ***REMOVED***
    export interface JsonSourceFile extends SourceFile ***REMOVED***
        statements: NodeArray<JsonObjectExpressionStatement>;
    ***REMOVED***
    export interface TsConfigSourceFile extends JsonSourceFile ***REMOVED***
        extendedSourceFiles?: string[];
    ***REMOVED***
    export interface JsonMinusNumericLiteral extends PrefixUnaryExpression ***REMOVED***
        kind: SyntaxKind.PrefixUnaryExpression;
        operator: SyntaxKind.MinusToken;
        operand: NumericLiteral;
    ***REMOVED***
    export interface JsonObjectExpressionStatement extends ExpressionStatement ***REMOVED***
    ...
    ***REMOVED***
    export interface ScriptReferenceHost ***REMOVED***
        getCompilerOptions(): CompilerOptions;
        getSourceFile(fileName: string): SourceFile | undefined;
        getSourceFileByPath(path: Path): SourceFile | undefined;
        getCurrentDirectory(): string;
    ***REMOVED***
    export interface ParseConfigHost ***REMOVED***
    ...
    ***REMOVED***
     ...
     */
    export type ResolvedConfigFileName = string & ***REMOVED***
    ...
    ***REMOVED***;
    ...
    export class OperationCanceledException ***REMOVED***
    ***REMOVED***
    export interface CancellationToken ***REMOVED***
        isCancellationRequested(): boolean;
        /** @throws OperationCanceledException if isCancellationRequested is true */
        throwIfCancellationRequested(): void;
    ***REMOVED***
    export interface Program extends ScriptReferenceHost ***REMOVED***
        /**
    ...
    ***REMOVED***
    export interface ResolvedProjectReference ***REMOVED***
        commandLine: ParsedCommandLine;
        sourceFile: SourceFile;
        references?: readonly (ResolvedProjectReference | undefined)[];
    ***REMOVED***
    export type CustomTransformerFactory = (context: TransformationContext) => CustomTransformer;
    export interface CustomTransformer ***REMOVED***
        transformSourceFile(node: SourceFile): SourceFile;
        transformBundle(node: Bundle): Bundle;
    ***REMOVED***
    export interface CustomTransformers ***REMOVED***
    ...
    ***REMOVED***
    export interface SourceMapSpan ***REMOVED***
    ...
    ***REMOVED***
    ...
    export enum ExitStatus ***REMOVED***
        Success = 0,
    ...
    ***REMOVED***
    export interface EmitResult ***REMOVED***
        emitSkipped: boolean;
        /** Contains declaration emit diagnostics */
        diagnostics: readonly Diagnostic[];
        emittedFiles?: string[];
    ***REMOVED***
    export interface TypeChecker ***REMOVED***
        ...
        /** Note that the resulting nodes cannot be checked. */
        signatureToSignatureDeclaration(signature: Signature, kind: SyntaxKind, enclosingDeclaration?: Node, flags?: NodeBuilderFlags): (SignatureDeclaration & ***REMOVED***
            typeArguments?: NodeArray<TypeNode>;
        ***REMOVED***) | undefined;
        /** Note that the resulting nodes cannot be checked. */
    ...
    ***REMOVED***
    export enum NodeBuilderFlags ***REMOVED***
        None = 0,
        NoTruncation = 1,
    ...
    ***REMOVED***
    export enum TypeFormatFlags ***REMOVED***
        None = 0,
        NoTruncation = 1,
        WriteArrayAsGenericType = 2,
        UseStructuralFallback = 8,
    ...
    ***REMOVED***
    export enum SymbolFormatFlags ***REMOVED***
        None = 0,
    ...
    ***REMOVED***
    export enum TypePredicateKind ***REMOVED***
        This = 0,
        Identifier = 1,
        AssertsThis = 2,
        AssertsIdentifier = 3
    ***REMOVED***
    export interface TypePredicateBase ***REMOVED***
        kind: TypePredicateKind;
        type: Type | undefined;
    ***REMOVED***
    export interface ThisTypePredicate extends TypePredicateBase ***REMOVED***
        kind: TypePredicateKind.This;
        parameterName: undefined;
        parameterIndex: undefined;
        type: Type;
    ***REMOVED***
    export interface IdentifierTypePredicate extends TypePredicateBase ***REMOVED***
        kind: TypePredicateKind.Identifier;
        parameterName: string;
        parameterIndex: number;
        type: Type;
    ***REMOVED***
    export interface AssertsThisTypePredicate extends TypePredicateBase ***REMOVED***
        kind: TypePredicateKind.AssertsThis;
        parameterName: undefined;
        parameterIndex: undefined;
        type: Type | undefined;
    ***REMOVED***
    export interface AssertsIdentifierTypePredicate extends TypePredicateBase ***REMOVED***
    ...
    ***REMOVED***
    ...
    export enum SymbolFlags ***REMOVED***
        None = 0,
        ...
        ClassMember = 106500,
    ***REMOVED***
    export interface Symbol ***REMOVED***
        flags: SymbolFlags;
    ...
    ***REMOVED***
    export enum InternalSymbolName ***REMOVED***
        Call = "__call",
    ...
    ***REMOVED***
     ...
     */
    export type __String = (string & ***REMOVED***
        __escapedIdentifier: void;
    ***REMOVED***) | (void & ***REMOVED***
        __escapedIdentifier: void;
    ***REMOVED***) | InternalSymbolName;
    /** ReadonlyMap where keys are `__String`s. */
    export interface ReadonlyUnderscoreEscapedMap<T> ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface UnderscoreEscapedMap<T> extends ReadonlyUnderscoreEscapedMap<T> ***REMOVED***
    ...
    ***REMOVED***
    export interface LiteralType extends Type ***REMOVED***
        value: string | number | PseudoBigInt;
        freshType: LiteralType;
        regularType: LiteralType;
    ***REMOVED***
    export interface UniqueESSymbolType extends Type ***REMOVED***
        symbol: Symbol;
        escapedName: __String;
    ***REMOVED***
    export interface StringLiteralType extends LiteralType ***REMOVED***
        value: string;
    ***REMOVED***
    export interface NumberLiteralType extends LiteralType ***REMOVED***
        value: number;
    ***REMOVED***
    export interface BigIntLiteralType extends LiteralType ***REMOVED***
        value: PseudoBigInt;
    ***REMOVED***
    export interface EnumType extends Type ***REMOVED***
    ***REMOVED***
    export enum ObjectFlags ***REMOVED***
        Class = 1,
        Interface = 2,
        Reference = 4,
        Tuple = 8,
        ...
        ClassOrInterface = 3,
    ***REMOVED***
    export interface ObjectType extends Type ***REMOVED***
        objectFlags: ObjectFlags;
    ***REMOVED***
    /** Class and interface types (ObjectFlags.Class and ObjectFlags.Interface). */
    export interface InterfaceType extends ObjectType ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface InterfaceTypeWithDeclaredMembers extends InterfaceType ***REMOVED***
    ...
    ***REMOVED***
     ...
     */
    export interface TypeReference extends ObjectType ***REMOVED***
        target: GenericType;
        node?: TypeReferenceNode | ArrayTypeNode | TupleTypeNode;
    ***REMOVED***
    export interface DeferredTypeReference extends TypeReference ***REMOVED***
    ***REMOVED***
    export interface GenericType extends InterfaceType, TypeReference ***REMOVED***
    ***REMOVED***
    export interface TupleType extends GenericType ***REMOVED***
        minLength: number;
        hasRestElement: boolean;
        readonly: boolean;
        associatedNames?: __String[];
    ***REMOVED***
    export interface TupleTypeReference extends TypeReference ***REMOVED***
        target: TupleType;
    ***REMOVED***
    export interface UnionOrIntersectionType extends Type ***REMOVED***
        types: Type[];
    ***REMOVED***
    export interface UnionType extends UnionOrIntersectionType ***REMOVED***
    ***REMOVED***
    export interface IntersectionType extends UnionOrIntersectionType ***REMOVED***
    ***REMOVED***
    export type StructuredType = ObjectType | UnionType | IntersectionType;
    export interface EvolvingArrayType extends ObjectType ***REMOVED***
        elementType: Type;
        finalArrayType?: Type;
    ***REMOVED***
    export interface InstantiableType extends Type ***REMOVED***
    ***REMOVED***
    export interface TypeParameter extends InstantiableType ***REMOVED***
    ***REMOVED***
    export interface IndexedAccessType extends InstantiableType ***REMOVED***
        objectType: Type;
        indexType: Type;
        constraint?: Type;
    ...
    ***REMOVED***
    ...
    export interface IndexType extends InstantiableType ***REMOVED***
        type: InstantiableType | UnionOrIntersectionType;
    ***REMOVED***
    export interface ConditionalRoot ***REMOVED***
    ...
    ***REMOVED***
    export interface ConditionalType extends InstantiableType ***REMOVED***
    ...
    ***REMOVED***
    export interface SubstitutionType extends InstantiableType ***REMOVED***
        typeVariable: TypeVariable;
        substitute: Type;
    ***REMOVED***
    export enum SignatureKind ***REMOVED***
        Call = 0,
        Construct = 1
    ***REMOVED***
    ...
    ***REMOVED***
    export enum IndexKind ***REMOVED***
        String = 0,
        Number = 1
    ***REMOVED***
    export interface IndexInfo ***REMOVED***
        type: Type;
        isReadonly: boolean;
        declaration?: IndexSignatureDeclaration;
    ***REMOVED***
    export enum InferencePriority ***REMOVED***
        NakedTypeVariable = 1,
    ...
    ***REMOVED***
    ...
    export interface FileExtensionInfo ***REMOVED***
        extension: string;
        isMixedContent: boolean;
        scriptKind?: ScriptKind;
    ***REMOVED***
    export interface DiagnosticMessage ***REMOVED***
        key: string;
        category: DiagnosticCategory;
        code: number;
        message: string;
        reportsUnnecessary?: ***REMOVED******REMOVED***;
    ***REMOVED***
    /**
     ...
     */
    export interface DiagnosticMessageChain ***REMOVED***
        messageText: string;
        category: DiagnosticCategory;
        code: number;
        next?: DiagnosticMessageChain[];
    ***REMOVED***
    export interface Diagnostic extends DiagnosticRelatedInformation ***REMOVED***
        /** May store more in future. For now, this will simply be `true` to indicate when a diagnostic is an unused-identifier diagnostic. */
        reportsUnnecessary?: ***REMOVED******REMOVED***;
        source?: string;
        relatedInformation?: DiagnosticRelatedInformation[];
    ***REMOVED***
    export interface DiagnosticRelatedInformation ***REMOVED***
        category: DiagnosticCategory;
        code: number;
    ...
    ***REMOVED***
    export interface DiagnosticWithLocation extends Diagnostic ***REMOVED***
        file: SourceFile;
        start: number;
        length: number;
    ***REMOVED***
    export enum DiagnosticCategory ***REMOVED***
        Warning = 0,
        Error = 1,
        Suggestion = 2,
        Message = 3
    ***REMOVED***
    export enum ModuleResolutionKind ***REMOVED***
        Classic = 1,
        NodeJs = 2
    ***REMOVED***
    export interface PluginImport ***REMOVED***
        name: string;
    ***REMOVED***
    export interface ProjectReference ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface CompilerOptions ***REMOVED***
        allowJs?: boolean;
    ...
    ***REMOVED***
    export interface TypeAcquisition ***REMOVED***
        /**
    ...
    ***REMOVED***
    export enum ModuleKind ***REMOVED***
        None = 0,
        CommonJS = 1,
        AMD = 2,
        UMD = 3,
        ...
        ESNext = 99
    ***REMOVED***
    export enum JsxEmit ***REMOVED***
        None = 0,
        Preserve = 1,
        React = 2,
        ReactNative = 3
    ***REMOVED***
    export enum NewLineKind ***REMOVED***
        CarriageReturnLineFeed = 0,
        LineFeed = 1
    ***REMOVED***
    export interface LineAndCharacter ***REMOVED***
        /** 0-based. */
        line: number;
        character: number;
    ***REMOVED***
    export enum ScriptKind ***REMOVED***
        Unknown = 0,
        JS = 1,
        JSX = 2,
        TS = 3,
        ...
        Deferred = 7
    ***REMOVED***
    export enum ScriptTarget ***REMOVED***
        ES3 = 0,
        ES5 = 1,
        ES2015 = 2,
        ES2016 = 3,
        ...
        Latest = 99
    ***REMOVED***
    export enum LanguageVariant ***REMOVED***
        Standard = 0,
        JSX = 1
    ***REMOVED***
    /** Either a parsed command line or a parsed tsconfig.json */
    export interface ParsedCommandLine ***REMOVED***
    ...
    ***REMOVED***
    export enum WatchDirectoryFlags ***REMOVED***
        None = 0,
        Recursive = 1
    ***REMOVED***
    export interface ExpandResult ***REMOVED***
        fileNames: string[];
        wildcardDirectories: MapLike<WatchDirectoryFlags>;
    ***REMOVED***
    export interface CreateProgramOptions ***REMOVED***
    ...
    ***REMOVED***
    export interface ModuleResolutionHost ***REMOVED***
    ...
    ***REMOVED***
     ...
     */
    export interface ResolvedModule ***REMOVED***
    ...
    ***REMOVED***
     ...
     */
    export interface ResolvedModuleFull extends ResolvedModule ***REMOVED***
        /**
    ...
    ***REMOVED***
     ...
     */
    export interface PackageId ***REMOVED***
        /**
         * Name of the package.
    ...
    ***REMOVED***
    export interface ResolvedModuleWithFailedLookupLocations ***REMOVED***
        readonly resolvedModule: ResolvedModuleFull | undefined;
    ***REMOVED***
    export interface ResolvedTypeReferenceDirective ***REMOVED***
        primary: boolean;
        ...
        isExternalLibraryImport?: boolean;
    ***REMOVED***
    export interface ResolvedTypeReferenceDirectiveWithFailedLookupLocations ***REMOVED***
        readonly resolvedTypeReferenceDirective: ResolvedTypeReferenceDirective | undefined;
        readonly failedLookupLocations: readonly string[];
    ***REMOVED***
    export interface CompilerHost extends ModuleResolutionHost ***REMOVED***
    ...
    ***REMOVED***
    export interface SourceMapRange extends TextRange ***REMOVED***
        source?: SourceMapSource;
    ***REMOVED***
    export interface SourceMapSource ***REMOVED***
        fileName: string;
        text: string;
        skipTrivia?: (pos: number) => number;
    ***REMOVED***
    export enum EmitFlags ***REMOVED***
        None = 0,
        SingleLine = 1,
        AdviseOnEmitNode = 2,
        NoSubstitution = 4,
    ...
    ***REMOVED***
    export interface EmitHelper ***REMOVED***
        readonly name: string;
        readonly scoped: boolean;
        readonly text: string | ((node: EmitHelperUniqueNameCallback) => string);
        readonly priority?: number;
    ***REMOVED***
    export interface UnscopedEmitHelper extends EmitHelper ***REMOVED***
        readonly scoped: false;
        readonly text: string;
    ***REMOVED***
    export type EmitHelperUniqueNameCallback = (name: string) => string;
    export enum EmitHint ***REMOVED***
        SourceFile = 0,
        Expression = 1,
        IdentifierName = 2,
        ...
        EmbeddedStatement = 5
    ***REMOVED***
    export interface TransformationContext ***REMOVED***
    ...
    ***REMOVED***
    export interface TransformationResult<T extends Node> ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface Printer ***REMOVED***
        /**
    ...
    ***REMOVED***
    export interface PrintHandlers ***REMOVED***
        /**
         ...
         * @example
         * ```ts
         * var printer = createPrinter(printerOptions, ***REMOVED***
         *   onEmitNode(hint, node, emitCallback) ***REMOVED***
         ...
         * ```ts
         * var printer = createPrinter(printerOptions, ***REMOVED***
         *   substituteNode(hint, node) ***REMOVED***
        ...
        substituteNode?(hint: EmitHint, node: Node): Node;
    ***REMOVED***
    export interface PrinterOptions ***REMOVED***
        removeComments?: boolean;
        newLine?: NewLineKind;
        omitTrailingSemicolon?: boolean;
        noEmitHelpers?: boolean;
    ***REMOVED***
    export interface GetEffectiveTypeRootsHost ***REMOVED***
        directoryExists?(directoryName: string): boolean;
        getCurrentDirectory?(): string;
    ***REMOVED***
    export interface ModuleSpecifierResolutionHost extends GetEffectiveTypeRootsHost ***REMOVED***
        useCaseSensitiveFileNames?(): boolean;
        fileExists?(path: string): boolean;
        readFile?(path: string): string | undefined;
    ***REMOVED***
    export interface TextSpan ***REMOVED***
        start: number;
        length: number;
    ***REMOVED***
    export interface TextChangeRange ***REMOVED***
        span: TextSpan;
        newLength: number;
    ***REMOVED***
    export interface SyntaxList extends Node ***REMOVED***
        _children: Node[];
    ***REMOVED***
    export enum ListFormat ***REMOVED***
        None = 0,
        SingleLine = 0,
        MultiLine = 1,
        PreserveLines = 2,
        ...
        JSDocComment = 33
    ***REMOVED***
    export interface UserPreferences ***REMOVED***
    ...
    ***REMOVED***
    ...
    export interface PseudoBigInt ***REMOVED***
        negative: boolean;
        base10Value: string;
    ***REMOVED***
...
declare namespace ts ***REMOVED***
    export enum FileWatcherEventKind ***REMOVED***
        Created = 0,
        Changed = 1,
        Deleted = 2
    ***REMOVED***
    ...
    export interface System ***REMOVED***
        args: string[];
        newLine: string;
        useCaseSensitiveFileNames: boolean;
        write(s: string): void;
    ...
    ***REMOVED***
    export interface FileWatcher ***REMOVED***
        close(): void;
    ***REMOVED***
...
declare namespace ts ***REMOVED***
    ...
    type ParameterPropertyDeclaration = ParameterDeclaration & ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    function validateLocaleAndSetLanguage(locale: string, sys: ***REMOVED***
        getExecutingFilePath(): string;
        resolvePath(path: string): string;
        fileExists(fileName: string): boolean;
        readFile(fileName: string): string | undefined;
...
declare namespace ts ***REMOVED***
     ...
     */
    export interface ConfigFileDiagnosticsReporter ***REMOVED***
        /**
    ...
    ***REMOVED***
     ...
     */
    export interface ParseConfigFileHost extends ParseConfigHost, ConfigFileDiagnosticsReporter ***REMOVED***
        getCurrentDirectory(): string;
    ***REMOVED***
    /**
     ...
     */
    export function readConfigFile(fileName: string, readFile: (path: string) => string | undefined): ***REMOVED***
        config?: any;
        error?: Diagnostic;
    ***REMOVED***;
    /**
     ...
     */
    export function parseConfigFileTextToJson(fileName: string, jsonText: string): ***REMOVED***
        config?: any;
        error?: Diagnostic;
    ***REMOVED***;
    /**
    ...
    export interface ParsedTsconfig ***REMOVED***
        raw: any;
        options?: CompilerOptions;
        typeAcquisition?: TypeAcquisition;
        /**
    ...
    ***REMOVED***
    export interface ExtendedConfigCacheEntry ***REMOVED***
        extendedResult: TsConfigSourceFile;
        extendedConfig: ParsedTsconfig | undefined;
    ***REMOVED***
    export function convertCompilerOptionsFromJson(jsonOptions: any, basePath: string, configFileName?: string): ***REMOVED***
        options: CompilerOptions;
        errors: Diagnostic[];
    ***REMOVED***;
    export function convertTypeAcquisitionFromJson(jsonOptions: any, basePath: string, configFileName?: string): ***REMOVED***
...
declare namespace ts ***REMOVED***
    ...
    /**
     * @param ***REMOVED***string | undefined***REMOVED*** containingFile - file that contains type reference directive, can be undefined if containing file is unknown.
     ...
     */
    interface ModuleResolutionCache extends NonRelativeModuleNameResolutionCache ***REMOVED***
    ...
    ***REMOVED***
     ...
     */
    interface NonRelativeModuleNameResolutionCache ***REMOVED***
    ...
    ***REMOVED***
    interface PerModuleNameCache ***REMOVED***
...
declare namespace ts ***REMOVED***
    ...
    export interface FormatDiagnosticsHost ***REMOVED***
        getCurrentDirectory(): string;
        getCanonicalFileName(fileName: string): string;
        getNewLine(): string;
    ***REMOVED***
    ...
    /** @deprecated */ export interface ResolveProjectReferencePathHost ***REMOVED***
        fileExists(fileName: string): boolean;
    ***REMOVED***
    /**
...
***REMOVED***
declare namespace ts ***REMOVED***
    interface EmitOutput ***REMOVED***
        outputFiles: OutputFile[];
        emitSkipped: boolean;
    ***REMOVED***
    interface OutputFile ***REMOVED***
        name: string;
...
***REMOVED***
declare namespace ts ***REMOVED***
    type AffectedFileResult<T> = ***REMOVED***
        result: T;
        affected: SourceFile | Program;
    ***REMOVED*** | undefined;
    interface BuilderProgramHost ***REMOVED***
        /**
    ...
    ***REMOVED***
     ...
     */
    interface BuilderProgram ***REMOVED***
        /**
    ...
    ***REMOVED***
     ...
     */
    interface SemanticDiagnosticsBuilderProgram extends BuilderProgram ***REMOVED***
        /**
    ...
    ***REMOVED***
     ...
     */
    interface EmitAndSemanticDiagnosticsBuilderProgram extends SemanticDiagnosticsBuilderProgram ***REMOVED***
        /**
...
***REMOVED***
declare namespace ts ***REMOVED***
    interface ReadBuildProgramHost ***REMOVED***
        useCaseSensitiveFileNames(): boolean;
        getCurrentDirectory(): string;
        readFile(fileName: string): string | undefined;
    ***REMOVED***
    ...
    interface IncrementalProgramOptions<T extends BuilderProgram> ***REMOVED***
        rootNames: readonly string[];
        options: CompilerOptions;
        configFileParsingDiagnostics?: readonly Diagnostic[];
        projectReferences?: readonly ProjectReference[];
    ...
    ***REMOVED***
    function createIncrementalProgram<T extends BuilderProgram = EmitAndSemanticDiagnosticsBuilderProgram>(***REMOVED*** rootNames, options, configFileParsingDiagnostics, projectReferences, host, createProgram ***REMOVED***: IncrementalProgramOptions<T>): T;
    ...
    interface WatchHost ***REMOVED***
        ...
        clearTimeout?(timeoutId: any): void;
    ***REMOVED***
    interface ProgramHost<T extends BuilderProgram> ***REMOVED***
        /**
        ...
        resolveTypeReferenceDirectives?(typeReferenceDirectiveNames: string[], containingFile: string, redirectedReference: ResolvedProjectReference | undefined, options: CompilerOptions): (ResolvedTypeReferenceDirective | undefined)[];
    ***REMOVED***
    interface WatchCompilerHost<T extends BuilderProgram> extends ProgramHost<T>, WatchHost ***REMOVED***
    ...
    ***REMOVED***
     ...
     */
    interface WatchCompilerHostOfFilesAndCompilerOptions<T extends BuilderProgram> extends WatchCompilerHost<T> ***REMOVED***
    ...
    ***REMOVED***
     ...
     */
    interface WatchCompilerHostOfConfigFile<T extends BuilderProgram> extends WatchCompilerHost<T>, ConfigFileDiagnosticsReporter ***REMOVED***
    ...
    ***REMOVED***
     ...
     */
    interface WatchOfConfigFile<T> extends Watch<T> ***REMOVED***
    ***REMOVED***
    /**
     * Creates the watch that generates program using the root files and compiler options
     */
    interface WatchOfFilesAndCompilerOptions<T> extends Watch<T> ***REMOVED***
...
***REMOVED***
declare namespace ts ***REMOVED***
    interface BuildOptions ***REMOVED***
        dry?: boolean;
        force?: boolean;
        verbose?: boolean;
        incremental?: boolean;
    ...
    ***REMOVED***
    ...
    interface SolutionBuilderHostBase<T extends BuilderProgram> extends ProgramHost<T> ***REMOVED***
        createDirectory?(path: string): void;
        /**
    ...
    ***REMOVED***
    interface SolutionBuilderHost<T extends BuilderProgram> extends SolutionBuilderHostBase<T> ***REMOVED***
        reportErrorSummary?: ReportEmitErrorSummary;
    ***REMOVED***
    interface SolutionBuilderWithWatchHost<T extends BuilderProgram> extends SolutionBuilderHostBase<T>, WatchHost ***REMOVED***
    ***REMOVED***
    interface SolutionBuilder<T extends BuilderProgram> ***REMOVED***
    ...
    ***REMOVED***
    ...
    enum InvalidatedProjectKind ***REMOVED***
        Build = 0,
        UpdateBundle = 1,
        UpdateOutputFileStamps = 2
    ***REMOVED***
    interface InvalidatedProjectBase ***REMOVED***
        ...
        getCurrentDirectory(): string;
    ***REMOVED***
    interface UpdateOutputFileStampsProject extends InvalidatedProjectBase ***REMOVED***
        readonly kind: InvalidatedProjectKind.UpdateOutputFileStamps;
        updateOutputFileStatmps(): void;
    ***REMOVED***
    interface BuildInvalidedProject<T extends BuilderProgram> extends InvalidatedProjectBase ***REMOVED***
    ...
    ***REMOVED***
    interface UpdateBundleProject<T extends BuilderProgram> extends InvalidatedProjectBase ***REMOVED***
        readonly kind: InvalidatedProjectKind.UpdateBundle;
        emit(writeFile?: WriteFileCallback, customTransformers?: CustomTransformers): EmitResult | BuildInvalidedProject<T> | undefined;
    ***REMOVED***
    type InvalidatedProject<T extends BuilderProgram> = UpdateOutputFileStampsProject | BuildInvalidedProject<T> | UpdateBundleProject<T>;
***REMOVED***
declare namespace ts.server ***REMOVED***
    ...
    interface TypingInstallerResponse ***REMOVED***
        readonly kind: ActionSet | ActionInvalidate | EventTypesRegistry | ActionPackageInstalled | EventBeginInstallTypes | EventEndInstallTypes | EventInitializationFailed;
    ***REMOVED***
    interface TypingInstallerRequestWithProjectName ***REMOVED***
        readonly projectName: string;
    ***REMOVED***
    interface DiscoverTypings extends TypingInstallerRequestWithProjectName ***REMOVED***
    ...
    ***REMOVED***
    interface CloseProject extends TypingInstallerRequestWithProjectName ***REMOVED***
        readonly kind: "closeProject";
    ***REMOVED***
    interface TypesRegistryRequest ***REMOVED***
        readonly kind: "typesRegistry";
    ***REMOVED***
    interface InstallPackageRequest extends TypingInstallerRequestWithProjectName ***REMOVED***
        readonly kind: "installPackage";
        readonly fileName: Path;
        readonly packageName: string;
        readonly projectRootPath: Path;
    ***REMOVED***
    interface PackageInstalledResponse extends ProjectResponse ***REMOVED***
        readonly kind: ActionPackageInstalled;
        readonly success: boolean;
        readonly message: string;
    ***REMOVED***
    interface InitializationFailedResponse extends TypingInstallerResponse ***REMOVED***
        readonly kind: EventInitializationFailed;
        readonly message: string;
    ***REMOVED***
    interface ProjectResponse extends TypingInstallerResponse ***REMOVED***
        readonly projectName: string;
    ***REMOVED***
    interface InvalidateCachedTypings extends ProjectResponse ***REMOVED***
        readonly kind: ActionInvalidate;
    ***REMOVED***
    interface InstallTypes extends ProjectResponse ***REMOVED***
        readonly kind: EventBeginInstallTypes | EventEndInstallTypes;
        readonly eventId: number;
        readonly typingsInstallerVersion: string;
        readonly packagesToInstall: readonly string[];
    ***REMOVED***
    interface BeginInstallTypes extends InstallTypes ***REMOVED***
        readonly kind: EventBeginInstallTypes;
    ***REMOVED***
    interface EndInstallTypes extends InstallTypes ***REMOVED***
        readonly kind: EventEndInstallTypes;
        readonly installSuccess: boolean;
    ***REMOVED***
    interface SetTypings extends ProjectResponse ***REMOVED***
        readonly typeAcquisition: TypeAcquisition;
        readonly compilerOptions: CompilerOptions;
...
declare namespace ts ***REMOVED***
    ...
    ***REMOVED***
    interface Identifier ***REMOVED***
        readonly text: string;
    ***REMOVED***
    interface Symbol ***REMOVED***
        readonly name: string;
    ...
    ***REMOVED***
    interface TypeReference ***REMOVED***
        typeArguments?: readonly Type[];
    ***REMOVED***
    interface Signature ***REMOVED***
    ...
    ***REMOVED***
    interface SourceFileLike ***REMOVED***
        getLineAndCharacterOfPosition(pos: number): LineAndCharacter;
    ***REMOVED***
    interface SourceMapSource ***REMOVED***
        getLineAndCharacterOfPosition(pos: number): LineAndCharacter;
    ***REMOVED***
    /**
     ...
     * the same values.
     */
    interface IScriptSnapshot ***REMOVED***
        ...
        dispose?(): void;
    ***REMOVED***
    namespace ScriptSnapshot ***REMOVED***
        function fromString(text: string): IScriptSnapshot;
    ***REMOVED***
    interface PreProcessedFileInfo ***REMOVED***
        ...
        isLibFile: boolean;
    ***REMOVED***
    interface HostCancellationToken ***REMOVED***
        isCancellationRequested(): boolean;
    ***REMOVED***
    interface InstallPackageOptions ***REMOVED***
        fileName: Path;
        packageName: string;
    ***REMOVED***
    interface LanguageServiceHost extends ModuleSpecifierResolutionHost ***REMOVED***
    ...
    ***REMOVED***
    type WithMetadata<T> = T & ***REMOVED***
        metadata?: unknown;
    ***REMOVED***;
    interface LanguageService ***REMOVED***
        ...
        getCombinedCodeFix(scope: CombinedCodeFixScope, fixId: ***REMOVED******REMOVED***, formatOptions: FormatCodeSettings, preferences: UserPreferences): CombinedCodeActions;
        ...
        dispose(): void;
    ***REMOVED***
    interface JsxClosingTagInfo ***REMOVED***
        readonly newText: string;
    ***REMOVED***
    interface CombinedCodeFixScope ***REMOVED***
        type: "file";
        fileName: string;
    ***REMOVED***
    type OrganizeImportsScope = CombinedCodeFixScope;
    type CompletionsTriggerCharacter = "." | '"' | "'" | "`" | "/" | "@" | "<";
    interface GetCompletionsAtPositionOptions extends UserPreferences ***REMOVED***
        /**
    ...
    ***REMOVED***
    ...
    interface SignatureHelpItemsOptions ***REMOVED***
    ...
    ***REMOVED***
     ...
     */
    interface SignatureHelpInvokedReason ***REMOVED***
        kind: "invoked";
    ...
    ***REMOVED***
     ...
     */
    interface SignatureHelpCharacterTypedReason ***REMOVED***
        kind: "characterTyped";
        /**
    ...
    ***REMOVED***
     ...
     */
    interface SignatureHelpRetriggeredReason ***REMOVED***
        kind: "retrigger";
        /**
         * Character that was responsible for triggering signature help.
         */
    ...
    ***REMOVED***
    interface ApplyCodeActionCommandResult ***REMOVED***
        successMessage: string;
    ***REMOVED***
    interface Classifications ***REMOVED***
        spans: number[];
        endOfLineState: EndOfLineState;
    ***REMOVED***
    interface ClassifiedSpan ***REMOVED***
        textSpan: TextSpan;
    ...
    ***REMOVED***
     ...
     */
    interface NavigationBarItem ***REMOVED***
        text: string;
    ...
    ***REMOVED***
     ...
     */
    interface NavigationTree ***REMOVED***
    ...
    ***REMOVED***
    interface TodoCommentDescriptor ***REMOVED***
        text: string;
        priority: number;
    ***REMOVED***
    interface TodoComment ***REMOVED***
        descriptor: TodoCommentDescriptor;
        message: string;
        position: number;
    ***REMOVED***
    interface TextChange ***REMOVED***
        span: TextSpan;
        newText: string;
    ***REMOVED***
    interface FileTextChanges ***REMOVED***
        fileName: string;
        textChanges: readonly TextChange[];
        isNewFile?: boolean;
    ***REMOVED***
    interface CodeAction ***REMOVED***
    ...
    ***REMOVED***
    interface CodeFixAction extends CodeAction ***REMOVED***
         ...
         */
        fixId?: ***REMOVED******REMOVED***;
        fixAllDescription?: string;
    ***REMOVED***
    interface CombinedCodeActions ***REMOVED***
        changes: readonly FileTextChanges[];
        commands?: readonly CodeActionCommand[];
    ***REMOVED***
    type CodeActionCommand = InstallPackageAction;
    interface InstallPackageAction ***REMOVED***
    ***REMOVED***
    /**
     * A set of one or more available refactoring actions, grouped under a parent refactoring.
     */
    interface ApplicableRefactorInfo ***REMOVED***
        /**
    ...
    ***REMOVED***
     ...
     */
    interface RefactorActionInfo ***REMOVED***
        /**
    ...
    ***REMOVED***
     ...
     */
    interface RefactorEditInfo ***REMOVED***
        edits: FileTextChanges[];
        renameFilename?: string;
        renameLocation?: number;
        commands?: CodeActionCommand[];
    ***REMOVED***
    interface TextInsertion ***REMOVED***
        newText: string;
        /** The position in newText the caret should point to after the insertion. */
        caretOffset: number;
    ***REMOVED***
    interface DocumentSpan ***REMOVED***
        textSpan: TextSpan;
        fileName: string;
        /**
    ...
    ***REMOVED***
    interface RenameLocation extends DocumentSpan ***REMOVED***
        readonly prefixText?: string;
        readonly suffixText?: string;
    ***REMOVED***
    interface ReferenceEntry extends DocumentSpan ***REMOVED***
        isWriteAccess: boolean;
        isDefinition: boolean;
        isInString?: true;
    ***REMOVED***
    interface ImplementationLocation extends DocumentSpan ***REMOVED***
        kind: ScriptElementKind;
        displayParts: SymbolDisplayPart[];
    ***REMOVED***
    interface DocumentHighlights ***REMOVED***
        fileName: string;
        highlightSpans: HighlightSpan[];
    ***REMOVED***
    enum HighlightSpanKind ***REMOVED***
        none = "none",
        definition = "definition",
        reference = "reference",
        writtenReference = "writtenReference"
    ***REMOVED***
    interface HighlightSpan ***REMOVED***
        fileName?: string;
        isInString?: true;
        textSpan: TextSpan;
        contextSpan?: TextSpan;
    ...
    ***REMOVED***
    interface NavigateToItem ***REMOVED***
        name: string;
        kind: ScriptElementKind;
        kindModifiers: string;
    ...
    ***REMOVED***
    enum IndentStyle ***REMOVED***
        None = 0,
        Block = 1,
        Smart = 2
    ***REMOVED***
    enum SemicolonPreference ***REMOVED***
        Ignore = "ignore",
        Insert = "insert",
        Remove = "remove"
    ***REMOVED***
    interface EditorOptions ***REMOVED***
    ...
    ***REMOVED***
    interface EditorSettings ***REMOVED***
        baseIndentSize?: number;
        indentSize?: number;
        tabSize?: number;
        newLineCharacter?: string;
        ...
        indentStyle?: IndentStyle;
    ***REMOVED***
    interface FormatCodeOptions extends EditorOptions ***REMOVED***
    ...
    ***REMOVED***
    interface FormatCodeSettings extends EditorSettings ***REMOVED***
    ...
    ***REMOVED***
    ...
    interface DefinitionInfo extends DocumentSpan ***REMOVED***
        kind: ScriptElementKind;
        name: string;
        containerKind: ScriptElementKind;
        containerName: string;
    ***REMOVED***
    interface DefinitionInfoAndBoundSpan ***REMOVED***
        definitions?: readonly DefinitionInfo[];
        textSpan: TextSpan;
    ***REMOVED***
    interface ReferencedSymbolDefinitionInfo extends DefinitionInfo ***REMOVED***
        displayParts: SymbolDisplayPart[];
    ***REMOVED***
    interface ReferencedSymbol ***REMOVED***
        definition: ReferencedSymbolDefinitionInfo;
        references: ReferenceEntry[];
    ***REMOVED***
    enum SymbolDisplayPartKind ***REMOVED***
        aliasName = 0,
        className = 1,
        enumName = 2,
        fieldName = 3,
    ...
    ***REMOVED***
    interface SymbolDisplayPart ***REMOVED***
        text: string;
        kind: string;
    ***REMOVED***
    interface JSDocTagInfo ***REMOVED***
        name: string;
        text?: string;
    ***REMOVED***
    interface QuickInfo ***REMOVED***
        kind: ScriptElementKind;
        kindModifiers: string;
        textSpan: TextSpan;
        displayParts?: SymbolDisplayPart[];
    ...
    ***REMOVED***
    ...
    interface RenameInfoSuccess ***REMOVED***
        canRename: true;
        /**
    ...
    ***REMOVED***
    interface RenameInfoFailure ***REMOVED***
        canRename: false;
        localizedErrorMessage: string;
    ***REMOVED***
    interface RenameInfoOptions ***REMOVED***
        readonly allowRenameOfImportPath?: boolean;
    ***REMOVED***
    interface SignatureHelpParameter ***REMOVED***
        name: string;
        documentation: SymbolDisplayPart[];
        displayParts: SymbolDisplayPart[];
        isOptional: boolean;
    ***REMOVED***
    interface SelectionRange ***REMOVED***
        textSpan: TextSpan;
    ...
    ***REMOVED***
     ...
     */
    interface SignatureHelpItem ***REMOVED***
        isVariadic: boolean;
    ...
    ***REMOVED***
     ...
     */
    interface SignatureHelpItems ***REMOVED***
    ...
    ***REMOVED***
    interface CompletionInfo ***REMOVED***
    ...
    ***REMOVED***
    interface CompletionEntry ***REMOVED***
        name: string;
        kind: ScriptElementKind;
        kindModifiers?: string;
        sortText: string;
        ...
        isRecommended?: true;
    ***REMOVED***
    interface CompletionEntryDetails ***REMOVED***
        name: string;
        kind: ScriptElementKind;
        kindModifiers: string;
        displayParts: SymbolDisplayPart[];
    ...
    ***REMOVED***
    interface OutliningSpan ***REMOVED***
    ...
    ***REMOVED***
    enum OutliningSpanKind ***REMOVED***
        ...
        Imports = "imports"
    ***REMOVED***
    enum OutputFileType ***REMOVED***
        JavaScript = 0,
        SourceMap = 1,
        Declaration = 2
    ***REMOVED***
    enum EndOfLineState ***REMOVED***
        None = 0,
    ...
    ***REMOVED***
    enum TokenClass ***REMOVED***
        ...
        RegExpLiteral = 9
    ***REMOVED***
    interface ClassificationResult ***REMOVED***
        finalLexState: EndOfLineState;
        entries: ClassificationInfo[];
    ***REMOVED***
    interface ClassificationInfo ***REMOVED***
        length: number;
        classification: TokenClass;
    ***REMOVED***
    interface Classifier ***REMOVED***
        /**
    ...
    ***REMOVED***
    enum ScriptElementKind ***REMOVED***
        unknown = "",
        warning = "warning",
        ...
        /** module foo ***REMOVED******REMOVED*** */
        moduleElement = "module",
        /** class X ***REMOVED******REMOVED*** */
        classElement = "class",
        /** var x = class X ***REMOVED******REMOVED*** */
        localClassElement = "local class",
        /** interface Y ***REMOVED******REMOVED*** */
        ...
        /** class X ***REMOVED*** [public|private]* foo() ***REMOVED******REMOVED*** ***REMOVED*** */
        memberFunctionElement = "method",
        /** class X ***REMOVED*** [public|private]* [get|set] foo:number; ***REMOVED*** */
        memberGetAccessorElement = "getter",
        memberSetAccessorElement = "setter",
        /**
         * class X ***REMOVED*** [public|private]* foo:number; ***REMOVED***
         * interface Y ***REMOVED*** foo:number; ***REMOVED***
         */
        memberVariableElement = "property",
        /** class X ***REMOVED*** constructor() ***REMOVED*** ***REMOVED*** ***REMOVED*** */
        constructorImplementationElement = "constructor",
        /** interface Y ***REMOVED*** ():number; ***REMOVED*** */
        callSignatureElement = "call",
        /** interface Y ***REMOVED*** []:number; ***REMOVED*** */
        indexSignatureElement = "index",
        /** interface Y ***REMOVED*** new():Y; ***REMOVED*** */
        ...
        /**
         * <JsxTagName attribute1 attribute2=***REMOVED***0***REMOVED*** />
         */
        jsxAttribute = "JSX attribute",
        /** String literal */
        string = "string"
    ***REMOVED***
    enum ScriptElementKindModifier ***REMOVED***
        none = "",
        ...
        jsonModifier = ".json"
    ***REMOVED***
    enum ClassificationTypeNames ***REMOVED***
        comment = "comment",
    ...
    ***REMOVED***
    enum ClassificationType ***REMOVED***
        comment = 1,
        identifier = 2,
        keyword = 3,
        numericLiteral = 4,
...
declare namespace ts ***REMOVED***
     ...
     */
    interface DocumentRegistry ***REMOVED***
        /**
        ...
        reportStats(): string;
    ***REMOVED***
    type DocumentRegistryBucketKey = string & ***REMOVED***
        __bucketKey: any;
    ***REMOVED***;
...
***REMOVED***
declare namespace ts ***REMOVED***
    interface TranspileOptions ***REMOVED***
    ...
    ***REMOVED***
    interface TranspileOutput ***REMOVED***
        outputText: string;
