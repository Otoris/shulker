    ...
    <Item ItemId=";Strings" ItemType="0" PsrId="211" Leaf="false">
      ...
      <Item ItemId=";ErrorWritingLog" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Falha ao gravar o log do compilador em '***REMOVED***0***REMOVED***'. Exceção: '***REMOVED***1***REMOVED***']]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";FallbackVersionWarning" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Usando a versão do compilador (***REMOVED***0***REMOVED***), se isso estiver incorreto, altere o elemento <TypeScriptToolsVersion> em seu arquivo de projeto.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";LocatedReferenceFilesAt_0" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Arquivo de referências localizadas em: '***REMOVED***0***REMOVED***'.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";NoCompilerError" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[O arquivo de projeto usa uma versão diferente do compilador e ferramentas TypeScript atualmente instalados neste computador. Nenhum compilador foi encontrado em ***REMOVED***0***REMOVED***. Você poderá corrigir esse problema alterando o elemento <TypeScriptToolsVersion> no arquivo de projeto.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      ...
      <Item ItemId=";ToolsVersionWarning" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Não foi possível localizar a versão do compilador (***REMOVED***0***REMOVED***) especificada no arquivo de projeto.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      ...
      <Item ItemId=";TypeScriptVersionMismatchWarning" ItemType="0" PsrId="211" InstFlg="true" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Seu projeto especifica o TypeScriptToolsVersion ***REMOVED***0***REMOVED***, mas um compilador correspondente não foi encontrado. O compilador TypeScript mais recente disponível será utilizado (***REMOVED***1***REMOVED***). Para remover este aviso, instale o SDK do TypeScript ***REMOVED***0***REMOVED*** ou atualize o valor do TypeScriptToolsVersion.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
