  ...
  <Item ItemId=";TypeScriptDebugEngine.TypeScriptResources.resources" ItemType="0" PsrId="211" Leaf="false">
    ...
    <Item ItemId=";Strings" ItemType="0" PsrId="211" Leaf="false">
      ...
      <Item ItemId=";Document_0_read_failed_1" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          <Val><![CDATA[Document ***REMOVED***0***REMOVED*** read failed: ***REMOVED***1***REMOVED***.]]></Val>
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[La lettura del documento ***REMOVED***0***REMOVED*** non è riuscita: ***REMOVED***1***REMOVED***.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      ...
      <Item ItemId=";Invalid_sourcemap_url_0_for_script_1" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          <Val><![CDATA[Invalid sourcemap url ***REMOVED***0***REMOVED*** for script ***REMOVED***1***REMOVED***.]]></Val>
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[L'URL del mapping di origine ***REMOVED***0***REMOVED*** non è valido per lo script ***REMOVED***1***REMOVED***.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";Sourcemap_0_read_failed_1" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          <Val><![CDATA[SourceMap ***REMOVED***0***REMOVED*** read failed: ***REMOVED***1***REMOVED***.]]></Val>
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[La lettura del mapping di origine ***REMOVED***0***REMOVED*** non è riuscita: ***REMOVED***1***REMOVED***.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      ...
      <Item ItemId=";Unsupported_inline_sourcemap_format_specified_SourceMap_0" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          <Val><![CDATA[Unsupported inline sourcemap format specified. SourceMap: ***REMOVED***0***REMOVED***]]></Val>
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Il formato specificato per il mapping di origine incorporato non è supportato. Mapping di origine: ***REMOVED***0***REMOVED***]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
