    ...
    <Item ItemId=";Strings" ItemType="0" PsrId="211" Leaf="false">
      ...
      <Item ItemId=";ErrorWritingLog" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Nepodařilo se napsat protokol kompilátoru do ***REMOVED***0***REMOVED***. Výjimka: ***REMOVED***1***REMOVED***]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";FallbackVersionWarning" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Používá se verze kompilátoru (***REMOVED***0***REMOVED***) – pokud není správná, změňte v souboru projektu element <TypeScriptToolsVersion>.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";LocatedReferenceFilesAt_0" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Našel se soubor odkazů v: ***REMOVED***0***REMOVED***.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";NoCompilerError" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Váš soubor projektu používá jinou verzi kompilátoru a nástrojů TypeScriptu, než jaká je právě nainstalovaná na tomto počítači. V ***REMOVED***0***REMOVED*** jsme nenašli žádný kompilátor. Tento problém možná opravíte změnou elementu <TypeScriptToolsVersion> v souboru projektu.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      ...
      <Item ItemId=";ToolsVersionWarning" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Nepovedlo se najít verzi kompilátoru (***REMOVED***0***REMOVED***) zadanou v souboru projektu.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      ...
      <Item ItemId=";TypeScriptNoVersionWarning" ItemType="0" PsrId="211" InstFlg="true" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Váš projekt neurčuje TypeScriptToolsVersion. Použije se nejnovější dostupný kompilátor TypeScriptu (***REMOVED***0***REMOVED***). Pokud chcete toto upozornění odebrat, nastavte TypeScriptToolsVersion na konkrétní verzi, nebo pokud chcete vždy vybrat nejnovější kompilátor, nastavte Latest.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";TypeScriptVersionMismatchWarning" ItemType="0" PsrId="211" InstFlg="true" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Váš projekt určuje verzi TypeScriptToolsVersion ***REMOVED***0***REMOVED***, ale nenašel se odpovídající kompilátor. Použije se nejnovější dostupný kompilátor TypeScriptu (***REMOVED***1***REMOVED***). Pokud chcete toto upozornění odebrat, nainstalujte sadu TypeScript ***REMOVED***0***REMOVED*** SDK nebo aktualizujte hodnotu TypeScriptToolsVersion.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
