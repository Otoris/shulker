    ...
    <Item ItemId=";Strings" ItemType="0" PsrId="211" Leaf="false">
      ...
      <Item ItemId=";ErrorWritingLog" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA['***REMOVED***0***REMOVED***에 컴파일러 로그를 쓰지 못했습니다. 예외: '***REMOVED***1***REMOVED***']]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";FallbackVersionWarning" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[컴파일러 버전(***REMOVED***0***REMOVED***)을 사용합니다. 이 버전이 잘못된 경우 프로젝트 파일에서 <TypeScriptToolsVersion> 요소를 변경하세요.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";LocatedReferenceFilesAt_0" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA['***REMOVED***0***REMOVED***'에서 참조 파일을 찾았습니다.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";NoCompilerError" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[이 시스템에 현재 설치된 것과 다른 버전의 TypeScript 컴파일러 및 도구가 프로젝트 파일에 사용됩니다. ***REMOVED***0***REMOVED***에서 컴파일러를 찾을 수 없습니다. 프로젝트 파일에서 <TypeScriptToolsVersion> 요소를 변경하여 이 문제를 해결할 수 있습니다.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      ...
      <Item ItemId=";ToolsVersionWarning" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[프로젝트 파일에 지정된 컴파일러 버전(***REMOVED***0***REMOVED***)을 찾을 수 없습니다.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      ...
      <Item ItemId=";TypeScriptNoVersionWarning" ItemType="0" PsrId="211" InstFlg="true" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[프로젝트에서 TypeScriptToolsVersion을 지정하지 않았습니다. 사용 가능한 최신 TypeScript 컴파일러(***REMOVED***0***REMOVED***)가 사용됩니다. 이 경고를 제거하려면 TypeScriptToolsVersion을 특정 버전으로 설정하거나 "Latest"로 설정하여 항상 최신 컴파일러를 선택하세요.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";TypeScriptVersionMismatchWarning" ItemType="0" PsrId="211" InstFlg="true" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[프로젝트에서 TypeScriptToolsVersion ***REMOVED***0***REMOVED***을(를) 지정했지만 일치하는 컴파일러를 찾을 수 없습니다. 사용 가능한 최신 TypeScript 컴파일러(***REMOVED***1***REMOVED***)가 사용됩니다. 이 경고를 제거하려면 TypeScript ***REMOVED***0***REMOVED*** SDK를 설치하거나 TypeScriptToolsVersion 값을 업데이트하세요.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
