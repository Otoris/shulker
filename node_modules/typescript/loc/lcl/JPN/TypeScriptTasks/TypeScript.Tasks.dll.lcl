    ...
    <Item ItemId=";Strings" ItemType="0" PsrId="211" Leaf="false">
      ...
      <Item ItemId=";ErrorWritingLog" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[コンパイラのログを '***REMOVED***0***REMOVED*** に書き込めませんでした。例外: '***REMOVED***1***REMOVED***']]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";FallbackVersionWarning" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[このコンパイラのバージョン (***REMOVED***0***REMOVED***) の使用が正しくない場合、プロジェクト ファイルの <TypeScriptToolsVersion> 要素を変更します。]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";LocatedReferenceFilesAt_0" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA['***REMOVED***0***REMOVED***' で参照ファイルが見つかりました。]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";NoCompilerError" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[プロジェクト ファイルでは、このコンピューターに現在インストールされているものとは異なるバージョンの TypeScript コンパイラおよびツールが使用されています。コンパイラは ***REMOVED***0***REMOVED*** で見つかりませんでした。この問題はプロジェクト ファイルの <TypeScriptToolsVersion> 要素を変更して解決できることがあります。]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      ...
      <Item ItemId=";ToolsVersionWarning" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[プロジェクト ファイルに指定されているコンパイラ バージョン (***REMOVED***0***REMOVED***) が見つかりませんでした。]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      ...
      <Item ItemId=";TypeScriptNoVersionWarning" ItemType="0" PsrId="211" InstFlg="true" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[このプロジェクトでは TypeScriptToolsVersion が指定されていません。使用可能な最新バージョンの TypeScript コンパイラが使われます (***REMOVED***0***REMOVED***)。この警告を削除するには、TypeScriptToolsVersion に特定のバージョンを設定するか、常に最新のコンパイラを選択するために "Latest" を設定してください。]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";TypeScriptVersionMismatchWarning" ItemType="0" PsrId="211" InstFlg="true" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[このプロジェクトでは TypeScriptToolsVersion ***REMOVED***0***REMOVED*** が指定されていますが、対応するコンパイラが見つかりませんでした。使用可能な最新バージョンの TypeScript コンパイラが使われます (***REMOVED***1***REMOVED***)。この警告を削除するには、TypeScript ***REMOVED***0***REMOVED*** SDK をインストールするか、TypeScriptToolsVersion の値を更新してください。]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
