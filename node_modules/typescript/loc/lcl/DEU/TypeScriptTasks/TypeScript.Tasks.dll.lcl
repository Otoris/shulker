    ...
    <Item ItemId=";Strings" ItemType="0" PsrId="211" Leaf="false">
      ...
      <Item ItemId=";ErrorWritingLog" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Fehler beim Schreiben des Compilerprotokolls in "***REMOVED***0***REMOVED***". Ausnahme: "***REMOVED***1***REMOVED***"]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";FallbackVersionWarning" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Die Compilerversion (***REMOVED***0***REMOVED***) wird verwendet. Wenn diese falsch ist, ändern Sie das <TypeScriptToolsVersion>-Element in Ihrer Projektdatei.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";LocatedReferenceFilesAt_0" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Verweisdatei wurde gefunden unter: "***REMOVED***0***REMOVED***".]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";NoCompilerError" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Die Projektdatei verwendet eine andere Version des TypeScript-Compilers und der TypeScript-Tools als die auf diesem Computer installierte Version. Es wurde kein Compiler unter ***REMOVED***0***REMOVED*** gefunden. Möglicherweise können Sie dieses Problem beheben, indem Sie das <TypeScriptToolsVersion>-Element in der Projektdatei ändern.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      ...
      <Item ItemId=";ToolsVersionWarning" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Die in der Projektdatei angegebene Compilerversion (***REMOVED***0***REMOVED***) wurde nicht gefunden.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      ...
      <Item ItemId=";TypeScriptNoVersionWarning" ItemType="0" PsrId="211" InstFlg="true" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Ihr Projekt gibt keine "TypeScriptToolsVersion" an. Der neueste verfügbare TypeScript-Compiler wird verwendet (***REMOVED***0***REMOVED***). Legen Sie für "TypeScriptToolsVersion" eine spezifische Version oder "Latest" fest, um diese Warnung zu entfernen.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";TypeScriptVersionMismatchWarning" ItemType="0" PsrId="211" InstFlg="true" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Ihr Projekt gibt TypeScriptToolsVersion ***REMOVED***0***REMOVED*** an, ein übereistimmender Compiler wurde jedoch nicht gefunden. Der neueste verfügbare TypeScript-Compiler wird verwendet (***REMOVED***1***REMOVED***). Installieren Sie das TypeScript ***REMOVED***0***REMOVED***-SDK, oder aktualisieren Sie den Wert von TypeScriptToolsVersion, um diese Warnung zu entfernen.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
