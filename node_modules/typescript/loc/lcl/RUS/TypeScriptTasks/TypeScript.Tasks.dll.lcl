    ...
    <Item ItemId=";Strings" ItemType="0" PsrId="211" Leaf="false">
      ...
      <Item ItemId=";ErrorWritingLog" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Не удалось записать журнал компилятора в "***REMOVED***0***REMOVED***". Исключение: "***REMOVED***1***REMOVED***"]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";FallbackVersionWarning" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Использование версии компилятора (***REMOVED***0***REMOVED***), если это неправильное изменение элемента <TypeScriptToolsVersion> в файле проекта.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";LocatedReferenceFilesAt_0" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Файл ссылок находится в "***REMOVED***0***REMOVED***".]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";NoCompilerError" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Ваш файл проекта использует версию компилятора и инструментов TypeScript, которая отличается от версии, установленной в настоящий момент на этом компьютере. В ***REMOVED***0***REMOVED*** не найден компилятор. Возможно, вам удастся устранить эту проблему, изменив элемент <TypeScriptToolsVersion> в файле проекта.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      ...
      <Item ItemId=";ToolsVersionWarning" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[Не удалось найти компилятор версии (***REMOVED***0***REMOVED***), указанный в файле проекта.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      ...
      <Item ItemId=";TypeScriptVersionMismatchWarning" ItemType="0" PsrId="211" InstFlg="true" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[В проекте указана версия TypeScriptToolsVersion ***REMOVED***0***REMOVED***, но соответствующий компилятор не найден. Будет использоваться последняя доступная версия компилятора TypeScript (***REMOVED***1***REMOVED***). Чтобы удалить это предупреждение, установите пакет SDK для TypeScript ***REMOVED***0***REMOVED*** или измените значение параметра TypeScriptToolsVersion.]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
