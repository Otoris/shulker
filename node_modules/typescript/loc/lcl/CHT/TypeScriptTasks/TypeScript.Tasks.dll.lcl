    ...
    <Item ItemId=";Strings" ItemType="0" PsrId="211" Leaf="false">
      ...
      <Item ItemId=";ErrorWritingLog" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[無法將編譯器記錄檔寫入 '***REMOVED***0***REMOVED***。例外狀況: '***REMOVED***1***REMOVED***']]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";FallbackVersionWarning" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[將使用編譯器版本 (***REMOVED***0***REMOVED***)，若此版本不正確，請變更專案檔中的 <TypeScriptToolsVersion> 元素。]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";LocatedReferenceFilesAt_0" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[在 '***REMOVED***0***REMOVED***' 找到參考檔案。]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";NoCompilerError" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[您的專案檔使用的 TypeScript 編譯器和工具版本與這部電腦目前安裝的版本不同。在 ***REMOVED***0***REMOVED*** 找不到任何編譯器。變更專案檔中的 <TypeScriptToolsVersion> 元素，或許可以修正此問題。]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      ...
      <Item ItemId=";ToolsVersionWarning" ItemType="0" PsrId="211" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[找不到專案檔中指定的編譯器版本 (***REMOVED***0***REMOVED***)。]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      ...
      <Item ItemId=";TypeScriptNoVersionWarning" ItemType="0" PsrId="211" InstFlg="true" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[您的專案未指定 TypeScriptToolsVersion。系統會使用最新的可用 TypeScript 編譯器 (***REMOVED***0***REMOVED***)。若要移除這個警告，請將 TypeScriptToolsVersion 設為特定版本，或 [最新]5D; 以一律選取最新編譯器。]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
      <Item ItemId=";TypeScriptVersionMismatchWarning" ItemType="0" PsrId="211" InstFlg="true" Leaf="true">
        <Str Cat="Text">
          ...
          <Tgt Cat="Text" Stat="Loc" Orig="New">
            <Val><![CDATA[您的專案指定了 TypeScriptToolsVersion ***REMOVED***0***REMOVED***，但找不到相符的編譯器。系統會使用最新可用的 TypeScript 編譯器 (***REMOVED***1***REMOVED***)。若要移除此警告，請安裝 TypeScript ***REMOVED***0***REMOVED*** SDK 或更新 TypeScriptToolsVersion 的值。]]></Val>
          </Tgt>
        </Str>
        <Disp Icon="Str" />
      </Item>
