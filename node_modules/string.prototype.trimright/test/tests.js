...
module.exports = function (trimRight, t) ***REMOVED***
	t.test('normal cases', function (st) ***REMOVED***
	...
	***REMOVED***);
	...
	t.test('unicode >= 4 && < 6.3', ***REMOVED*** skip: !(/^\s$/).test(mongolianVowelSeparator) ***REMOVED***, function (st) ***REMOVED***
	...
	***REMOVED***);
	...
	t.test('zero-width spaces', function (st) ***REMOVED***
		var zeroWidth = '\u200b';
