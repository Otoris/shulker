...
<head>
    ...
    <style type='text/css'>
        .coverage-summary .sorter ***REMOVED***
...
MuteStream.prototype.write = function (c) ***REMOVED***
  if (this.muted) ***REMOVED***
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (c.match(/^\u001b/)) ***REMOVED***
<span class="cstat-no" title="statement not covered" >      if(c.indexOf(this._prompt) === 0) ***REMOVED***</span>
...
<span class="branch-2 cbranch-no" title="branch not covered" >          c.indexOf(this._prompt) === 0)</span> ***REMOVED***
...
MuteStream.prototype.end = function (c) ***REMOVED***
  <span class="missing-if-branch" title="else path not taken" >E</span>if (this.muted) ***REMOVED***
    <span class="missing-if-branch" title="if path not taken" >I</span>if (c &amp;&amp; this.replace) ***REMOVED***
...
***REMOVED***
&nbsp;
function proxy (fn) ***REMOVED*** return <span class="fstat-no" title="function not covered" >function () ***REMOVED***</span>
...
window.onload = function () ***REMOVED***
        if (typeof prettyPrint === 'function') ***REMOVED***
            prettyPrint();
        ***REMOVED***
***REMOVED***;
</script>
