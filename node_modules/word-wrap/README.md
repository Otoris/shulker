...
```js
wrap(str, ***REMOVED***width: 60***REMOVED***);
```
...
```js
wrap(str, ***REMOVED***indent: '      '***REMOVED***);
```
...
Default: `function(str)***REMOVED***return str;***REMOVED***`
...
```js
wrap(str, ***REMOVED***trim: true***REMOVED***);
```
...
```js
wrap(str, ***REMOVED***cut: true***REMOVED***);
```
