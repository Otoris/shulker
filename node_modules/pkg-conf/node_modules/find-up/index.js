...
module.exports = (filename, opts = ***REMOVED******REMOVED***) => ***REMOVED***
	const startDir = path.resolve(opts.cwd || '');
	const ***REMOVED***root***REMOVED*** = path.parse(startDir);
...
module.exports.sync = (filename, opts = ***REMOVED******REMOVED***) => ***REMOVED***
	let dir = path.resolve(opts.cwd || '');
	const ***REMOVED***root***REMOVED*** = path.parse(dir);
