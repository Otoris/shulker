...
class Receiver extends Writable ***REMOVED***
   ...
   *
   * @param ***REMOVED***String***REMOVED*** binaryType The type for binary data
   ...
   */
  constructor(binaryType, extensions, maxPayload) ***REMOVED***
    super();
  ...
  ***REMOVED***
  ...
  getInfo() ***REMOVED***
    ...
    ***REMOVED*** else if (this._opcode === 0x01 || this._opcode === 0x02) ***REMOVED***
      if (this._fragmented) ***REMOVED***
        this._loop = false;
        return error(RangeError, `invalid opcode $***REMOVED***this._opcode***REMOVED***`, true, 1002);
      ***REMOVED***
    ...
    if (this._opcode === 0x08) ***REMOVED***
      ...
      ***REMOVED*** else ***REMOVED***
        ...
        if (!isValidStatusCode(code)) ***REMOVED***
          return error(RangeError, `invalid status code $***REMOVED***code***REMOVED***`, true, 1002);
        ***REMOVED***
 ...
 *
 * @param ***REMOVED***(Error|RangeError)***REMOVED*** ErrorCtor The error constructor
 ...
 * @private
 */
function error(ErrorCtor, message, prefix, statusCode) ***REMOVED***
