 ...
 *
 * @param ***REMOVED***(DataView|TypedArray)***REMOVED*** view The view to convert
 * @return ***REMOVED***Buffer***REMOVED*** Converted view
 * @private
 */
function viewToBuffer(view) ***REMOVED***
  const buf = Buffer.from(view.buffer);

  if (view.byteLength !== view.buffer.byteLength) ***REMOVED***
