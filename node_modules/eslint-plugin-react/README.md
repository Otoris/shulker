  ...
  "settings": ***REMOVED***
    ...
    ***REMOVED***,
    "propWrapperFunctions": [
        ...
        "forbidExtraProps",
        ***REMOVED***"property": "freeze", "object": "Object"***REMOVED***,
        ***REMOVED***"property": "myFavoriteWrapper"***REMOVED***
    ],
    "linkComponents": [
      // Components used as alternatives to <a> for linking, eg. <Link to=***REMOVED*** url ***REMOVED*** />
      "Hyperlink",
      ***REMOVED***"name": "Link", "linkAttribute": "to"***REMOVED***
    ]
  ***REMOVED***
***REMOVED***
```
