...
(function () ***REMOVED***
    ...
    ***REMOVED***
     ...
     * @param ***REMOVED***string***REMOVED*** originalSource The original wrapped comment
     * @param ***REMOVED***number***REMOVED*** unwrappedIndex The index of a character in the unwrapped string
     * @returns ***REMOVED***number***REMOVED*** The index of the corresponding character in the original wrapped string
     */
    function convertUnwrappedCommentIndex(originalSource, unwrappedIndex) ***REMOVED***
        var replacedSource = originalSource.replace(/^\/\*\*?/, '');
        var numSkippedChars = 0;
        var matcher = new RegExp(STAR_MATCHER, 'g');
        var match;

        while ((match = matcher.exec(replacedSource))) ***REMOVED***
            numSkippedChars += match[1].length;

            if (match.index + match[0].length > unwrappedIndex + numSkippedChars) ***REMOVED***
    ...
    ***REMOVED***
    ...
    (function (exports) ***REMOVED***
        ...
        ***REMOVED***
        ...
        function parseType(title, last, addRange) ***REMOVED***
            ...
            ***REMOVED***
            ...
            if (isAllowedOptional(title)) ***REMOVED***
                return typed.parseParamType(type, ***REMOVED***startIndex: convertIndex(startIndex), range: addRange***REMOVED***);
            ***REMOVED***

            return typed.parseType(type, ***REMOVED***startIndex: convertIndex(startIndex), range: addRange***REMOVED***);
        ***REMOVED***

        function scanIdentifier(last) ***REMOVED***
            var identifier;
            if (!esutils.code.isIdentifierStartES5(source.charCodeAt(index)) && !source[index].match(/[0-9]/)) ***REMOVED***
                return null;
            ***REMOVED***
            identifier = advance();
        ...
        ***REMOVED***
        ...
        function parseName(last, allowBrackets, allowNestedParams) ***REMOVED***
            ...
            ***REMOVED***
            ...
            if (source.charCodeAt(index) === 0x5B  /* '[' */) ***REMOVED***
                if (allowBrackets) ***REMOVED***
                    useBrackets = true;
                    name = advance();
                ***REMOVED*** else ***REMOVED***
                    return null;
        ...
        ***REMOVED***
        ...
        function convertIndex(rangeIndex) ***REMOVED***
            if (source === originalSource) ***REMOVED***
                return rangeIndex;
            ***REMOVED***
        ...
        ***REMOVED***;
        ...
        TagParser.prototype.parseThis = function parseThis() ***REMOVED***
            // this name may be a name expression (e.g. ***REMOVED***foo.bar***REMOVED***),
            // an union (e.g. ***REMOVED***foo.bar|foo.baz***REMOVED***) or a name path (e.g. foo.bar)
            var value = sliceSource(source, index, this._last).trim();
            if (value && value.charAt(0) === '***REMOVED***') ***REMOVED***
                var gotType = this.parseType();
                if (gotType && this._tag.type.type === 'NameExpression' || this._tag.type.type === 'UnionType') ***REMOVED***
                    this._tag.name = this._tag.type.name;
                    return true;
                ***REMOVED*** else ***REMOVED***
        ...
        ***REMOVED***;
        ...
        TagParser.prototype.parse = function parse() ***REMOVED***
            ...
            ***REMOVED***
            ...
            if (this._options.range) ***REMOVED***
        ...
        function parse(comment, options) ***REMOVED***
            ...
            ***REMOVED***
            ...
            if (options.tags) ***REMOVED***
                if (Array.isArray(options.tags)) ***REMOVED***
