...
function filterRules(rules, predicate) ***REMOVED***
  return fromEntries(entries(rules).filter(entry => predicate(entry[1])));
***REMOVED***

function configureAsError(rules) ***REMOVED***
  return fromEntries(Object.keys(rules).map(key => [`react/$***REMOVED***key***REMOVED***`, 2]));
***REMOVED***
