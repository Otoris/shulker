...
> type: `***REMOVED*** [type: string]: string[] | undefined ***REMOVED***`
...
const node = ***REMOVED***
    ...
    left: ***REMOVED*** type: "Identifier", name: "foo" ***REMOVED***,
    right: ***REMOVED*** type: "Literal", value: 0 ***REMOVED***
***REMOVED***
...
> type: `(additionalKeys: object) => ***REMOVED*** [type: string]: string[] | undefined ***REMOVED***`
...
***REMOVED***)) // → ***REMOVED*** ..., MethodDefinition: ["decorators", "key", "value"], ... ***REMOVED***
```
