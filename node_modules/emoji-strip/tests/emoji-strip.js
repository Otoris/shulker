...
tape('strip emoji', function (t) ***REMOVED***
...
tape('strip emoji with skin tones', function (t) ***REMOVED***
...
tape('strip flag emoji', function (t) ***REMOVED***
  emoji = '🇧🇷Brasil!!🇧🇷!'
...
tape('strip Unicode Version 9.0 emoji', function (t) ***REMOVED***
...
tape('strip Unicode Version 10.0 emoji', function (t) ***REMOVED***
  emoji = 'emoji are \u***REMOVED***1F9D9***REMOVED***magic'
  t.equal(emojiStrip(emoji), 'emoji are magic')

  emoji = 't-rex\u***REMOVED***1F996***REMOVED***'
  t.equal(emojiStrip(emoji), 't-rex')

  t.end()
***REMOVED***)

tape('don’t magically remove digits', function (t) ***REMOVED***
