...
function detectShebang(parsed) ***REMOVED***
...
function parseNonShell(parsed) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (parsed.options.forceShell || needsShell) ***REMOVED***
        ...
        parsed.args = ['/d', '/s', '/c', `"$***REMOVED***shellCommand***REMOVED***"`];
...
function parse(command, args, options) ***REMOVED***
    ...
    ***REMOVED***
    ...
    options = Object.assign(***REMOVED******REMOVED***, options); // Clone object to avoid changing the original
